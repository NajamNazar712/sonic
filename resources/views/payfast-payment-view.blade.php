...
<body>
    ...
    <form method="POST" action="https://ipguat.apps.net.pk/Ecommerce/api/Transaction/PostTransaction" >
        ...
        <input type="text" name="FAILURE_URL"       value="http://sonic.test/payfast-payment" ><BR>
        <input type="text" name="BASKET_ID"         value="001" ><BR>
        <input type="text" name="ORDER_DATE"        value="2023-04-26" ><BR>
        <input type="text" name="CHECKOUT_URL"      value="http://sonic.test" ><BR>
