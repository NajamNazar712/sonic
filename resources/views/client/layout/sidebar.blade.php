  ...
  data-scroll-to-active="true">
    <div class="main-menu-content">
      <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
        ...
        @if (count(array_intersect([1, 3], session('permissions'))) !== 0)
        ...
        @if(session('packaging_charges_check') && in_array(4, session('permissions')))
        ...
        @if (count(array_intersect([6, 7], session('permissions'))) !== 0)
