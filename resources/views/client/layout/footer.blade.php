                ...
                .done(function (data) {
                    if(data.status == 1){
                        ...
                        if(data.question.recommendation_box){
                            ...
                            <textarea class="form-control"  name="recommendation" placeholder="Recommendations or suggestions"></textarea>
                            `);
                        }
                            ...
                            html+= `
                                            ...
                                            <tr>
                                             <td>
                                                 ...
                                                 <input type="hidden" value="${values.nps_survey_id}">
                                             </td>
                                             <td>${values.question}</td>
                                             <td>
                                                <div style="display: contents">
                                                    <input title="1" style="width: 20px;height: 20px;cursor:pointer" class="radio" value="1" type="radio" name="ratting[${index}]">
                                                    <input title="2" style="width: 20px;height: 20px;cursor:pointer" class="radio" value="2" type="radio" name="ratting[${index}]">
                                                    <input title="3" style="width: 20px;height: 20px;cursor:pointer" class="radio" value="3" type="radio" name="ratting[${index}]">
                                                    <input title="4" style="width: 20px;height: 20px;cursor:pointer" class="radio" value="4" type="radio" name="ratting[${index}]">
                                                    <input title="5" style="width: 20px;height: 20px;cursor:pointer" class="radio" value="5" type="radio" name="ratting[${index}]">
                                                 </div>
