...
@section('title','Subscription For Shipment Status')

@section('content')
    <h1 class="mb-1">
        Subscription For Shipment Status
    </h1>
        ...
        <div class="card-content" aria-expanded="true">
            <div class="card-body">
                ...
                <div class="row justify-content-center">
                    <div class="col-5">
                        <form id="settings_form" class="form-horizontal text-center" method="POST" action="{{ route('cod.settings.subscription.store') }}" novalidate="novalidate">
                            {{ csrf_field() }}
