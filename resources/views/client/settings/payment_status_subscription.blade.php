...
@section('title','Subscription For Payment Status')

@section('content')
    <h1 class="mb-1">
        Subscription For Payment Status
    </h1>
        ...
        <div class="card-content" aria-expanded="true">
            <div class="card-body">
                ...
                <div class="row justify-content-center">
                    <div class="col-5">
                        <form id="settings_form" class="form-horizontal text-center" method="POST" action="{{ route('cod.settings.payment_subscription.store') }}" novalidate="novalidate">
                            {{ csrf_field() }}
