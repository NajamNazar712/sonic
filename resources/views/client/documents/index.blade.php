                                        ...
                                        <div class="card-header">
                                            ...
                                            <div class="heading-elements">
                                                <ul class="list-inline mb-0">
                                                    <li><a href="{{ asset('file/documents/API Document - SONIC Version 1.13.pdf') }}" class="btn btn-secondary round btn-min-width mr-1 mb-1" target="_blank"> <i class=" ft-download"></i> Download</a></li>
                                                </ul>
                                            </div>
                                        </div>
