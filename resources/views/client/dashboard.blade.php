                                    ...
                                    <form id="track_form" class="form-inline mb-1 justify-content-center" novalidate="novalidate">
                                      ...
                                      <span class="input-group-text bg-primary bg-darken-2 border-primary white rounded-left">
                                        <span class="la la-calendar-o small-calender-icon"></span>
                                                ...
                                                <input type="text" name="booking_from_date" class="form-control bg-primary border-primary white rounded-right" id="booking_from_date" placeholder="Booking Date From"  data-value="{{ \Carbon\Carbon::today()->subDays(1)->startOfDay() }}">
                                            </div>
                                        </div>
                                        <div class="col-3">
                                            <div class="form-group input-group">
                            ...
                            <div class="claims d-none" id="request_claims">
                                ...
                                <div class="row justify-content-center">
                                    ...
                                    <div class="col-10 text-left d-none" id="claim_shipment_damage_div">
                                        ...
                                        {{--                                        <div class="col-10" id="damage_claim_product_cost_div">--}}
                                        <fieldset class="form-group">
        ...
        $(document).ready(function () {
            ...
            var booking_from_date = $('#booking_from_date').pickadate({
                ...
                onSet: function(context) {
                    ...
                    booking_to_date.pickadate('picker').set('select', new Date(current_max.toDate()),{muted:true});
                }
            });
            ...
            $('#case_nature_requests').on('change',function (e) {
                ...
                if($(this).val() == 12){
                    if(selected_rows.length >1)
                    {
                        toastr.error('Multiple Shipment for COD Change Amount is not allowed', 'Error!', {
                            positionClass: 'toast-top-center',
                            containerId: 'toast-top-center'
                        });
