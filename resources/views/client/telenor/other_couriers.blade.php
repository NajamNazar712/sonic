...
@section('title', 'Telenor Other Couriers')
                ...
                <div class="card">
                    <div class="card-content" aria-expanded="true">
                        <div class="card-body">
                            ...
                            <form id="delivery_form" class="form-horizontal" method="POST" action="{{ route('cod.shipment.telenor.other_courier.store') }}" novalidate="novalidate" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                ...
                                <div class="row align-items-center justify-content-center">
                                    ...
                                    <div class="col ml-auto">
                                        <div class="form-group text-right">
                                            <a href="{{ asset('file/Telenor Other Couriers.xlsx') }}?v=21_10_2020" class="btn btn-primary"><i class="la la-download"></i> Download Template</a>
                                        </div>
                                    </div>
                                </div>
                            </form>
