                ...
                <div class="col-12 d-flex align-items-center justify-content-end">
                    <div class="col-md-4 col-10 p-0">
                        <div class="mb-2 text-center">
                            <p class="bold" style="font-size: 17px !important;">For Help Dial : <a href="tel:021-111-118-729" style="text-decoration:underline;">021-111-118-729</a>  or email us <a href="mailto:info@slgtrax.com" style="text-decoration:underline;">info@slgtrax.com</a></p>
                        </div>
                            ...
                            <div class="card-content">
                                ...
                                <div class="card-body">
                                    ...
                                    <form class="form-horizontal" method="POST" action="{{ route('cod.register.submit') }}">
                                        ...
                                        <fieldset class="form-group position-relative has-icon-left">
                                            <input type="password" name="password" class="form-control {{ $errors->has('password') ? ' is-invalid' : '' }}" id="password" placeholder="Set Your Password"
                                                   required>
                                            <div class="form-control-position">
                                                <i class="la la-key"></i>
                                            </div>
