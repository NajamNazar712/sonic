...
<body class="vertical-layout vertical-overlay-menu 1-column  bg-full-screen-image menu-expanded" data-open="click"
    data-menu="vertical-overlay-menu" data-col="1-column">
                                                                ...
                                                                <select name="nature_of_account"
                                                                    ...
                                                                    @foreach ($account_types as $type)
                                                                        <option value="{{ $type->id }}"
                                                                            {{ old('nature_of_account') == $type->id ? 'selected' : '' }}>
                                                                            {{ $type->name }}</option>
                                                                    @endforeach
                                                                </select>
                                                            </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control required"
                                                                placeholder="abc@example.com"
                                                                value="@if (old('email') != null) {{ old('email') }}@elseif($lead != null){{ $lead->email_address }}@else{{ old('email') }} @endif"
                                                                name="email">
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="password">
