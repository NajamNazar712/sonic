                ...
                <div class="modal-body text-center rebook_body">
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                            ...
                            <div class="form-group">
                                <textarea name="address" class="form-control" id="address" cols="49" rows="5" placeholder="Address*" data-rule-required="true" data-msg-required="This field is required" data-rule-maxlength="255" data-msg-maxlength="Address can be maximum 255 characters"></textarea>
                            </div>
                            <div class="form-group">
