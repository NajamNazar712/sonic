...
@section('title', 'Report - Overall Sales (Telenor)')

@section('content')
    <h1 class="mb-1">
        Report - Overall Sales (Telenor)
    </h1>
            ...
            <div class="card-body">
                ...
                <div id="search_form" class="row mb-2 justify-content-center">
                    ...
                    <div class="col-4">
                        <div class="form-group input-group">
                            ...
                            <input type="text" name="search_date_from" class="form-control pickadate bg-primary border-primary white rounded-right" id="search_date_from" placeholder="Arrival Date (From)" data-value="{{ Carbon\Carbon::now()->subDays(62) }}">
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group input-group">
                            ...
                            <input type="text" name="search_date_to" class="form-control pickadate bg-primary border-primary white rounded-right" id="search_date_to" placeholder="Arrival Date (To)" data-value="{{ Carbon\Carbon::now() }}">
                        </div>
                    </div>
                ...
                <table class="table table-bordered datatable" id="datatable" style="z-index: 3;">
                    ...
                    <tr role="row" class="bg-primary white">
                        ...
                        <th class="border-primary border-darken-1">Delivered within 15 Days</th>
                    </tr>
                    </thead>
                </table>
        ...
        $(document).ready(function () {
            ...
            var from_date = $('#search_date_from').pickadate({
                ...
                onSet: function(context) {
                    if (context.select) {
                        ...
                        var afterDate = currentDate.add(62, 'days');
            ...
            var to_date = $('#search_date_to').pickadate({
                ...
                onSet: function(context) {
                    if (context.select) {
                        ...
                        var beforeDate = currentDate.subtract(62, 'days');
            ...
            jQuery.fn.DataTable.Api.register( 'buttons.exportData()', function ( options ) {
                if ( this.context.length ) {
                    ...
                    params.length = -1;
                    var jsonResult = $.ajax({
                        url: '{{ route('cod.reports.sales.telenor.list') }}',
                        data: params,
                        success: function (result) {
                            ...
                            head.push('Delivered within 15 Days');
                            ...
                            $.each(result.data, function(index, values) {
                                ...
                                row.push(values.delivery_within_15_days);
            ...
            var table = $('#datatable').DataTable({
                ...
                columns: [
                    ...
                    { data: 'delivery_within_15_days' ,name: 'delivery_within_15_days', class: 'align-middle delivery_within_15_days', orderable: false, searchable: false}
                ],
