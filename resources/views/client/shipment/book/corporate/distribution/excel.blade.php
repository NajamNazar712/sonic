                ...
                <div class="card">
                    <div class="card-content" aria-expanded="true">
                        <div class="card-body">
                            ...
                            <form id="booking_form" class="form-horizontal" method="POST" action="{{ route('cod.shipment.book.corporate_excel_distribution.store') }}" novalidate="novalidate" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                <div class="row align-items-center justify-content-center mb-2">
                                    ...
                                    <input type="radio" class="d-none" name="excel_type" value="0">
                                    ...
                                    @if(session('rate_type_id') != 3)
                                     <table class="table table-bordered">
                                        ...
                                        @foreach ($delivery_types as $delivery_type)
                                            <tr role="row">
                                                <td class="text-center">{{ $delivery_type->id }}</td>
