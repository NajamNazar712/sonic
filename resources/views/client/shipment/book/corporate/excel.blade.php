                ...
                <div class="card">
                    <div class="card-content" aria-expanded="true">
                        <div class="card-body">
                            ...
                            <form id="booking_form" class="form-horizontal" method="POST" action="{{ route('cod.shipment.book.corporate_excel_store') }}" novalidate="novalidate" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                <div class="col">
                                ...
                                <div class="row align-items-center justify-content-center">
                                    ...
                                    <div class="col ml-auto">
                                        <div class="form-group text-right">
                                            <a href="{{ asset('file/Trax Book Corporate Shipment Template.xlsx') }}?v=21_10_2020" class="btn btn-primary"><i class="la la-download"></i> Download Overall Template</a>
                                        </div>
                                        <div class="form-group text-right">
                                            <a href="{{ asset('file/Trax Book Corporate Regular Shipment Template.xlsx') }}?v=21_10_2020" class="btn btn-primary"><i class="la la-download"></i> Download Regular Template</a>
                                        </div>
                                        <div class="form-group text-right">
