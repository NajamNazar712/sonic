									...
									<div id="order_information_header_div" class="col col_custom_middle">
										...
										<div id="replacement" class="mb-1 d-none" style="color:#000000; background-color: #000000">
											...
											<div class="pt-1 pl-1 pr-1 border border-light rounded-bottom">
												...
												<div class="form-group input-group">
													<input style="color:#000000; background-color: #000000" type="text" name="replacement_item_quantity" class="form-control text-center quantity" placeholder="Item Quantity*" data-rule-required="true" data-msg-required="Item Quantity is required">												</div>
											</div>
										</div>
