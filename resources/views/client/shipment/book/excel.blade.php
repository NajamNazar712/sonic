										...
										<div class="row">
											<div class="col">
												<div class="form-group text-right">
													<a href="{{ asset('file/Trax Book Regular Shipment Template.xlsx') }}?v=22_03_2023" class="btn btn-primary btn-block"><i class="la la-download"></i> Regular</a>
												</div>
											</div>
											<div class="col">
												<div class="form-group text-right">
												<a href="{{ asset('file/Trax Book Replacement Shipment Template.xlsx') }}?v=22_03_2023" class="btn btn-primary btn-block"><i class="la la-download"></i> Replacement</a>
												</div>
											</div>
											<div class="col">
												<div class="form-group text-right">
											...
											<div class="col">
												<div class="form-group text-right">
													@if($omni_user != 1)
														<a href="{{ asset('file/Trax Book Shipment Template.xlsx') }}?v=22_03_2023" class="btn btn-primary btn-block"><i class="la la-download"></i> Overall</a>
													@else
											...
											@if($omni_user == 1)
												<div class="col">
													<div class="form-group text-right">
														<a href="{{ asset('file/Trax Book Omni Shipment Template.xlsx') }}?v=22_03_2023" class="btn btn-primary btn-block"><i class="la la-download"></i> Omni</a>
													</div>
												</div>
											@endif
										</div>
