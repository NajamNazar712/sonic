    ...
    <div class="app-content content">
        <div class="content-wrapper">
            ...
            <div class="content-body">
                <h1 class="mb-1">
                   Book an International Shipment (High Return Ratio for Consignee)
                </h1>
...
{{--                            <div class="alert">Following(s) Consignee have a greater return ratio <br> Do you still want to book a shipment? <br> For assistance, Call: 021-38772222</div>--}}
                            ...
                            @endforeach
                            <form id="booking_form" class="form-horizontal" method="POST" action="{{ route('cod.shipment.book.international.excel_store') }}" novalidate="novalidate">
                                {{ csrf_field() }}
