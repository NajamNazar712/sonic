...
@section('title', 'High Return Ratio for Consignee')
    ...
    <div class="app-content content">
        <div class="content-wrapper">
            ...
            <div class="content-body">
                <h1 class="mb-1">
                   Book a Shipment (High Return Ratio for Consignee)
                </h1>

                <div class="card">
                    <div class="card-content" aria-expanded="true">
                        <div class="card-body">
{{--                            <div class="alert">Following(s) Consignee have a greater return ratio <br> Do you still want to book a shipment? <br> For assistance, Call: 021-38772222</div>--}}
                                ...
                                <div class="table-responsive">
                                    <table class='table table-bordered' id='tbl'>
                                        ...
                                        @foreach($data as $key => $ro)
                                            ...
                                            <tr>
                                                @if(isset($blacklist_errors[$key+2]['msg']))
                                                    ...
                                                    <td><textarea type="text" name="form[{{$no}}][consignee_address]" class="form-control text" readonly="readonly">{{$ro['consignee_address']}}</textarea></td>
