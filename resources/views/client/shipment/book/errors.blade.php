                    ...
                    <div class="card-content" aria-expanded="true">
                        ...
                        {!! Form::model($data,['method' => 'POST', 'route' => 'cod.shipment.book.excel_store']) !!}
                            ...
                            <td><h4 style="color: red">{!! $no=$no+1!!}</h4><font color="red">{{ 'Error(s) in this row' }}</font></td>
                                ...
                                @endif
                                @if(isset($errors[$no]['shipper_reference_1']))
                                    <td>{!! Form::text('form[' . $no . '][shipper_reference_1]', $ro['shipper_reference_1'],['class' => 'form-control is-invalid','style'=>'width:auto']) !!}<font color="red">{{$errors[$no]['shipper_reference_1']}}</font></td>
                                @else
                                    <td>{!! Form::text('form[' . $no . '][shipper_reference_1]', $ro['shipper_reference_1'],['class' => 'form-control','style'=>'width:60px','readonly' => 'readonly']) !!}</td>
                                @endif
                                @if(isset($errors[$no]['shipper_reference_2']))
                                    <td>{!! Form::text('form[' . $no . '][shipper_reference_2]', $ro['shipper_reference_2'],['class' => 'form-control is-invalid','style'=>'width:auto']) !!}<font color="red">{{$errors[$no]['shipper_reference_2']}}</font></td>
                                @else
                                    <td>{!! Form::text('form[' . $no . '][shipper_reference_2]', $ro['shipper_reference_2'],['class' => 'form-control','style'=>'width:60px','readonly' => 'readonly']) !!}</td>
                                @endif
                                @if(isset($errors[$no]['shipper_reference_3']))
                                    <td>{!! Form::text('form[' . $no . '][shipper_reference_3]', $ro['shipper_reference_3'],['class' => 'form-control is-invalid','style'=>'width:auto']) !!}<font color="red">{{$errors[$no]['shipper_reference_3']}}</font></td>
                                @else
                                    <td>{!! Form::text('form[' . $no . '][shipper_reference_3]', $ro['shipper_reference_3'],['class' => 'form-control','style'=>'width:60px','readonly' => 'readonly']) !!}</td>
                                @endif
                                @if(isset($errors[$no]['shipper_reference_4']))
                                    <td>{!! Form::text('form[' . $no . '][shipper_reference_4]', $ro['shipper_reference_4'],['class' => 'form-control is-invalid','style'=>'width:auto']) !!}<font color="red">{{$errors[$no]['shipper_reference_4']}}</font></td>
                                @else
                                    <td>{!! Form::text('form[' . $no . '][shipper_reference_4]', $ro['shipper_reference_4'],['class' => 'form-control','style'=>'width:60px','readonly' => 'readonly']) !!}</td>
                                @endif
                                @if(isset($errors[$no]['shipper_reference_5']))
                                    <td>{!! Form::text('form[' . $no . '][shipper_reference_5]', $ro['shipper_reference_5'],['class' => 'form-control is-invalid','style'=>'width:auto']) !!}<font color="red">{{$errors[$no]['shipper_reference_5']}}</font></td>
                                @else
                                    <td>{!! Form::text('form[' . $no . '][shipper_reference_5]', $ro['shipper_reference_5'],['class' => 'form-control','style'=>'width:60px','readonly' => 'readonly']) !!}</td>
                                @endif
