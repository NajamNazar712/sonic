                            ...
                            <div class="table-responsive">
                                <table class='table table-bordered' id='tbl'>
                                    ...
                                    <tr>
                                        ...
                                        <th>Return Contact Person (03000000000)</th>
                                        <th>Return Vendor</th>
                                        <th>Return Phone Number</th>
                                        <th>Return City</th>
                                    ...
                                    @foreach($data as $ro)
                                        <tr>
                                            ...
                                            @if(isset($errors[$no]['information_display']))
                                                <td>{!! Form::select('form[' . $no . '][information_display]',['no'=>'no','yes'=>'yes'],null, ['class' => 'form-control is-invalid information_display select2','id'=>'information_display','placeholder' => '']) !!}<font color="red">{{$errors[$no]['information_display']}}</font></td>
                                            @else
                                            ...
                                            @if(isset($errors[$no]['consignee_phone_number_2']))
                                                <td>{!! Form::text('form[' . $no . '][consignee_phone_number_2]', $ro['consignee_phone_number_2'],['class' => 'form-control is-invalid phone_number','style'=>'width:auto']) !!}<font color="red">{{$errors[$no]['consignee_phone_number_2']}}</font></td>
                                            @else
                                            ...
                                            @if(isset($errors[$no]['consignee_email_address']))
                                                <td>{!! Form::text('form[' . $no . '][consignee_email_address]', $ro['consignee_email_address'],['class' => 'form-control is-invalid','style'=>'width:auto']) !!}<font color="red">{{$errors[$no]['consignee_email_address']}}</font></td>
                                            @else
                                                <td>{!! Form::text('form[' . $no . '][consignee_email_address]', $ro['consignee_email_address'],['class' => 'form-control','style'=>'width:auto','readonly' => 'readonly']) !!}</td>
                                            @endif
                                            @if($service_type_check_id == 1 || $service_type_check_id == null)
                                            ...
                                            @if(isset($errors[$no]['return_address']))
                                                <td>{!! Form::text('form[' . $no . '][return_address]', $ro['return_address'],['class' => 'form-control is-invalid','style'=>'width:auto']) !!}<font color="red">{{$errors[$no]['return_address']}}</font></td>
                                            @else
                                                <td>{!! Form::text('form[' . $no . '][return_address]', $ro['return_address'],['class' => 'form-control','style'=>'width:60px','readonly' => 'readonly']) !!}</td>
                                            @endif

                                            @if(isset($errors[$no]['return_contact_person']))
                                                <td>{!! Form::text('form[' . $no . '][return_contact_person]', $ro['return_contact_person'],['class' => 'form-control is-invalid','style'=>'width:auto']) !!}<font color="red">{{$errors[$no]['return_contact_person']}}</font></td>
                                            @else
                                                <td>{!! Form::text('form[' . $no . '][return_contact_person]', $ro['return_contact_person'],['class' => 'form-control','style'=>'width:60px','readonly' => 'readonly']) !!}</td>
                                            @endif

                                            @if(isset($errors[$no]['return_vendor']))
                                                <td>{!! Form::text('form[' . $no . '][return_vendor]', $ro['return_vendor'],['class' => 'form-control is-invalid','style'=>'width:auto']) !!}<font color="red">{{$errors[$no]['return_vendor']}}</font></td>
                                            @else
                                                <td>{!! Form::text('form[' . $no . '][return_vendor]', $ro['return_vendor'],['class' => 'form-control','style'=>'width:60px','readonly' => 'readonly']) !!}</td>
                                            @endif
                                            @if(isset($errors[$no]['return_phone_number']))
                                                <td>{!! Form::text('form[' . $no . '][return_phone_number]', $ro['return_phone_number'],['class' => 'form-control is-invalid','style'=>'width:auto']) !!}<font color="red">{{$errors[$no]['return_phone_number']}}</font></td>
                                            @else
                                                <td>{!! Form::text('form[' . $no . '][return_phone_number]', $ro['return_phone_number'],['class' => 'form-control','style'=>'width:60px','readonly' => 'readonly']) !!}</td>
                                            @endif
                                            @if(isset($errors[$no]['return_city']))
                                                <td>{!! Form::text('form[' . $no . '][return_city]', $ro['return_city'],['class' => 'form-control is-invalid','style'=>'width:auto']) !!}<font color="red">{{$errors[$no]['return_city']}}</font></td>
                                            @else
                                                <td>{!! Form::text('form[' . $no . '][return_city]', $ro['return_city'],['class' => 'form-control','style'=>'width:60px','readonly' => 'readonly']) !!}</td>
                                            @endif
                                            @if(isset($errors[$no]['return_email_address']))
                                                <td>{!! Form::text('form[' . $no . '][return_email_address]', $ro['return_email_address'],['class' => 'form-control is-invalid','style'=>'width:auto']) !!}<font color="red">{{$errors[$no]['return_email_address']}}</font></td>
                                            @else
                                                <td>{!! Form::text('form[' . $no . '][return_email_address]', $ro['return_email_address'],['class' => 'form-control','style'=>'width:60px','readonly' => 'readonly']) !!}</td>
                                            @endif
...
@section('js')
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.self_collection').select2({
                width: '100%',
                placeholder: 'Self Collection'
            });
