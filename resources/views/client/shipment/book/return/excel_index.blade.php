...
@section('title', 'Book Return Address Excel Shipment(s)')
    ...
    <div class="app-content content">
        <div class="content-wrapper">
            ...
            <div class="content-body">
                <h1 class="mb-1">
                    Book Return Address Excel Shipment(s)
                </h1>
                ...
                <div class="card">
                    <div class="card-content" aria-expanded="true">
                        <div class="card-body">
                            ...
                            <form id="booking_form" class="form-horizontal" method="POST" action="{{ route('cod.shipment.book.return_address.excel.store') }}" novalidate="novalidate" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                    ...
                                    <div class="col-6">
                                        <div class="form-group text-right">
                                            @if(session('account_type') == 1)
                                                <a href="{{ asset('file/Trax Book Regular Shipment With Return Address Template.xlsx') }}?v=09_06_2021" class="btn btn-primary btn-lg"><i class="la la-download"></i> Regular Template Download</a>
                                            @else
                                                <a href="{{ asset('file/Trax Book Corporate Regular Shipment With Return Address Template.xlsx') }}?v=09_06_2021" class="btn btn-primary btn-lg"><i class="la la-download"></i> Regular Template Download</a>
                                            @endif
                                        </div>
                                    </div>
                                </div>
