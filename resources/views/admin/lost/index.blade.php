    ...
    $(document).ready(function(){
        ...
        var table = $('#datatable').DataTable({
            ...
            rowCallback: function(row, data, index) {
                ...
                if ((data.approval == 0 && data.permission != 944 || (data.approval >= 1 && data.permission != 944  && data.cleared == 0)) || (data.permission != 944 && data.shipment_cleared == null) || (data.permission != 944 && data.verification == 1)) {
                    $('td:eq(0)', row).removeClass('select-checkbox');
                }
