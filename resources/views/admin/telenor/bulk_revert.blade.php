...
@section('title', 'Telenor Bulk Revert')
                ...
                <div class="card">
                    <div class="card-content" aria-expanded="true">
                        <div class="card-body">
                            ...
                            <form id="revert_form" class="form-horizontal" method="POST" action="{{ route('admin.telenor.revert.bulk_revert_submit') }}" novalidate="novalidate" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                ...
                                <div class="row align-items-center justify-content-center">
                                    ...
                                    <div class="col ml-auto">
                                        <div class="form-group text-right">
                                            <a href="{{ asset('file/Telenor Bulk Revert.xlsx') }}?v=21_10_2020" class="btn btn-primary"><i class="la la-download"></i> Download Template</a>
                                        </div>
                                    </div>
                                </div>
                            </form>
        ...
        $(document).ready(function() {
            ...
            $('#revert_form').validate({
                ...
                submitHandler: function(form) {
                    ...
                    swal({
                        title: 'Please Wait!',
                        text: 'Your shipment(s) are being reverted!',
                        icon: 'info',
                        buttons: false,
