...
@section('title', 'Edit In-Process Escalation')
                    ...
                    <div class="card-content" aria-expanded="true">
                        <div class="card-body">
                            ...
                            <div class="row justify-content-center">
                                <form id="settings_form" class="form-horizontal text-center" method="POST" action="{{ route('admin.settings.escalation.in_process.edit.store') }}" novalidate="novalidate">
                                    {{ csrf_field() }}
            ...
            $('#settings_form').validate({
                ...
                submitHandler: function(form) {
                    ...
                    if(checked > 0){
                        ...
                        swal({
                            title: 'Are You Sure?',
                            text: 'Select Yes to add In-Process Escalation!',
                            icon: 'warning',
                            buttons: {
                                cancel: {
                                    text: 'No',
