                ...
                <div class="row mb-2 justify-content-center">
                    <div class="col-12 ">
                        <form id="search_form" class="form-inline mb-1 justify-content-center" novalidate="novalidate">
                            ...
                            <div class="col-4">
                                <fieldset class="form-group">
                                    <select name="search_rider_category" id="search_rider_category" class="form-control select2"
                                        multiple="multiple">
                                        @foreach ($rider_category as $ridercategory)
                                            <option value="{{ $ridercategory->id }}">{{ $ridercategory->name }}</option>
                                        @endforeach
                                    </select>
                                </fieldset>
                            </div>
                            ...
                            <div class="col-4">
                                <div class="form-group input-group">
                                    ...
                                    <input type="text" name="delivery_note_created_date_from"
                                        class="form-control bg-primary border-primary white rounded-right" id="delivery_note_created_date_from"
                                        placeholder="Delivery Note Created Date (From)" data-value="{{$today}}">
                                </div>
                            </div>
                            <div class="col-4">
                                <div class="form-group input-group">
                                    ...
                                    <input type="text" name="delivery_note_created_date_to"
                                        class="form-control bg-primary border-primary white rounded-right" id="delivery_note_created_date_to"
                                        placeholder="Delivery Note Created Date (To)" data-value="{{$today}}">
                                </div>
                            </div>
                            <div class="col-4 mt-1">
                                <div class="form-group input-group">
                                    ...
                                    <input type="text" name="update_date_from"
                                        class="form-control bg-primary border-primary white rounded-right" id="update_date_from"
                                        placeholder="Update Date (From)" data-value="{{$today}}">
                                </div>
                            </div>
                            <div class="col-4 mt-1">
                                <div class="form-group input-group">
                                    ...
                                    <input type="text" name="update_date_to"
                                        class="form-control bg-primary border-primary white rounded-right" id="update_date_to"
                                        placeholder="Update Date (To)" data-value="{{$today}}">
                                </div>
                            </div>
