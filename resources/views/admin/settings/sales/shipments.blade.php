...
@section('title', 'Projected Shipments')
                                ...
                                <div class="col-5">
                                    <form id="settings_form" class="form-horizontal text-center" method="POST" action="{{ route('admin.settings.sales.projection.shipments.store') }}" novalidate="novalidate">
                                        ...
                                        <div class="form-group">
                                            <select name="shippers[]" id="shipper_select" class="form-control select2" multiple="multiple" data-msg-required="Atleast one Shipper is required" data-rule-require="true" required="required">
                                        ...
                                        <div class="form-group">
                                            <div class="input-group">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text">Projected Shipments/Day</span>
                                                </div>
                                                <input type="text" name="projected_shipment" class="form-control class" placeholder="Projected Shipments/Day*" data-rule-required="true" data-msg-required="Projected Shipments/Day is required" value="">
                                ...
                                <div class="row justify-content-center">
                                    <table class="table table-bordered datatable" id="datatable" style="z-index: 3;">
                                        ...
                                        <tr role="row" class="bg-primary white">
                                            ...
                                            <th class="border-primary border-darken-1">Projected Shipment</th>
