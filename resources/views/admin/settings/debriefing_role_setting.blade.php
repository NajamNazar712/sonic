...
@section('title', 'Caller Agent Role Assigning')
                                ...
                                <form id="settings_form" class="form-horizontal text-center" method="POST" action="{{ route('admin.settings.debriefing_role_setting.update') }}" novalidate="novalidate">
                                    ...
                                    <div class="row mb-2 justify-content-center">
                                        <div class="col-12 form-group">
                                            <select name="roles[]" id="roles_select" class="form-control select2" multiple="multiple" data-msg-required="Atleast One Role Is Required" data-rule-required="true" required="required">
    ...
    $(document).ready(function() {
        ...
        $('#settings_form').validate({
            ...
            , submitHandler: function(form) {
                swal({
                    title: 'Are You Sure?'
                    , text: 'Select Yes to update Roles!'
                    , icon: 'warning'
                    , buttons: {
                        cancel: {
                            text: 'No'
