        ...
        $(document).ready(function () {
            ...
            var table = $('#datatable').DataTable({
                ...
                columns: [
                    ...
                    {data: 'holiday', name: 'holidays.holiday', class: 'align-middle holiday'},
                    {data: 'reason', name: 'holidays.reason', class: 'align-middle reason'},
                    {data: 'created_at', name: 'holidays.created_at', class: 'align-middle created_at'},
            ...
            $('#add_holiday_button').on('click', function () {
                ...
                if(flag){
                    ...
                    $.ajax({
                        url: '{!! route('admin.settings.holidays.add') !!}',
                        method: 'POST',
                        data: {
                            '_token': '{{ csrf_token() }}',
