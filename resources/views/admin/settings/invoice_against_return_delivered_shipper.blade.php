...
@section('title', 'Invoice Return Delivered Shipper')
...
<div class="app-content content">
    <div class="content-wrapper">
        ...
        <div class="content-body">
            <h1 class="mb-1">
                Invoice Against Return Delivered Shipment
            </h1>
                ...
                <div class="card-content" aria-expanded="true">
                    <div class="card-body">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-6">
                                <form id="settings_form" class="form-horizontal text-center" method="POST" action="{{ route('admin.settings.invoice_against_return_delivered_shipper.store') }}" novalidate="novalidate">
                                    {{ csrf_field() }}
