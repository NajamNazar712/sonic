...
@section('title', 'Specified Shippers')
...
@section('content')
    <div class="app-content content">
        ...
        <div class="modal fade text-left" id="AddStarShipper" data-backdrop="static" tabindex="-1" role="dialog"
             aria-labelledby="AddAlistShipper"
             aria-hidden="true">
            <div class="modal-dialog modal-md" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id="">Add AList Shippers</h4>
                    </div>
                    <form method="post" id="star_shipper_add" action="{{route('admin.settings.star_shippers.add')}}">
                        @csrf
                        <div class="modal-body">
                            <input type="hidden" value="2" name="shipper_type"/>
    ...
    <script>
        $(document).ready(function () {
            ...
            var table = $('#datatable').DataTable({
                ...
                buttons: [
                        @if (session('role_id') == 1 || in_array(1006, session('permissions')))
                    {
                ...
                ajax: '{{ route('admin.settings.alist_shippers.list') }}',
                rowId: 'id',
                order: [[3, 'desc']],
                columns: [
                    {
