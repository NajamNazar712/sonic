...
@section('title', 'Short Receive Report Hub Wise Time')
    ...
    <div class="app-content content">
        <div class="content-wrapper">
            ...
            <div class="content-body">
                <h1 class="mb-1">
                    Short Receive Report Hub Wise Time
                </h1>
                                        ...
                                        @if(count($existing_cities))
                                            @foreach($existing_cities as $index => $ext_city)
                                                <div class="row justify_content_center mb-1">
                                                    <div class="col">
                                                        <div class="form-group">
                                                            <select name="cities[{{$index}}]" id="cities_select_{{$index}}" class="select2 form-control cities_select" data-rule-required="true" data-msg-required="This field is required" disabled>
                                                                @foreach($cities as $city)
                                                                    @if($ext_city->hub_id == $city->id)
                                                    ...
                                                    <div class="col">
                                                        <div class="form-group">
                                                            <input type="text" name="time[{{$index}}]" id="time_{{$index}}" class="form-control time" value="{{$ext_city->time}}" placeholder="Value" data-rule-required="true" data-msg-required="This field is required">
                                                        </div>
                                                    </div>
                                                </div>
                                            @endforeach
