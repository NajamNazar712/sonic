...
@section('title', 'Shipper(s) Return Shipment(s) Address Change')
    ...
    <div class="app-content content">
        <div class="content-wrapper">
            ...
            <div class="content-body">
                <h1 class="mb-1">
                    Shipper(s) Return Shipment(s) Address Change (Excel)
                </h1>
                    ...
                    <div class="card-content" aria-expanded="true">
                        <div class="card-body">
                            ...
                            <div class="row justify-content-center">
                                <div class="col-6">
                                    <form id="settings_form" class="form-horizontal text-center" method="POST" action="{{ route('admin.settings.return_shipments_address.store') }}" novalidate="novalidate">
                                        {{ csrf_field() }}
...
@section('js')
    ...
    <script>
        $(document).ready(function() {
            ...
            @if(count($return_shipments_address_change_shippers) > 0)
            var ids = @json($return_shipments_address_change_shippers);
            ...
            $('#settings_form').validate({
                ...
                submitHandler: function (form) {
                    swal({
                        title: 'Are You Sure?',
                        text: 'Select Yes to update Shipper!',
                        icon: 'warning',
                        buttons: {
                            cancel: {
                                text: 'No',
