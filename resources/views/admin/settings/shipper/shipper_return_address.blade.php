...
@section('title', 'Shipper(s) Return Address Feature')
    ...
    <div class="app-content content">
        <div class="content-wrapper">
            ...
            <div class="content-body">
                <h1 class="mb-1">
                    Shipper(s) Return Address Feature
                </h1>
                    ...
                    <div class="card-content" aria-expanded="true">
                        <div class="card-body">
                            ...
                            <div class="row justify-content-center">
                                <div class="col-6">
                                    <form id="settings_form" class="form-horizontal text-center" method="POST" action="{{ route('admin.settings.shippers_return_address.store') }}" novalidate="novalidate">
                                        {{ csrf_field() }}
...
@section('js')
    ...
    <script>
        $(document).ready(function() {
            ...
            @if(count($shipper_return_address) > 0)
            var ids = @json($shipper_return_address);
            ...
            $('#settings_form').validate({
                ...
                submitHandler: function (form) {
                    swal({
                        title: 'Are You Sure?',
                        text: 'Select Yes to update Shipper Return Address!',
                        icon: 'warning',
                        buttons: {
                            cancel: {
                                text: 'No',
