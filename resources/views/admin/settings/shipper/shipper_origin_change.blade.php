...
@section('title', 'Shipper Origin Change')
                    ...
                    <div class="card-content" aria-expanded="true">
                        <div class="card-body">
                            ...
                            <div class="row justify-content-center">
                                <div class="col-6">
                                    <form id="settings_form" class="form-horizontal text-center" method="POST" action="{{ route('admin.settings.shippers_origin_change.store') }}" novalidate="novalidate">
                                        {{ csrf_field() }}
...
@section('js')
    ...
    <script>
        $(document).ready(function() {
            ...
            @if(count($shipper_origin_change) > 0)
            var ids = @json($shipper_origin_change);
            ...
            $('#settings_form').validate({
                ...
                submitHandler: function (form) {
                    swal({
                        title: 'Are You Sure?',
                        text: 'Select Yes to update Shipper Origin Change!',
                        icon: 'warning',
                        buttons: {
                            cancel: {
                                text: 'No',
