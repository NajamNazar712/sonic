...
@section('title', 'Bypassing of weight entry')
                        ...
                        <div class="card-body">
                            ...
                            <div class="row justify-content-center">
                                <div class="col-6">
                                    ...
                                    <form id="settings_form" class="form-horizontal text-center" method="POST" action="{{ route('admin.settings.shippers.bypass_weight.update') }}" novalidate="novalidate">
                                        {{ csrf_field() }}
...
@section('js')
    ...
    <script>
        $(document).ready(function() {
            ...
            @if(count($bypassed_shippers) > 0)
                var ids = @json($bypassed_shippers);
            ...
            $('#settings_form').validate({
                ...
                submitHandler: function (form) {
                    swal({
                        title: 'Are You Sure?',
                        text: 'Select Yes to update Bypassing of weight entry!',
                        icon: 'warning',
                        buttons: {
                            cancel: {
                                text: 'No',
