...
@section('title', 'T Payment Cash Shippers')
                    ...
                    <div class="card-content" aria-expanded="true">
                        <div class="card-body">
                            ...
                            <div class="row justify-content-center">
                                <div class="col-6">
                                    <form id="settings_form" class="form-horizontal text-center" method="POST" novalidate="novalidate" action="{{ route('admin.settings.t_payment_cash_shippers.store') }}">
                                        {{ csrf_field() }}
...
@section('js')
    ...
    <script>
        $(document).ready(function() {
            ...
            @if(count($t_payment_cash_shippers) > 0)
            var ids = @json($t_payment_cash_shippers);
