                            ...
                            <form id="settings_form" class="form-horizontal row justify-content-center" method="POST" action="{{ route('admin.settings.minimum_chargeable_weight.update') }}" novalidate="novalidate">
                                ...
                                <div class="col-4">
                                    <div class="form-group row">
                                        <h4 class="text-center" style="text-align: left"><b>Overnight*:</b></h4>
                                    ...
                                    <div class="form-group row">
                                        <h4 class="text-center" style="text-align: left"><b>Overland*:</b></h4>
                                    ...
                                    <div class="form-group row">
                                        <h4 class="text-center" style="text-align: left"><b>Detain*:</b></h4>
