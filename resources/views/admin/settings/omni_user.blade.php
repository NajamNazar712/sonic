                    ...
                    <div class="card-content" aria-expanded="true">
                        <div class="card-body">
                            ...
                            <div class="row justify-content-center">
                                <div class="col-6">
                                    <form id="settings_form" class="form-horizontal text-center" method="POST" action="{{ route('admin.settings.omni.update') }}" novalidate="novalidate">
                                        {{ csrf_field() }}
        ...
        $(document).ready(function() {
            ...
            $('#settings_form').validate({
                ...
                submitHandler: function (form) {
                    swal({
                        title: 'Are You Sure?',
                        text: 'Select Yes to update Omni Users!',
                        icon: 'warning',
                        buttons: {
                            cancel: {
                                text: 'No',
