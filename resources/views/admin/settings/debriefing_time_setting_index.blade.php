...
@section('title', 'Debriefing Time Settings')
                    ...
                    <div class="card-content" aria-expanded="true">
                        <div class="card-body">
                            ...
                            <div class="row justify-content-center">
                                <div class="col-2">
                                    <form id="settings_form" class="form-horizontal text-center" method="POST" action="{{ route('admin.settings.debriefing_time_setting.update') }}" novalidate="novalidate">
                                        {{ csrf_field() }}
