...
@section('title', 'Airway Bill Address Visibility')
    ...
    <div class="app-content content">
        <div class="content-wrapper">
            ...
            <div class="content-body">
                <h1 class="mb-1">
                    Airway Bill Address Visibility
                </h1>
                    ...
                    <div class="card-content" aria-expanded="true">
                        <div class="card-body">
                            ...
                            <div class="row justify-content-center">
                                <div class="col-6">
                                    <form id="settings_form" class="form-horizontal text-center" method="POST" action="{{ route('admin.settings.airway_bill_address_visibility.store') }}" novalidate="novalidate">
                                        {{ csrf_field() }}
        ...
        $(document).ready(function() {
            ...
            $('#rider_select').prepend('<option value="" selected="selected"></option>').select2({
                ...
                allowClear:true
                    ...
                    @if(count($airway_bill_address_visibility_accounts) > 0)
            var ids = @json($airway_bill_address_visibility_accounts);
            ...
            $('#settings_form').validate({
                ...
                submitHandler: function (form) {
                    swal({
                        title: 'Are You Sure?',
                        text: 'Select Yes to update Airway Bill Address Visibility!',
                        icon: 'warning',
                        buttons: {
                            cancel: {
                                text: 'No',
