...
@section('title', 'View Delivery Area')
                                ...
                                <div class="col">
                                    <form id="settings_form" class="form-horizontal text-center" method="POST" action="{{ route('admin.settings.delivery_area_keyword.update') }}" novalidate="novalidate">
                                        ...
                                        <div class="form-group text-center">
                                            <input type="text" id="area_name" name="area_name" class="form-control area_name text-center" placeholder="Write Area Name*" data-rule-required="true" data-msg-required="Area Name is required" data-tags-input-name="area_name" value="{{$delivery_location->area_name}}" disabled>
...
@section('js')
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#delivery_area_keyword')[0].selectize.disable();
