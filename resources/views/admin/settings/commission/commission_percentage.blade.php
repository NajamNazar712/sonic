...
@section('title', 'Commission Percentage')
                        ...
                        <div class="card-body">
                            ...
                            <div class="row justify-content-center">
                                <div class="col-5 col-sm-4 col-md-3 col-lg-2">
                                    <form id="settings_form" class="form-horizontal text-center" method="POST" action="{{ route('admin.settings.commission.percentage.store') }}" novalidate="novalidate">
                                        {{ csrf_field() }}
...
@section('js')
    ...
    <script>
        $(document).ready(function() {
            $('#settings_form input.commission_percentage').inputmask({
                'alias': 'integer',
                'allowMinus': false,
                'allowPlus': false
            });
