...
@section('title', 'Complaint Portal Shippers')
                    ...
                    <div class="card-content" aria-expanded="true">
                        <div class="card-body">
                            ...
                            <div class="row justify-content-center">
                                <div class="col-6">
                                    <form id="settings_form" class="form-horizontal text-center" method="POST" action="{{ route('admin.settings.complain_portal_shippers.update') }}" novalidate="novalidate">
                                        {{ csrf_field() }}
        ...
        $(document).ready(function() {
            ...
            $('#settings_form').validate({
                ...
                submitHandler: function (form) {
                    swal({
                        title: 'Are You Sure?',
                        text: 'Select Yes to update Complaint Portal Shippers!',
                        icon: 'warning',
                        buttons: {
                            cancel: {
                                text: 'No',
