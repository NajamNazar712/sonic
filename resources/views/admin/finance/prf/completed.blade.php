...
@section('title','Payment Requisition Completed/Canelled List')

@section('content')
    <h1 class="mb-1">
        Payment Requisition Completed/Canelled List
    </h1>
        ...
        $(document).ready(function () {
            ...
            jQuery.fn.DataTable.Api.register( 'buttons.exportData()', function ( options ) {
                if ( this.context.length ) {
                    ...
                    params.excel = true;
                    var jsonResult = $.ajax({
                        url: '{{ route('admin.finance.prf.ajaxCompletedList') }}',
                        data: params,
                        success: function (result) {
                            ...
                            $.each(result.data, function(index, values) {
                                ...
                                // row.push(values.status_date); // Status Date
            ...
            var table = $('#datatable').DataTable({
                ...
                columns: [
                    ...
                    {data: 'created_at', name: 'payment_requisitions.created_at', class: 'align-middle requested_date'},
