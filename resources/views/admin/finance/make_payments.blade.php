...
{{--                                            @endforeach--}}
                                ...
                                <div class="col-3">
                                    <form id="positive_negative_filter_form" class="mb-1 justify-content-center"
                                        novalidate="novalidate">
                                        <div class="form-group">
                                            <select name="positive_negative_filter"
                                                class="select2 positive_negative_filter">
                                ...
                                <div class="col-3">
                                    <form id="shipper_status_form" class="mb-1 justify-content-center"
                                        novalidate="novalidate">
                                        <div class="form-group">
                                ...
                                <div class="col-3">
                                    <form id="payment_cycles_form" class="mb-1 justify-content-center"
                                        novalidate="novalidate">
                                        <div class="form-group">
                                            <select name="payment_cycles" class="select2 payment_cycles"
                                                id="payment_cycles_form_val">
                                                @foreach ($payment_cycles as $payment_cycle)
                                                    <option value="{{ $payment_cycle->id }}">{{ $payment_cycle->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        </div>
                                ...
                                <div class="col-3">
                                    <form id="payment_cycle_days_form" class="mb-1 justify-content-center"
                                        novalidate="novalidate">
                                        <div class="form-group">
                                            <select name="payment_cycle_days" class="select2 payment_cycle_days"
                                                id="payment_cycle_days_val">
                                                @for ($i = 1; $i < 29; $i++)
                                                    <option value="{{ $i }}">
                                                        {{ $i . ' date' }}</option>
                                                @endfor
                                ...
                                <div class="col-3">
                                    <form id="shipper_document_status_form" class="mb-1 justify-content-center"
                                        novalidate="novalidate">
                                        <div class="form-group">
                            ...
                            <div class="row text-center">
                                <div class="col-4">
                                    ...
                                    <p class="border" id="stats_total_amount">Rs. {{ $total_amount }}</p>
                                </div>

                                <div class="col-4">
                                    <h4 class="bg-primary mb-0 text-white border">Total Charges</h4>
                                    <p class="border" id="stats_total_charges">Rs. {{ $total_charges }}</p>
                                </div>

                                <div class="col-4">
                                    <h4 class="bg-primary mb-0 text-white border">Total Payable</h4>
                                    <p class="border" id="stats_total_payable">Rs. {{ $total_payable }}</p>
                                </div>
                            </div>
                                ...
                                <div class="card-header">
                                    <div class="heading-elements">
                                        <ul class="list-inline">
                                            <li class="primary border-primary round" value="0"
                                                id="star_shippers_filter"><a>
                                                    Star Shippers</a>
                                            </li>
                                        </ul>
                                    </div>
                            ...
                            <div class="modal fade" id="delivered_shipments" role="dialog"
                                aria-labelledby="delivered_shipments_title" aria-hidden="true">
                                <div class="modal-dialog modal-sm" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h4 class="modal-title" id="delivered_shipments_title">Delivered Shipment(s)
                                            </h4>
                            ...
                            <div class="modal fade" id="returned_shipments" role="dialog"
                                aria-labelledby="returned_shipments_title" aria-hidden="true">
                                <div class="modal-dialog modal-sm" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h4 class="modal-title" id="returned_shipments_title">Returned Shipment(s)
                                            </h4>
                            ...
                            <div class="modal fade" id="adjusted_shipments" role="dialog"
                                aria-labelledby="adjusted_shipments_title" aria-hidden="true">
                                <div class="modal-dialog modal-sm" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h4 class="modal-title" id="adjusted_shipments_title">Adjusted Shipment(s)
                                            </h4>
                            ...
                            <div class="modal fade" id="view_details" role="dialog"
                                aria-labelledby="view_details_title" aria-hidden="true">
                            ...
                            <div class="modal fade" id="make_payments" role="dialog"
                                ...
                                <div class="modal-dialog modal-lg modal-full-length" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h4 class="modal-title" id="make_payments_title">Make Payments<span></span>
                                            </h4>
...
@section('css')
    <link rel="stylesheet" type="text/css" href="{{ asset('app-assets/vendors2/css/forms/selects/select2.min.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('app-assets/vendors2/css/extensions/toastr.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('app-assets/vendors2/css/pickers/pickadate/pickadate.css') }}">
    <link rel="stylesheet" type="text/css"
        href="{{ asset('app-assets/css/plugins/pickers/daterange/daterange.min.css') }}">
@endsection

@section('js')
    <script src="{{ asset('app-assets/vendors2/js/forms/extended/inputmask/jquery.inputmask.bundle.min.js') }}"
        type="text/javascript"></script>
    <script src="{{ asset('app-assets/vendors2/js/forms/select/select2.full.min.js') }}" type="text/javascript"></script>
    <script src="{{ asset('app-assets/vendors2/js/extensions/toastr.min.js') }}" type="text/javascript"></script>
    <script src="{{ asset('app-assets/vendors2/js/forms/validation/jquery.validate.min.js') }}" type="text/javascript">
    </script>
    <script src="{{ asset('js/datatable_buttons.js') }}" type="text/javascript"></script>
    <script src="{{ asset('app-assets/vendors2/js/pickers/pickadate/picker.js') }}" type="text/javascript"></script>
    <script src="{{ asset('app-assets/vendors2/js/pickers/pickadate/picker.date.js') }}" type="text/javascript"></script>
    <script src="{{ asset('app-assets/vendors2/js/pickers/pickadate/legacy.js') }}" type="text/javascript"></script>
            ...
            var table = $('#datatable').DataTable({
                ...
                ajax: {
                    ...
                    data: function(d) {
                        ...
                        d.positive_negative_filter = $(
                            '#positive_negative_filter_form select.positive_negative_filter').val();
                        ...
                        d.payment_cycle_days = $('#payment_cycle_days_form select.payment_cycle_days')
                            .val();
                ...
                columns: [{
                    ...
                    },
                    {
                        data: 'address',
                        name: 'u.address',
                        class: 'align-middle text-center address'
                    },
                    {
                        data: 'created_at',
                        name: 'pending_payments.created_at',
                        class: 'align-middle text-center created_at'
                    },
                    {
                        data: 'total_shipments',
                        name: 'pending_payments.total_shipments',
                        class: 'align-middle text-center total_shipments'
                    },
                    {
                        data: 'total_pending_shipments',
                        name: 'total_pending_shipments',
                        class: 'align-middle text-center total_pending_shipments',
                        orderable: false
                    },
                    {
                        data: 'delivered_shipments',
                        name: 'pending_payments.delivered_shipments',
                        class: 'align-middle text-center delivered_shipments'
                    },
                    {
                        data: 'returned_shipments',
                        name: 'pending_payments.returned_shipments',
                        class: 'align-middle text-center returned_shipments'
                    },
                    {
                        data: 'adjusted_shipments',
                        name: 'pending_payments.adjusted_shipments',
                        class: 'align-middle text-center adjusted_shipments'
                    },
                    {
                        data: 'total_amount',
                        name: 'ppc.amount',
                        class: 'align-middle text-center total_amount',
                        orderable: false
                    },
                    {
                        data: 'total_charges',
                        name: 'ppc.charges',
                        class: 'align-middle text-center total_charges',
                        orderable: false
                    },
                    {
                        data: 'total_gst',
                        name: 'ppc.gst',
                        class: 'align-middle text-center total_gst',
                        orderable: false
                    },
                    {
                        data: 'total_wht',
                    ...
                    },
                    {
                        data: 'total_payable',
                        name: 'ppc.payable',
                        class: 'align-middle text-center total_payable',
                        orderable: false
                    },
                    {
                        data: 'bank',
                        name: 'bank',
                        class: 'align-middle text-center bank'
                    },
                    {
                        data: 'bank_branch',
                        name: 'ubi.bank_branch',
                        class: 'align-middle text-center bank_branch'
                    },
                    {
                        data: 'account_no',
                        name: 'ubi.account_no',
                        class: 'align-middle text-center account_no'
                    },
                    {
                        data: 'account_title',
                        name: 'ubi.account_title',
                        class: 'align-middle text-center account_title'
                    },
                    {
                        data: 'iban',
                        name: 'ubi.iban',
                        class: 'align-middle text-center iban'
                    },
                    {
                        data: 'account_city',
                        name: 'bc.name',
                        class: 'align-middle text-center account_city'
                    },
                    {
                        data: 'payment_cycle',
                        name: 'pc.id',
                        class: 'align-middle text-center payment_cycle'
                    },
                    {
                        data: 'payment_cycle_days',
                        name: 'u.payment_cycle_days',
                        class: 'align-middle text-center payment_cycle_days'
                    },
                    {
                        data: 'return_shipments_average_aging',
                ...
                initComplete: function() {
                    ...
                    var bank_select =
                        '<select name="bank_select" id="bank_select" class="select2 form-control"></select>';
                    ...
                    this.api().columns().every(function(column_id) {
                        ...
                        if ($(header).is('.select') || $(header).is('.serial_number') || $(
                                header).is('.total_amount') || $(header).is('.total_charges') ||
                            $(header).is('.total_gst') || $(header).is('.total_deductable') ||
                            $(header).is('.total_payable') || $(header).is(
