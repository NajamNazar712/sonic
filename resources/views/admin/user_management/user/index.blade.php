...
@section('content')
    <div class="app-content content">
        <div class="content-wrapper">
            ...
            <div class="content-body">
                ...
                <div class="modal fade text-left" id="AssignHubModal" data-backdrop="static" tabindex="-1" role="dialog"
                    aria-labelledby="AddTierModal" aria-hidden="true">
                                        ...
                                        <div class="row justify-content-center">
                                            <div class="col-6">
                                                <button id="edit" type="submit"
                                                    class="btn btn-primary btn-block">Assign Hub</button>
                                            </div>
                                        </div>
                                    </div>
                                </form>
                            ...
                            <div class="row justify-content-center mb-4">
                                <div class="col-4">
                                    <fieldset class="form-group">
                                        <select name="search_roles[]" id="search_roles" class="form-control select2"
                                            multiple="multiple" required data-rule-required="true"
                                            data-msg-required="This field is required">
                                            @foreach ($roles as $role)
                                                <option value="{{ $role->id }}">{{ $role->name }} -
                                                    {{ $role->department->name }}</option>
                                            @endforeach
                                        </select>
                                    </fieldset>
                                </div>
    ...
    <div class="modal fade text-left" id="PhoneUpdateModal" data-backdrop="static" tabindex="-1" role="dialog"
        aria-labelledby="PhoneUpdateModal" aria-hidden="true">
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    <form id="update_phone_form" action="{{ route('admin.user_management.users.phone_update') }}"
                        method="post">
                        @method('POST')
                        @csrf
                        <div class="container">
                            ...
                            <div class="form-group">
                                <input type="text" name="phone_number" id="phone" class="form-control"
                                    data-rule-required="true" data-msg-required="Phone Number required">
                            </div>
                            <div class="row justify-content-center">
                                <div class="col-6">
        ...
        $(document).ready(function() {
            ...
            var table = $('#datatable').DataTable({
                ...
                @if (session('role_id') == 1 || in_array(82, session('permissions')))
                    buttons: [{
                            ...
                            action: function(e, dt, node, config) {
                                window.location =
                                    '{{ route('admin.user_management.users.add.index') }}';
                            }
                        }, {
                ...
                columns: [{
                    ...
                    {
                        data: 'phone_number',
                        name: 'admins.phone_number',
                        class: 'align-middle phone_number'
                    },
                    {
                        data: 'official_phone_number',
                        name: 'admins.official_phone_number',
                        class: 'align-middle official_phone_number'
                    },
                    {
                        data: 'email',
                        name: 'admins.email',
                        class: 'align-middle email'
                    },
                    {
                        data: 'cnic',
                        name: 'admins.cnic',
                    ...
                    {
                        data: 'designation',
                        name: 'admins.designation',
                        class: 'align-middle designation'
                    },
                    {
                        data: 'role',
                        name: 'role',
                        class: 'align-middle role'
                    },
                    {
                        data: 'default_hub',
                        name: 'h.name',
                        class: 'align-middle default_hub'
                    },
                    {
                        data: 'created_at',
                        name: 'admins.created_at',
                        class: 'align-middle created_at'
                    },
                    {
                        data: 'updated_at',
                        name: 'admins.updated_at',
