				...
				<div class="card">
					<div class="card-content" aria-expanded="true">
						<div class="card-body">
							...
							<form id="role_form" class="form-horizontal" method="POST" action="{{ route('admin.user_management.roles.bulk_add.store') }}" novalidate="novalidate">
								{{ csrf_field() }}
								...
								<div class="row">
									...
									<div class="col-12">
										<div class="form-group text-center">
											<button type="submit" class="btn btn-primary">Bulk Add</button>
										</div>
									</div>
								</div>
								</form>
