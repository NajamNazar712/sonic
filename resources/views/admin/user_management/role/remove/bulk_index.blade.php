...
@section('title', 'Bulk Remove Role')
				...
				<div class="card">
					<div class="card-content" aria-expanded="true">
						<div class="card-body">
							...
							<form id="role_form" class="form-horizontal" method="POST" action="{{ route('admin.user_management.roles.bulk_remove.store') }}" novalidate="novalidate">
								{{ csrf_field() }}
								...
								<div class="row">
									...
									<div class="col-12">
										<div class="form-group text-center">
											<button type="submit" class="btn btn-primary">Bulk Remove</button>
										</div>
									</div>
								</div>
								</form>
		...
		$(document).ready(function() {
			...
			$('#role_form .permission').each(function() {
				...
				checkbox.iCheck({
					...
					uncheckedClass: 'checked bg-success',
