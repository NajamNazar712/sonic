...
@section('title','Unable to Return')
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var table = $('#datatable').DataTable({
                ...
                order: [[14, 'desc']],
                columns: [
                    {data: 'shId', orderable: false, searchable: false, class: 'align-middle serial_number', targets: 0, render: function (data, type, row) {return '';}},
