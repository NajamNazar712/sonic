                    ...
                    $.ajax({
                        ...
                        .done(function(data) {
                            if (data) {
                                ...
                                tableHtml +=
                                    '<thead class="text-center"><tr><th class="p-1">Calling Date</th><th>Calling Time</th><th>Call Findings</th><th>Un Responsive Finding</th><th>Others</th><th>Call To</th><th>Status</th><th>User</th></tr></thead>';
