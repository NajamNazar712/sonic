...
@section('title', 'Packaging Stock Inventory')
<meta name="csrf-token" content="{{ csrf_token() }}">
@section('content')
    <h1 class="mb-1">
        Packaging Stock Inventory
    </h1>
            ...
            <div class="card-body">
                ...
                <table class="table table-bordered datatable" id="datatable" style="z-index: 3;">
                    ...
                    <tr role="row" class="bg-primary white">
                        ...
                        <th class="border-primary border-darken-1">Master Warehouse ({{$master_warehouse->name}})</th>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var table = $('#datatable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: '{{ route('admin.packaging.inventory.list') }}',
                    method: 'POST',
                    headers: {
                ...
                initComplete: function() {
                    ...
                    this.api().columns().every(function(column_id) {
                        ...
                        if ($(header).is('.serial_number') || $(header).is('.counts') || $(header).is('.total') || $(header).is('.master_warehouse')) {
                            $(td).appendTo($(search));
                        }
                        else {
