                            ...
                            <form id="add_shipment_form" class="mb-1 justify-content-center" novalidate="novalidate">
                                ...
                                <div class="row text-center justify-content-center align-items-center">
                                    ...
                                    <div class="col">
                                     ...
                                     <div class="col">
                                         <div class="form-group ml-1 volumetric_weights">
                                             <input type="text" name="breadth" class="form-control form-control-sm breadth" placeholder="Breadth (cm)*" data-rule-required="true" data-msg-required="Breadth is required" data-rule-range="[0.1,375]" data-msg-range="Length needs to be from 0.1 to 375" disabled="disabled" data-rule-volumecheck="true" data-msg-volumecheck="Total weight cannot be less than 0.1" id="breadth">
                                         </div>
                                     </div>
                                     <div class="col">
                                         <div class="form-group ml-1 volumetric_weights">
                                             <input type="text" name="height" class="form-control form-control-sm height" placeholder="Height (cm)*" data-rule-required="true" data-msg-required="Height is required" data-rule-range="[0.1,375]" data-msg-range="Length needs to be from 0.1 to 375" disabled="disabled" data-rule-volumecheck="true" data-msg-volumecheck="Total weight cannot be less than 0.1" id="height">
                                         </div>
