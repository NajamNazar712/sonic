                            ...
                            <div class="card-body">
                                ...
                                <div class="card text-white box-shadow-0 bg-gradient-y-primary">
                                    <div class="card-header">
                                        ...
                                        <div class="heading-elements">
                                            <ul class="list-inline mb-0">
                                                <li><a href="{{ asset('file/documents/trax-plugin-wordpress-reimbursement 1.8.zip') }}" class="btn btn-secondary round btn-min-width mr-1 mb-1"> <i class=" ft-download"></i> Download for Reimbursement Account</a></li>
                                            </ul>
                                            <ul class="list-inline mb-0">
                                                <li><a href="{{ asset('file/documents/trax-plugin-wordpress-corporate 1.8.zip') }}" class="btn btn-secondary round btn-min-width mr-1 mb-1"> <i class=" ft-download"></i> Download for Corporate Account</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="card-content collapse show">
