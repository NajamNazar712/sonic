                    ...
                    <div class="card-content" aria-expanded="true">
                        <div class="card-body">
                            ...
                            <form id="nps_form" class="form-horizontal" method="POST"
                                  action="{{ route('admin.nps.update',$id) }}" novalidate="novalidate">
                                {{ csrf_field() }}

                                <div class="row">
                                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                                        <div class="form-group input-group ">
                                            <input type="text" class="form-control" name="survey_name" value="{{$nps_survey->survey_name}}"
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                                        <div class="form-group input-group ">
                                            ...
                                            <select name="shipper_ids[]" id="shippers_select" class="form-control select2"
                                                    multiple="multiple" {{$nps_survey->all_shipper == 1 ? 'disabled' : ''}}
                                                    data-msg-required="Atleast one shipper is required"
                                                    data-rule-required="true" required="required">
                                                @php $shiper_ids = explode(',',$nps_survey->shipper_ids); @endphp
                                                @foreach($shippers as $shipper)
                                                        <option {{ (in_array($shipper->id,$shiper_ids) ? 'selected' : '') }} value="{{$shipper->id}}">{{$shipper->name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="checkbox" name="all_shipper" id="all_shippers_checkbox" class="switchery all_shippers_checkbox" data-size="sm" data-switchery="true" {{$nps_survey->all_shipper == 1 ? 'checked' : ''}}>
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="checkbox" name="recommendation_box" id="recommendation_box" class="switchery recommendation_box" data-size="sm" data-switchery="true" {{$nps_survey->recommendation_box == 1 ? 'checked' : ''}}>
                                    ...
                                    <div class="col-12">
                                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                            <table class="table table-bordered table-striped text-center"
                                                ...
                                                <tbody>
                                                @foreach($nps_survey->nps_quest  as $key=>$val)
                                                    @if($key== 0)
                                                        <tr>
                                                            <td>{{$key+1}}</td>
                                                            <td> <div class="form-group" style="margin-bottom:0px"><input  data-rule-required="true" data-msg-required="Question is required" value="{{$val->question}}" class="form-control question" name="question[{{$key}}]"></div></td>
                                                        </tr>
                                                        @else
                                                        <tr>
                                                            <td>{{$key+1}}</td>
                                                            <td> <div class="form-group" style="margin-bottom:0px"><input id=question{{$key}} data-rule-required="true" data-msg-required="Question is required" value="{{$val->question}}" class="form-control question" name="question[{{$key}}]"></div>
...
@section('js')
    ...
    <script>
        ...
        var serial_no = '{{count($nps_survey->nps_quest)}}';
