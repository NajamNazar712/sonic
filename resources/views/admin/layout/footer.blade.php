<footer class="footer footer-static footer-light navbar-border navbar-shadow">
    <p class="clearfix blue-grey lighten-2 text-sm-center mb-0 px-2">
        <span class="float-md-left d-block d-md-inline-block font-weight-bold"><i class="ft-phone-call align-middle mr-1"></i><span class="align-middle">0213-877-22-22</span></span>
...
<!-- BEGIN VENDOR JS-->
<script src="{{asset('js/main-2.1.js')}}" type="text/javascript"></script>
