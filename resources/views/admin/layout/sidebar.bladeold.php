                            ...
                            <li class=" nav-item"><a href="#"><span class="menu-title"
                                ...
                                <ul class="menu-content">
                                    ...
                                    @if (session('role_id') == 1 || in_array(849, session('permissions')))
                                        <li><a class="menu-item"
                                               href="{{ route('admin.return.return_confirm_otp.index') }}">Return OTP
                                                History</a></li>
                                    @endif

                                    @if (session('role_id') == 1 || in_array(885, session('permissions')))
                                        <li><a class="menu-item"
                                               href="{{route('admin.return.shipper_return_receiving.history.index')}}">Shipper
                                                Return Receiving History</a></li>
                                    @endif
                                </ul>
                            </li>
                        @endif
                                ...
                                <ul class="menu-content">
                                    ...
                                    @if (session('role_id') == 1 ||count(array_intersect([881,882], session('permissions'))) !== 0)
                                        <li class=" nav-item"><a href="#"><span
                                                        class="menu-title">Advance Petty Cash</span></a>
                ...
                <li class=" nav-item"><a href="#"><span class="menu-title" data-i18n="nav.dash.main"><i
                    ...
                    <ul class="menu-content">
                        @if (session('role_id') == 1 || in_array(869, session('permissions')))
                            <li><a class="menu-item" href="{{ route('admin.crm.dashboard.index') }}">CRM Dashboard</a>
                            </li>
                        @endif
                        @if (session('role_id') == 1 ||
                                session('department_id') == 3 ||
            ...
            <li class=" nav-item"><a href="#"><span class="menu-title" data-i18n="nav.dash.main"><i
                ...
                <ul class="menu-content">
                    ...
                    @if (session('role_id') == 1 || in_array(862, session('permissions')))
                        <li class=" nav-item"><a href="{{ route('admin.management.riders.rider_remarks.index') }}"><span
                                        class="menu-title">Rider Remarks</span></a>
                        </li>
                    @endif

                    @if (session('role_id') == 1 || in_array(878, session('permissions')))
                        <li class=" nav-item"><a href="{{ route('admin.management.shipment_received.index') }}"><span
                                        class="menu-title">Shipment Receiver Details</span></a>
                        </li>
                    @endif
                ...
                <li class=" nav-item"><a href="#"><span class="menu-title"><i
                    ...
                    <ul class="menu-content">
                        ...
                        @if (session('role_id') == 1 || in_array(879, session('permissions')))
                            <li><a class="menu-item" href="{{ route('admin.reports.project_arrival.index') }}">Project
                                    Arrival</a></li>
                        @endif
                        @if (session('role_id') == 1 || in_array(880, session('permissions')))
                            <li><a class="menu-item" href="{{ route('admin.reports.rider_picked.index') }}">Rider-Picked
                                    Status (W/O Arrival)</a></li>
                        @endif
                        @if (session('role_id') == 1 || in_array(877, session('permissions')))
                            <li><a class="menu-item" href="{{ route('admin.reports.quick_scanned_report.index') }}">Quick
                                    Scanned Report</a></li>
                        @endif
                        @if (session('role_id') == 1 || in_array(886, session('permissions')))
                            <li><a class="menu-item" href="{{ route('admin.reports.overland.index') }}">Overland
                                    Report</a></li>
                        @endif
                                    ...
                                    @if (session('role_id') == 1 || in_array(689, session('permissions')))
                                        <li class=" nav-item"><a
                                                    href="{{ route('admin.settings.return_shipments_address.index') }}"><span
                                                        class="menu-title">Return Shipments Address Change</span></a>
                                        </li>
                                    @endif
                            ...
                            <li class=" nav-item"><a href="#"><span class="menu-title">Bookings</span></a>
                                <ul class="menu-content">
                                    ...
                                    @if (session('role_id') == 1 || in_array(887, session('permissions')))
                                        <li><a class="menu-item"
                                               href="{{ route('admin.settings.airway_bill_address_visibility.index') }}">Airway
                                                Bill Address Visibility</a></li>
                                    @endif
                                </ul>
                            </li>
                        @endif
                            ...
                            <li class=" nav-item"><a href="#"><span class="menu-title">Financials</span></a>
                                <ul class="menu-content">
                                    ...
                                    @if (session('role_id') == 1 || in_array(851, session('permissions')))
                                        <li><a class="menu-item"
                                               href="{{ route('admin.settings.fintech_company_charges.index') }}">Fintech
                                                Company Charges</a></li>
                                    @endif


                                    @if (session('role_id') == 1 || in_array(854, session('permissions')))
                                        <li><a class="menu-item"
                                               href="{{ route('admin.settings.standard_fintech_charges.index') }}">Standard
                                                Fintech Charges</a></li>
                                    @endif
                                        ...
                                        <li class=" nav-item"><a href="#"><span class="menu-title">Store
                                            ...
                                            <ul class="menu-content">
                                                ...
                                                @if (session('role_id') == 1 || in_array(584, session('permissions')))
                                                    <li><a class="menu-item"
                                                           href="{{ route('admin.retail.add.rates') }}">Retail Standard
                                                            Rates</a></li>
                                                @endif
                                                ...
                                                @if (session('role_id') == 1 || in_array(585, session('permissions')))
                                                    <li class=" nav-item"><a
                                                                href="{{route('admin.retail.international.rates.index')}}"><span
                                                                    class="menu-title">Retail Rate Upload</span></a>
                                                    </li>
                                                @endif
                ...
                <ul class="menu-content">
                    @if (session('role_id') == 1 || count(array_intersect([449, 465, 467, 478, 481, 484, 492, 506, 568, 596, 592, 613, 717, 783,829, 831,845], session('permissions'))) !== 0)
                        ...
                        @if (session('role_id') == 1 || in_array(613, session('permissions')))
                            <li><a class="menu-item" href="{{ route('admin.human_resource.leave.index')}}">Employee
                                    Leaves</a></li>
                        @endif
                        @if (session('role_id') == 1 || in_array(717, session('permissions')))
                            <li><a class="menu-item" href="{{ route('admin.human_resource.adjustment.index')}}">Employee
                                    Attendance Adjustment</a></li>
                        @endif
                        @if (session('role_id') == 1 || in_array(829, session('permissions')))
                            <li><a class="menu-item" href="{{ route('admin.human_resource.employee_penalty.index')}}">Employee
                                    Penalty</a></li>
                        @endif
                        @if (session('role_id') == 1 || in_array(831, session('permissions')))
                            <li><a class="menu-item" href="{{ route('admin.human_resource.fuel_allocation.index')}}">Rider
                                    Fuel Allocation</a></li>
                        @endif

                    @endif
                    @if (session('role_id') == 1 || in_array(783, session('permissions')))
                        <li><a class="menu-item" href="{{ route('admin.human_resource.employee_confirmation.index')}}">Employee
                                Confirmation</a></li>
                    @endif
                    @if (Auth::user()->trax_id != NULL)
                        <li><a class="menu-item" href="{{ route('admin.human_resource.payslip.index')}}">Payslips</a>
                        </li>
                    @endif

                    @if (session('role_id') == 1 || in_array(845, session('permissions')))
                        <li><a class="menu-item" href="{{ route('admin.human_resource.employee_areas.index')}}">Assign
                                Employee Area</a></li>
                    @endif
