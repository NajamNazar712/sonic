...
{{--                                @endif--}}
            ...
            @if (session('role_id') == 1 || count(array_intersect([81, 85, 88, 92, 96, 558, 100, 131, 205, 231, 104, 116, 149, 150, 151, 152, 154, 157, 158, 171, 175,188, 189, 192, 197, 198, 214, 228, 229, 230, 231, 237, 253, 302, 311, 313, 314, 318, 320, 329, 333, 362, 367, 375, 377, 378, 379, 380, 387, 384, 385,394, 417, 418, 425,438,443,447,462, 477,488, 491, 494, 498, 499, 526, 565, 581], session('permissions'))) !== 0)
                        ...
                        @if (session('role_id') == 1 || count(array_intersect([151, 175, 269, 311, 343, 357, 359, 565], session('permissions'))) !== 0)
                            <li class=" nav-item"><a href="#"><span class="menu-title">Reports</span></a>
                                <ul class="menu-content">
                                    ...
                                    @endif
                                    @if (session('role_id') == 1 || in_array(565, 581, session('permissions')))
