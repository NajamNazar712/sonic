<div class="main-menu menu-fixed menu-light menu-accordion menu-bordered menu-shadow"
    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            @if (session('role_id') == 1 || count(array_intersect([64, 65, 66, 67, 68, 69, 70, 71, 72, 73, 74, 75,113, 138, 148, 153, 156, 169, 170, 172, 176, 200, 258, 259, 263, 264, 275, 300, 301, 327], session('permissions'))) !== 0)
