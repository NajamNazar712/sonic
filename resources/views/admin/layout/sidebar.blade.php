...
{{--                            @endif--}}
            ...
            @if (session('role_id') == 1 ||
                    count(array_intersect(
                            [25, 26, 27, 124, 386, 501, 545, 546, 547, 551, 554, 557, 556, 559, 564,934,1062, 1068,1069],
                ...
                <li class=" nav-item"><a href="#"><span class="menu-title" data-i18n="nav.dash.main"><i
                    ...
                    <ul class="menu-content">
                        @if (session('role_id') == 1 || count(array_intersect([1062, 1068,1069], session('permissions'))) !== 0)
                            <li class=" nav-item"><a href="#"><span class="menu-title">Local Fleet Management</span></a>
                                <ul class="menu-content">
                                    @if (session('role_id') == 1 || in_array(1062, session('permissions')))
                                        <li>
                                            <a class="menu-item"  href="{{ route('admin.cargo.supply_chain.local_fleet.vehicle.index') }}">Vehicle</a>
                                        </li>
                                    @endif
                                    @if (session('role_id') == 1 || in_array(1068, session('permissions')))
                                        <li>
                                            <a class="menu-item"  href="{{ route('admin.cargo.supply_chain.local_fleet.vehicle.trips.index') }}">Vehicle Trips</a>
                                        </li>
                                    @endif
            ...
            @if (session('role_id') == 1 || count(array_intersect([64,65,66,67,68,69,70,71,72,73,74,75,113,138,148,153,156,169,170,172,176,200,210,258,259,263,264,275,300,301,319,327,328,337,356,401,437,444,472,476,493,502,524,532,555,613,614,624,642,647,653,679,673,676,688,705,717,780,784,786,793,794,823,824,839,886,892,901,911,915,925,935,936,937,945,950,1061],session('permissions'))) !== 0)
                <li class=" nav-item"><a href="#"><span class="menu-title"><i
                    ...
                    <ul class="menu-content">
                        ...
                        @endif
                        @if (session('role_id') == 1 || in_array(1061, session('permissions')))
                            <li>
            ...
            @if (session('role_id') == 1 || count(array_intersect([81, 85, 88, 92, 96, 558, 100, 131, 205, 231, 104, 116, 149, 150, 151, 152, 154, 157, 158, 171, 175, 188, 189, 192, 197, 198, 214, 228, 229, 230, 231, 237, 253, 302, 311, 313, 314, 318, 320, 329, 333, 362, 367, 388, 375, 377, 378, 379, 380, 387, 384, 385, 394, 417, 418, 425, 438, 443, 447, 462, 477, 488, 491, 494, 498, 499, 526, 544, 558, 565, 580, 581, 582, 601, 616, 646, 644, 656, 659, 661, 664, 660, 667, 668, 680, 674, 682, 683, 689, 697, 701, 708, 710, 714, 716, 747, 761, 788, 820, 826, 836, 846, 861, 887, 904, 889, 910,932,938,942,951,978,990,992,997,1040], session('permissions'))) !== 0)
                <li class=" nav-item"><a href="#"><span class="menu-title" data-i18n="nav.dash.main"><i
                    ...
                    <ul class="menu-content">
                            ...
                            <li class=" nav-item"><a href="#"><span class="menu-title">Shippers</span></a>
                                <ul class="menu-content">
                                    ...
                                    @endif
                                        ...
                                        @endif
                                        @if (session('role_id') == 1 || in_array(932, session('permissions')))
                                            <li><a class="menu-item"
                                        ...
                                        @if (session('role_id') == 1 || in_array(904, session('permissions')))
                                            <li><a class="menu-item"
                                                    href="{{ route('admin.settings.rv_shipper_priority.index') }}">RV Shipper Priority</a>
                                            </li>
                                        @endif
                                        ...
                                        @if (session('role_id') == 1 || in_array(1072, session('permissions')))
                                        <li><a class="menu-item"
                        ...
                        @if (session('role_id') == 1 ||
                            ...
                            <li class=" nav-item"><a href="#"><span class="menu-title">Support</span></a>
                                <ul class="menu-content">
                                    @if (session('role_id') == 1 ||
                                            count(array_intersect([81, 85, 100, 152, 279, 358, 394, 447, 466, 601,1040], session('permissions'))) !== 0)
                            ...
                            <li class=" nav-item"><a href="#"><span class="menu-title">Commission</span></a>
                                <ul class="menu-content">
                                    ...
                                    @if (session('role_id') == 1 || in_array(332, session('permissions')))
                                        <li><a class="menu-item"
                                                href="{{ route('admin.settings.commission.percentage.index') }}">Set Commission</a></li>
                                    @endif
                                </ul>
                            </li>
                        @endif

                        @if (session('role_id') == 1 || count(array_intersect([431, 432, 474, 992], session('permissions'))) !== 0)
                                    ...
                                    @if (session('role_id') == 1 || count(array_intersect([431, 432, 474, 992], session('permissions'))) !== 0)
                                        <li class=" nav-item"><a href="#"><span class="menu-title">Store
                                            ...
                                            <ul class="menu-content">
                                                ...
                                                @endif
                                                @if (session('role_id') == 1 || in_array(992, session('permissions')))
                                                    <li class=" nav-item">
