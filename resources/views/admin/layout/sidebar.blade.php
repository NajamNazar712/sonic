<div class="main-menu menu-fixed menu-light menu-accordion menu-bordered menu-shadow" data-scroll-to-active="true">
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            @if (session('role_id') == 1 ||
                    count(array_intersect([17, 20, 23, 123, 368, 369, 370, 446, 670], session('permissions'))) !== 0)
                <li class=" nav-item"><a href="#"><span class="menu-title" data-i18n="nav.dash.main"><i
            ...
            @if (session('role_id') == 1 ||
                ...
                <li class=" nav-item"><a href="#"><span class="menu-title" data-i18n="nav.dash.main"><i
                    ...
                    <ul class="menu-content">
                        @if (session('role_id') == 1 || count(array_intersect([149, 214, 228,302, 313, 314, 318, 367, 388,498, 580, 558,646,644,660, 667, 668, 701,716, 826], session('permissions'))) !== 0)
                        @if (session('role_id') == 1 ||
                                count(array_intersect(
                                        [149, 214, 228, 302, 313, 314, 318, 367, 388, 498, 580, 558, 646, 644, 660, 667, 668, 701, 716, 820, 826],
                                        session('permissions'))) !== 0)
            ...
            <li class=" nav-item"><a href="#"><span class="menu-title"><i class="ft-users"></i>Human
                ...
                <ul class="menu-content">
                    @if (session('role_id') == 1 ||
                            count(array_intersect([449, 465, 467, 478, 481, 484, 492, 506, 568, 596, 592, 613, 717], session('permissions'))) !== 0)
