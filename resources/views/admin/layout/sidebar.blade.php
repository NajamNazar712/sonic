<div class="main-menu menu-fixed menu-light menu-accordion menu-shadow menu-border"
    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            <li class=" nav-item"><a href="{{route('admin.orders.index')}}"><span class="menu-title"
                                                                                  data-i18n="nav.dash.main">Order Management</span></a>
            </li>
            ...
            @if (session('role_id') == 1 || in_array(32, session('permissions')))
                <li class=" nav-item"><a href="{{route('admin.sameday.index')}}"><span class="menu-title">Same-Day Delivery</span></a>
                </li>
            @endif
                    ...
                    <ul class="menu-content">
                        ...
                        @if (session('role_id') == 1 || count(array_intersect([193], session('permissions'))) !== 0)
                            @if (session('role_id') == 1 || in_array(193, session('permissions')))
                                <li><a class="menu-item" href="{{route('admin.delivery.intercept.index')}}">Intercept
                                        Request</a></li>
                            @endif
                        @endif
                    </ul>
                ...
                <li class=" nav-item"><a href="#"><span class="menu-title">Packaging</span></a>
                    <ul class="menu-content">
                        ...
                        @if (session('role_id') == 1 || in_array(79, session('permissions')))
                            <li><a class="menu-item" href="{{ route('admin.packaging.requests.index') }}">Requests</a>
                            </li>
                        @endif
                    </ul>
                </li>
                ...
                <li class=" nav-item"><a href="#"><span class="menu-title"
                    ...
                    <ul class="menu-content">
                        @if (session('role_id') == 1 || in_array(131, session('permissions')))
                            <li><a class="menu-item" href="{{route('admin.management.zonal.index')}}">Zonal
                                    Management</a></li>
                        @endif

                        @if (session('role_id') == 1 || in_array(88, session('permissions')))
                            <li><a class="menu-item" href="{{route('admin.management.city.index')}}">City Management</a>
                            </li>
                        @endif

                        @if (session('role_id') == 1 || in_array(92, session('permissions')))
                            <li><a class="menu-item" href="{{route('admin.management.route.index')}}">Route
                                    Management</a></li>
                        @endif
            ...
            <li class=" nav-item"><a href="{{ route('admin.tracking.index') }}"><span class="menu-title">Tracking</span></a>
            </li>

            @if (session('role_id') == 1 || in_array(117, session('permissions')))
                <li class=" nav-item"><a href="{{ route('admin.cancelled_shipments.index') }}"><span class="menu-title">Cancelled Shipments</span></a>
                </li>
            @endif
                ...
                <li class=" nav-item"><a href="#"><span class="menu-title" data-i18n="nav.dash.main">Settings</span></a>
                    <ul class="menu-content">
                        @if (session('role_id') == 1 || in_array(104, session('permissions')))
                            <li><a class="menu-item" href="{{route('admin.settings.pickup.index')}}">Pickup Weight
                                    Threshold</a></li>
                        @endif
                        ...
                        @if (session('role_id') == 1 || in_array(149, session('permissions')))
                            <li><a class="menu-item"
                                   href="{{route('admin.settings.auto_account_disabled_days.auto_index')}}">Auto Account
                                    Disabled Days</a></li>
                        @endif

                        @if (session('role_id') == 1 || in_array(150, session('permissions')))
                            <li><a class="menu-item" href="{{route('admin.settings.non_service_area.index')}}">Non
                                    Service Area</a></li>
                        @endif

                        @if (session('role_id') == 1 || in_array(151, session('permissions')))
                            <li><a class="menu-item" href="{{route('admin.settings.daily_pickup_sales_cron.index')}}">Daily
                            ...
                            <li><a class="menu-item" href="#">Petty Cash</a>
                                <ul class="menu-content">
                                    @if (session('role_id') == 1 || in_array(157, session('permissions')))
                                        <li><a class="menu-item"
                                               href="{{route('admin.settings.petty_cash.heads.index')}}">Heads</a></li>
                                    @endif
            ...
            @endif
            @if (session('role_id') == 1 || in_array(175, session('permissions')))
                <li><a class="menu-item" href="{{route('admin.delivery.intercept.history.index')}}">Intercept Rebook History</a></li>
            @endif
        </ul>
    </div>
</div>