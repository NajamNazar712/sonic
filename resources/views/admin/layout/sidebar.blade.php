<div class="main-menu menu-fixed menu-light menu-accordion menu-bordered menu-shadow"
    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            @endif
            @if (session('role_id') == 1 || count(array_intersect([5, 11, 15, 242, 76, 79, 217, 315, 428], session('permissions'))) !== 0)
...
{{--                                        @endif--}}
            ...
            @if (session('role_id') == 1 || count(array_intersect([25, 26, 27, 124, 386], session('permissions'))) !== 0)
...
{{--                                    @endif--}}
            ...
            @if (session('role_id') == 1 || count(array_intersect([32, 33, 35, 36, 40, 42, 105, 44, 47, 48, 49, 126, 262, 441], session('permissions'))) !== 0)
                <li class=" nav-item"><a href="#"><span class="menu-title" data-i18n="nav.dash.main"><i class="la la-motorcycle"></i>Last Mile</span></a>
                    <ul class="menu-content">
                        @if (session('role_id') == 1 || count(array_intersect([32, 33, 35, 36, 40, 42, 105, 262, 441], session('permissions'))) !== 0)
...
{{--                                    @endif--}}
            ...
            <li class=" nav-item"><a href="#"><span class="menu-title" data-i18n="nav.dash.main"><i class="la la-check-square-o"></i>Support</span></a>
                <ul class="menu-content">
                    ...
                    @if (session('role_id') == 1 || count(array_intersect([399, 400, 402, 421, 422], session('permissions'))) !== 0)
...
{{--                                @endif--}}
            ...
            @if (session('role_id') == 1 || count(array_intersect([64, 65, 66, 67, 68, 69, 70, 71, 72, 73, 74, 75,113, 138, 148, 153, 156, 169, 170, 172, 176, 200, 210, 258, 259, 263, 264, 275, 300, 301, 327,328,337,356, 401, 437, 444], session('permissions'))) !== 0)
            ...
            @if (session('role_id') == 1 || count(array_intersect([81, 85, 88, 92, 96, 100, 131, 205, 231, 104, 116, 149, 150, 151, 152, 154, 157, 158, 171, 175,188, 189, 192, 197, 198, 214, 228, 229, 230, 231, 237, 253, 302, 311, 313, 314, 318, 320, 329, 333, 362, 367, 375, 377, 378, 379, 380, 387, 384, 385,394, 417, 418, 425,438,443,447], session('permissions'))) !== 0)
...
{{--                                    @endif--}}
                        ...
                        @if (session('role_id') == 1 || count(array_intersect([81, 85, 100,417, 418, 152, 279, 358,394,447], session('permissions'))) !== 0)
                            <li class=" nav-item"><a href="#"><span class="menu-title">Support</span></a>
                                <ul class="menu-content">
                                    @if (session('role_id') == 1 || count(array_intersect([81, 85, 100, 152, 279, 358,394], session('permissions'))) !== 0)
            ...
            @if (session('role_id') == 1 || count(array_intersect([448], session('permissions'))) !== 0)
