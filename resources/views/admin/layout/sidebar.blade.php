    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            @if (session('role_id') == 1 || in_array(669, session('permissions')))
                <li><a class="menu-item" href="{{route('admin.pam_leads.index')}}"><i class="la la-truck"></i>Movit Leads</a></li>
            @endif
            @if (session('role_id') == 1 || count(array_intersect([5, 11, 15, 242, 76, 79, 217, 315, 428, 470, 762 ,767, 791], session('permissions'))) !== 0)
                <li class=" nav-item"><a href="#"><span class="menu-title" data-i18n="nav.vertical_nav.main"><i class="la la-users"></i>Shippers</span></a>
                    <ul class="menu-content">
                        ...
                        @if (session('role_id') == 1 || in_array(791, session('permissions')))
                            <li><a class="menu-item" href="{{ route('admin.daily_visit.screen.index') }}">Daily Visit</a>
                            </li>
                        @endif
                            ...
                            <li class=" nav-item"><a href="#"><span class="menu-title"
                                ...
                                <ul class="menu-content">
                                    @if (session('role_id') == 1 || in_array(315, session('permissions')))
                                        <li><a class="menu-item" href="{{route('admin.dashboard.sales.index')}}">Dashboard</a></li>
                                    @endif
            ...
            @if (session('role_id') == 1 || count(array_intersect([17, 20, 23, 123, 368, 369, 370,446, 670], session('permissions'))) !== 0)
                <li class=" nav-item"><a href="#"><span class="menu-title" data-i18n="nav.dash.main"><i class="la la-cubes"></i>First Mile</span></a>
                    <ul class="menu-content">
						 @if (session('role_id') == 1 || count(array_intersect([368, 369, 370], session('permissions'))) !== 0)
                            <li class=" nav-item"><a href="#"><span class="menu-title">Multiple Pieces</span></a>
                                <ul class="menu-content">
                                    @if (session('role_id') == 1 || in_array(368, session('permissions')))
                                        <li><a class="menu-item" href="{{ route('admin.multiple_pieces.add.index') }}">Add</a></li>
                                    @endif
                                    @if (session('role_id') == 1 || in_array(369, session('permissions')))
                                        <li><a class="menu-item" href="{{ route('admin.multiple_pieces.hold.index') }}">List</a></li>
                                    @endif
                                    @if (session('role_id') == 1 || in_array(370, session('permissions')))
                                        <li><a class="menu-item" href="{{ route('admin.multiple_pieces.resolved.index') }}">Resolved</a></li>
                                    @endif
                                </ul>
                            </li>
                        @endif
...
{{--                            </li>--}}
                            ...
                            @if (session('role_id') == 1 || count(array_intersect([17,24,271,272,366, 670], session('permissions'))) !== 0)
                                <li class=" nav-item"><a href="#"><span class="menu-title">Pickups</span></a>
                                    <ul class="menu-content">
{{--                                        @if (session('role_id') == 1 || in_array(17, session('permissions')))--}}
...
{{--                                        @endif--}}
                                        ...
                                        @if (session('role_id') == 1 || in_array(670, session('permissions')))
                                            <li><a class="menu-item" href="{{ route('admin.v2_pickups.rider_receiving.dws.index') }}">Rider Receiving DWS</a></li>
                                        @endif
                            ...
                            <li class=" nav-item"><a href="#"><span class="menu-title">Cargo Vehicle Manifest</span></a>
                                <ul class="menu-content">
                                    <li class=" nav-item"><a href="#"><span class="menu-title">Bag</span></a>
                                        <ul class="menu-content">
                                            ...
                                            @if (session('role_id') == 1 || in_array(559, session('permissions')) && Auth::user()->default_hub_id != NULL)
                                                <li><a class="menu-item" href="{{ route('admin.cargo_manifest.bags.create.open_bag.index') }}">Create Open Bag</a></li>
                                            @endif
                                    ...
                                    @if ((session('role_id') == 1 || in_array(557, session('permissions'))) && Auth::user()->default_hub_id != NULL)
                                        <li><a class="menu-item" href="{{ route('admin.cargo_manifest.receive.bag.index') }}">Quick Receive Bag Shipments</a></li>
                                    @endif
...
{{--                                    @endif--}}
                                        @if (session('role_id') == 1 || count(array_intersect([105, 423], session('permissions'))) !== 0)
                                            <li class=" nav-item"><a href="#"><span class="menu-title" data-i18n="nav.dash.main">Pending
                                                ...
                                                <ul class="menu-content">
                                                    @if (session('role_id') == 1 || in_array(105, session('permissions')))
                                                        <li><a class="menu-item" href="{{ route('admin.delivery.cash_collection.pending.index') }}">COD</a></li>
                                                    @endif
                                                    @if (session('role_id') == 1 || in_array(423, session('permissions')))
                                                        <li><a class="menu-item" href="{{ route('admin.delivery.cash_collection.retail.index') }}">Retail</a></li>
                                                    @endif
                                                </ul>
                                            </li>
                                        @endif
                                   ...
                                   {{-- @if (session('role_id') == 1 || in_array(40, session('permissions')))
                                    ...
                                    @endif--}}
                                        @if (session('role_id') == 1 ||  count(array_intersect([40,424], session('permissions'))) !== 0)
                                            <li class=" nav-item"><a href="#"><span class="menu-title" data-i18n="nav.dash.main">Completed</span></a>
                                                <ul class="menu-content">
                                                    @if (session('role_id') == 1 || in_array(40, session('permissions')))
                                                        <li>
                                                            <a class="menu-item" href="{{ route('admin.delivery.completed.index') }}">COD</a>
                                                        </li>
                                                    @endif
                                                    @if (session('role_id') == 1 || in_array(424, session('permissions')))
                                                        <li>
                                                            <a class="menu-item" href="{{ route('admin.delivery.completed.retail.index') }}">Retail</a>
                                                        </li>
                                                    @endif
                                                </ul>
                                            </li>
                            ...
                            <li class=" nav-item"><a href="#"><span class="menu-title" data-i18n="nav.dash.main">Return</span></a>
                                <ul class="menu-content">
                                    ...
                                    @if (session('role_id') == 1 || in_array(266, session('permissions')))
                                        <li><a class="menu-item" href="{{ route('admin.return.cx_sales.index') }}">Unable to Return</a></li>
                                    @endif
            ...
            @if (session('role_id') == 1 || count(array_intersect([42, 52, 54, 59, 61, 136, 167, 232, 120, 145, 146, 147,232, 238, 243,454,455,509,625, 807], session('permissions'))) !== 0)
                    ...
                    <ul class="menu-content">
                        ...
                        @if (session('role_id') == 1 || count(array_intersect([120,509, 807], session('permissions'))))
                            <li class=" nav-item"><a href="#"><span class="menu-title">Invoices</span></a>
                                <ul class="menu-content">
                                 <li><a class="menu-item" href="{{ route('admin.finance.invoices.index') }}">Invoice</a></li>
                                ...
                                @if (session('role_id') == 1 || in_array(807, session('permissions')))
                                    <li><a class="menu-item"
                                           href="{{ route('admin.international.wholesale.invoices.index') }}">Wholesale Invoices</a></li>
                                @endif
                                </ul>
                            </li>
                        @endif
            ...
            <li class=" nav-item"><a href="#"><span class="menu-title" data-i18n="nav.dash.main"><i class="la la-check-square-o"></i>Support</span></a>
                <ul class="menu-content">
                    ...
                    @if (session('role_id') == 1 || count(array_intersect([399, 400, 402, 421, 422,525,595], session('permissions'))) !== 0)
                        <li class=" nav-item"><a href="#"><span class="menu-title">Telenor</span></a>

                            <ul class="menu-content">
                                @if (session('role_id') == 1 || in_array(421, session('permissions')))
                                    <li><a class="menu-item"
                                           href="{{ route('admin.telenor.arrival.index') }}">Bulk Arrival</a>
                                    </li>
                                @endif
                                ...
                                @if (session('role_id') == 1 || in_array(422, session('permissions')))
                                    <li><a class="menu-item"
                                           href="{{ route('admin.telenor.order_id.index') }}">Bulk Order ID</a>
                                    </li>
                                @endif
...
{{--                                @endif--}}
                    ...
                    @if (session('role_id') == 1 || in_array(563, session('permissions')))
                        <li><a class="menu-item" href="{{ route('admin.rider_otp.index') }}">Rider OTP (Login & Delivery Note)</a></li>
                    @endif
                        ...
                        <li class=" nav-item"><a href="#"><span class="menu-title">International</span></a>
                            <ul class="menu-content">
                                @if (session('role_id') == 1 || in_array(799, session('permissions')))
                                    <li><a class="menu-item" href="{{ route('admin.international.wholesale.accounts.index') }}">Wholesale Accounts</a></li>
                                @endif
                                @if (session('role_id') == 1 || in_array(804, session('permissions')))
                                    <li><a class="menu-item" href="{{ route('admin.international.wholesale.excel.index') }}">Wholesale Excel Booking</a></li>
                                @endif
            ...
            @if (session('role_id') == 1 || count(array_intersect([64, 65, 66, 67, 68, 69, 70, 71, 72, 73, 74, 75,113, 138, 148, 153, 156, 169, 170, 172, 176, 200, 210, 258, 259, 263, 264, 275, 300, 301, 319, 327, 328, 337, 356, 401, 437, 444, 472, 476, 493, 502, 524, 532, 555, 613, 614, 624, 642, 647, 653, 679, 673, 676, 688, 705, 717, 780, 784, 786, 793, 794], session('permissions'))) !== 0)
                <li class=" nav-item"><a href="#"><span class="menu-title"><i class="la la-file-text-o"></i>Reports</span></a>
                    <ul class="menu-content">
                        ...
                        <li><a class="menu-item" href="{{route('admin.reports.debriefing.agent_index')}}">Debriefing Agent Report</a></li>
                        @endif
            ...
            @if (session('role_id') == 1 || count(array_intersect([81, 85, 88, 92, 96, 558, 100, 131, 205, 231, 104, 116, 149, 150, 151, 152, 154, 157, 158, 171, 175,188, 189, 192, 197, 198, 214, 228, 229, 230, 231, 237, 253, 302, 311, 313, 314, 318, 320, 329, 333, 362, 367, 375, 377, 378, 379, 380, 387, 384, 385,394, 417, 418, 425,438,443,447,462, 477,488, 491, 494, 498, 499, 526,544, 558, 565,580, 581, 582, 601, 616, 646, 644, 656, 659, 661, 664, 660, 667, 668, 680, 674,682, 683, 689, 697, 701, 708, 710, 714,716,747,761, 788, 820], session('permissions'))) !== 0)
...
{{--                                    @endif--}}
                                    ...
                                    @if (session('role_id') == 1 || in_array(558, session('permissions')))
                                        <li><a class="menu-item" href="{{ route('admin.settings.ccd_booking.index') }}">CCD Booking</a>
                                        </li>
                                    @endif
                                    ...
                                    @if (session('role_id') == 1 || in_array(313, session('permissions')))
                                        <li><a class="menu-item" href="{{route('admin.settings.sales.projection.percentage.index')}}">Projection Percentage</a></li>
                                    @endif
                                    ...
                                    @if (session('role_id') == 1 || in_array(580, session('permissions')))
                                        <li><a class="menu-item" href="{{ route('admin.settings.carrefour_account.index') }}">Carrefour Accounts</a>
                                        </li>
                                    @endif
                                    ...
                                    @if (session('role_id') == 1 || in_array(646, session('permissions')))
                                            <li><a class="menu-item" href="{{route('admin.settings.shippers.status_webhook.index')}}">Shippers Status Webhook Subscription</a></li>
                                    @endif
                                    ...
                                    @if (session('role_id') == 1 || in_array(667, session('permissions')))
                                        <li class=" nav-item"><a href="{{route('admin.settings.shippers_origin_change.index')}}"><span class="menu-title">Shipper Origin Change</span></a> </li>
                                    @endif
                                    @if (session('role_id') == 1 || in_array(668, session('permissions')))
                                        <li class=" nav-item"><a href="{{route('admin.settings.shippers_return_address.index')}}"><span class="menu-title">Shipper Return Address</span></a> </li>
                                    @endif

                                    @if (session('role_id') == 1 || in_array(689, session('permissions')))
                                        <li class=" nav-item"><a href="{{route('admin.settings.return_shipments_address.index')}}"><span class="menu-title">Return Shipments Address Change</span></a> </li>
                                    @endif

                                    @if (session('role_id') == 1 || in_array(701, session('permissions')))
                                        <li class=" nav-item"><a href="{{route('admin.settings.referral.index')}}"><span class="menu-title">Referral Module</span></a> </li>
                                    @endif
                                        @if (session('role_id') == 1 || in_array(716, session('permissions')))
                                            <li class=" nav-item"><a href="{{route('admin.settings.invoice_against_return_delivered_shipper.index')}}"><span class="menu-title">Invoice Against Return Delivered Shipper</span></a> </li>
                                        @endif
                                    @if (session('role_id') == 1 || in_array(788, session('permissions')))
                                        <li><a class="menu-item" href="{{route('admin.settings.complain_portal_shippers.index')}}">Complaint Portal Shippers</a></li>
                                    @endif

                                    @if (session('role_id') == 1 || in_array(820, session('permissions')))
                                        <li><a class="menu-item" href="{{route('admin.settings.non_cod_otp_shippers.index')}}">Non-Cod OTP Shippers Setting</a></li>
                                    @endif
                                </ul>
                            ...
                            <li class=" nav-item"><a href="#"><span class="menu-title">Bookings</span></a>
                                <ul class="menu-content">
                                    ...
                                    @if (session('role_id') == 1 || in_array(375, session('permissions')))
                                        <li><a class="menu-item" href="{{route('admin.settings.restrict_cities_intercept.index')}}">Restrict Cities For Saver Plus Shipments</a></li>
                                    @endif
                                </ul>
                            </li>
                        @endif
                        ...
                        @if (session('role_id') == 1 || count(array_intersect([198, 387, 385, 498, 499,544,682], session('permissions'))) !== 0)
...
{{--                                        @endif--}}
                        ...
                        @endif
                        @if (session('role_id') == 1 || count(array_intersect([88, 92, 96, 131, 192, 205, 231, 253, 335, 377, 378, 379, 380, 425,443,488,526, 562, 659,680,674, 683, 684, 707, 714, 747], session('permissions'))) !== 0)
                            <li class=" nav-item"><a href="#"><span class="menu-title">Last Mile</span></a>
                                <ul class="menu-content">
                                    ...
                                    @if (session('role_id') == 1 || in_array(488, session('permissions')))
                                        <li><a class="menu-item" href="{{route('admin.settings.rcp_tat.index')}}">Return Confirmation Pending TAT Setting</a></li>
                                    @endif
                        ...
                        @if (session('role_id') == 1 || count(array_intersect([157,158, 171, 189, 229, 230, 362,462], session('permissions'))) !== 0)
                        ...
                        @endif
                        @if (session('role_id') == 1 || count(array_intersect([81, 85, 100,417, 418, 152, 279, 358,394,447, 466, 601], session('permissions'))) !== 0)
                            <li class=" nav-item"><a href="#"><span class="menu-title">Support</span></a>
                                <ul class="menu-content">
                                    @if (session('role_id') == 1 || count(array_intersect([81, 85, 100, 152, 279, 358,394,447, 466, 601], session('permissions'))) !== 0)
                                            ...
                                            <li class=" nav-item"><a href="#"><span class="menu-title">User Management</span></a>
                                                <ul class="menu-content">
                                                    ...
                                                    @if (session('role_id') == 1 || in_array(394, session('permissions')))
                                                        <li><a class="menu-item" href="{{ route('admin.user_management.user_requests.index') }}">User Requests</a>
                                                        </li>
                                                    @endif
                                                    @if (session('role_id') == 1 || in_array(447, session('permissions')))
                                                        <li><a class="menu-item" href="{{ route('admin.user_management.fuel_management.index') }}">Fuel Management</a></li>
                                                    @endif
                                        ...
                                        @endif
                                            @if (session('role_id') == 1 || in_array(601, session('permissions')))
                                                <li class=" nav-item"><a href="{{ route('admin.app_notifications.index') }}"><span class="menu-title">App-Notifications</span></a>
                                                </li>
                                            @endif
                        ...
                        @if (session('role_id') == 1 || count(array_intersect([151, 175, 269, 311, 343, 357, 359, 565], session('permissions'))) !== 0)
                            <li class=" nav-item"><a href="#"><span class="menu-title">Reports</span></a>
                                <ul class="menu-content">
                                    ...
                                    @if (session('role_id') == 1 || in_array(311, session('permissions')))
                                        <li><a class="menu-item" href="{{route('admin.settings.overnight_overland_cargo_report.index')}}">Rush Saver Plus Cargo Report</a></li>
                                    @endif
                                    ...
                                    @if (session('role_id') == 1 || in_array(565, session('permissions')))
                                        <li><a class="menu-item" href="{{route('admin.settings.last_mile_cron.index')}}">Last Mile Status Cron Time</a></li>
                                    @endif
                                </ul>
                            </li>
                        @endif
                            ...
                            <li class=" nav-item"><a href="#"><span class="menu-title">International</span></a>
                                <ul class="menu-content">
                                    ...
                                    @if (session('role_id') == 1 || in_array(581, session('permissions')))
                                        <li><a class="menu-item" href="{{route('admin.settings.dhl_sync_time.index')}}">DHL Sync Time</a></li>
                                    @endif
                                    @if (session('role_id') == 1 || in_array(582, session('permissions')))
                                        <li><a class="menu-item" href="{{route('admin.settings.international_automation_user.index')}}">Automation User</a></li>
                                    @endif
                                </ul>
                            </li>
                        @endif
                        ...
                        <li class=" nav-item"><a href="#"><span class="menu-title">Leads Management</span></a>
                            <ul class="menu-content">
                                ...
                                @if (session('role_id') == 1 || in_array(661, session('permissions')))
                                    <li><a class="menu-item" href="{{route('admin.settings.lead_tagging.index')}}">Auto Tagging</a></li>
                                @endif
                        ...
                        @if (session('role_id') == 1 || in_array(697, session('permissions')))
                            <li><a class="menu-item" href="{{route('admin.settings.auto_tag_territories.index')}}">Auto Tag Territories</a></li>
                        @endif
            ...
            <li class=" nav-item"><a href="#"><span class="menu-title"><i class="ft-users"></i>Human Resource</span></a>
                <ul class="menu-content">
                    @if (session('role_id') == 1 || count(array_intersect([449, 465, 467, 478, 481, 484, 492, 506, 568, 596, 592, 613, 717, 829], session('permissions'))) !== 0)
            ...
            <li class=" nav-item"><a href="#"><span class="menu-title"><i class="ft-users"></i>Quality Assurance</span></a>
                <ul class="menu-content">
                    ...
                    @if (session('role_id') == 1 || in_array(777, session('permissions')))
                        <li><a class="menu-item" href="{{ route('admin.qa.cx_training.index')}}">CX Training</a></li>
                    @endif
