                ...
                <div class="card">
                    <div class="card-content" aria-expanded="true">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-2">
                                <h3 id="selected_note_title" class="h1 text-bold-700"></h3>
                            </div>
                        </div>
                        <div id="tracking_info" class="d-none mb-3 ml-1 mr-1">
                            <table class="table table-bordered datatable" id="datatable" style="z-index: 3;">
                                ...
                                <tr role="row" class="bg-primary white">
                                    ...
                                    <th class="border-primary border-darken-1">Note ID</th>
                        ...
                        <div class="row d-none" id="verify_div">
                            <div class="col-12">
                                <form id="scan_shipment_form" class="form-inline mb-1 justify-content-center" novalidate="novalidate">
                                    ...
                                    <input type="hidden" name="vigilance_note_type" id="selected_note_type">
                                ...
                                <form id="verify_shipment_form" action="{{route('admin.vigilance.note.add')}}" class="form mb-1" method="POST">
                                    {{ csrf_field() }}
                                    <input type="hidden" name="rider_id" id="verify_rider_id">
                                    <input type="hidden" name="note_type" id="verify_note_type">
                                    <table class="table table-bordered datatable" id="verify_datatable" style="z-index: 3;">
                                        ...
                                        <tr role="row" class="bg-primary white">
                                            ...
                                            <th class="border-primary border-darken-1">Note No.</th>
        ...
        $(document).ready(function () {
            ...
            function init(){
                ...
                table = $('#datatable').DataTable({
                    ...
                    serverSide: true,
                    ajax: {
                        url: '{{ route('admin.vigilance.note.list') }}',
                        data: function (d) {
                            d.search_note_type = $('#search_form input[name="note_type"]:checked').val();
                    ...
                    columns: [
                        ...
                        {data: 'note', name: 'note', class: 'align-middle note', orderable: false, searchable: false},
            ...
            $('#search_filter_btn').on('click', function () {
                ...
                var note_type_id = $('#search_form input[name="note_type"]:checked').val();
                if(rider_id){
                    $('#selected_rider_id').val(rider_id);
                    $('#selected_note_type').val(note_type_id);
                    $('#verify_rider_id').val(rider_id);
                    $('#verify_note_type').val(note_type_id);
                    ...
                    if(note_type_id == 1){
                        ...
                        $('#selected_note_title').text('Return Note');
                    }
            ...
            var vtable = $('#verify_datatable').DataTable({
                ...
                columns: [
                    ...
                    {name: 'note', class: 'align-middle note', orderable: false},
            ...
            $('#scan_shipment_form').validate({
                ...
                submitHandler: function(form) {
                    ...
                    var note_type = $('#search_form input[name="note_type"]:checked').val();
                    var rider_id = $('#selected_rider_id').val();
                    if(!rider_id){
                        toastr.error('Rider not selected, please refresh and try again!', 'Error!', {positionClass: 'toast-top-center', containerId: 'toast-top-center'});
                    }
                    ...
                    if (vtable.columns('.tracking_number').data().eq(0).indexOf(parseInt(tracking_number)) === -1) {
