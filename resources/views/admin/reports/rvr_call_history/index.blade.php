...
@section('title', 'Overall RVR Call History')
            ...
            <div class="row">
                <div class="card">
                    <div class="card-content" aria-expanded="true">
                        <div class="card-body">
                            <h1>Overall RVR Call History</h1>
                            ...
                            <table class="table table-stripped table-bordered datatable" id="datatable" style="z-index: 3;">
                                ...
                                <tr role="row" class="bg-primary white">
                                    ...
                                    <th class="border-primary border-darken-1">Calling Date</th>
                                    <th class="border-primary border-darken-1">Calling Time</th>
                                    <th class="border-primary border-darken-1">Call Findings</th>
                                    <th class="border-primary border-darken-1">Call Finding Reasons</th>
                                    <th class="border-primary border-darken-1">Call Remarks</th>
                                </tr>
                                </thead>
                            </table>
                        </div>
        ...
        $('#search_agent_name').prepend('<option value="" selected="selected"></option>')
            ...
            jQuery.fn.DataTable.Api.register( 'buttons.exportData()', function ( options ) {
                if ( this.context.length ) {
                    ...
                    var jsonResult = $.ajax({
                        url: '{{ route('admin.reports.rvr_call_history.list') }}',
                        method: 'POST',
                        headers: {
                        ...
                        success: function (result) {
                            ...
                            head.push('Calling Date');
                            head.push('Calling Time');
                            head.push('Call Findings');
                            head.push('Call Finding Reasons');
                            head.push('Call Remarks');
                            ...
                            $.each(result.data, function(index, values) {
                                ...
                                row.push(values.calling_datetime);
                                row.push(values.calling_time);
                                row.push('Unresponsive');
                                row.push(values.call_finding_reason);
                                row.push(values.call_remarks);
            ...
            var table = $('#datatable').DataTable({
                ...
                columns: [
                    ...
                    {data: 'calling_datetime', name: 'calling_datetime', class: 'align-middle calling_datetime',searchable: false},
                    {data: 'calling_time', name: 'calling_time', class: 'align-middle calling_time',searchable: false},
                    {data: 'call_findings', name: 'call_findings', class: 'align-middle call_findings',searchable: false},
                    {data: 'call_finding_reason', name: 'call_finding_reason', class: 'align-middle call_finding_reason',searchable: false},
                    {data: 'call_remarks', name: 'call_remarks', class: 'align-middle call_remarks',searchable: false},
                ],
