           ...
           $('#search_shipper').prepend('<option value="" selected="selected"></option>').select2({
            ...
            var table = $('#datatable').DataTable({
                ...
                columns: [
                    ...
                    { data:'invoice_number' ,name: 'combined_invoices.invoice_number', class: 'align-middle text-center invoice_number'},
                    { data:'payment_id' ,name: 'reimbursement.payment_id', class: 'align-middle payment_id'},
                    ...
                    { data:'p_collection_amount' ,name: 'reimbursement.amount', class: 'align-middle collection_amount'},
                    ...
                    { data:'p_gst' ,name: 'reimbursement.gst', class: 'align-middle p_gst',sortable:false},
                    { data:'pps_sms_charges' ,name: 'reimbursement.sms_charges', class: 'align-middle pps_sms_charges',sortable:false},
                    ...
                    { data:'p_total_charges' ,name: 'reimbursement.charges', class: 'align-middle total_charges'},
                    ...
                    { data: 'p_net_payable' ,name: 'reimbursement.payable', class: 'align-middle net_payable'},
