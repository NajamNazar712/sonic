                ...
                <div class="" id="report_data">
                    ...
                    <table class="table table-bordered datatable" id="datatable" style="z-index: 3;">
                        ...
                        <tr role="row" class="bg-primary white">
                            ...
                            <th class="border-primary border-darken-1">OSA Charges</th>
        ...
        $(document).ready(function () {
            ...
            jQuery.fn.DataTable.Api.register( 'buttons.exportData()', function ( options ) {
                if ( this.context.length ) {
                    ...
                    params.excel = true;
                    var jsonResult = $.ajax({
                        url: '{{ route('admin.reports.osa_charges.list') }}',
                        data: params,
                        success: function (result) {
                            head = [];
                            head.push('S. No.');
                            head.push('Tracking No');
                            head.push('OSA Charges');
            ...
            var table = $('#datatable').DataTable({
                ...
                columns: [
                    ...
                    { data:'osa_charges' ,name: 'nc.osa_charges', class: 'align-middle osa_charges'},
                    { data:'updated_by' ,name: 'a.name', class: 'align-middle updated_by'},
                    { data:'updated_at' ,name: 'nc.updated_at', class: 'align-middle updated_at'},
                ],
