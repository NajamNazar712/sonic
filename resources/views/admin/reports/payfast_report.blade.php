...
@section('title', 'PayFast Report Summary')

@section('content')
    <h1 class="mb-1">
        PayFast Report Summary
    </h1>
        ...
        $(document).ready(function () {
                    ...
                    var jsonResult = $.ajax({
                        ...
                        success: function (result) {
                            ...
                            $.each(result.data, function(index, values) {
                                ...
                                row.push(values.fintech_amount);
                                body.push(row);
                            });
                        },
                        async: false
            ...
            var table = $('#datatable').DataTable({
                ...
                columns: [
                    ...
                    { data:'cod_amount' ,name: 'cod_amount', class: 'align-middle text-center transaction_amount'},
                    { data:'delivery_note_id' ,name: 'delivery_note_id', class: 'align-middle text-center delivery_note_id'},
                    { data:'payment_name_id' ,name: 'payment_name_id', class: 'align-middle text-center payment_name_id'},
                    { data:'cod_amount' ,name: 'cod_amount', class: 'align-middle text-center cod_amount'},
                    { data:'fintech_amount' ,name: 'fintech_amount', class: 'align-middle text-center fintech_amount'},
