...
@section('title', 'Cargo Short Received Shipments')

@section('content')
    <h1 class="mb-1">
        Cargo Short Received Shipments
    </h1>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var table = $('#datatable').DataTable({
                ...
                serverSide: true,
                ajax: '{{ route('admin.reports.cargo_short_received_shipments.list') }}',
                order: [[6, 'desc']],
                columns: [
                    ...
                    { data:'transited_at' ,name: 'cargo_consignments.created_at', class: 'align-middle class'}
                ],
