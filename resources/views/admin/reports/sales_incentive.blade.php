...
@section('title', 'Sales Incentive Report')
                ...
                <div class="" id="report_data">
                    ...
                    <table class="table table-bordered datatable" id="datatable" style="z-index: 3;">
                        ...
                        <tr role="row" class="bg-primary white">
                            ...
                            <th class="border-primary border-darken-1">Sales code</th>
        ...
        $(document).ready(function () {
            ...
            jQuery.fn.DataTable.Api.register( 'buttons.exportData()', function ( options ) {
                if ( this.context.length ) {
                    ...
                    params.excel = true;
                    var jsonResult = $.ajax({
                        url: '{{ route('admin.reports.sales_incentive.list') }}',
                        data: params,
                        success: function (result) {
                            head = [];
                            head.push('S. No.');
                            head.push('Sales code');
            ...
            var table = $('#datatable').DataTable({
                ...
                columns: [
                    ...
                    { data:'sales_code' ,name: 'sales_code', class: 'align-middle admin', sortable: false, orderable: false, searchable: false},
                    ...
                    { data:'origin_city' ,name: 'c.name', class: 'align-middle origin_city'}
                ],
