        ...
        $(document).ready(function () {
            ...
            var table = $('#datatable').DataTable({
                ...
                columns: [
                    ...
                    {data: 'cargo_number', name: 'ccss.cargo_number', class: 'align-middle cargo_number'},
                    {data: 'cargo_date_time', name: 'ccss.cargo_date_time', class: 'align-middle cargo_date_time'},
                    ...
                    {data: 'return_cargo_number', name: 'ccss.cargo_number', class: 'align-middle return_cargo_number'},
                    {data: 'return_cargo_date_time', name: 'ccss.cargo_date_time', class: 'align-middle return_cargo_date_time'},
