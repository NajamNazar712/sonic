                    ...
                    <div class="row mb-2 justify-content-center">                        
                        <div class="col-4">
                            <fieldset class="form-group">
                                <select name="search_shippers[]" id="search_shippers" class="form-control select2" multiple="multiple">
                        ...
                        <div class="col-4 mt-2">
                            <fieldset class="form-group">
                                <input type="text" class="form-control search_tracking_no" name="search_tracking_no" id="search_tracking_no" placeholder="Search Tracking Number">
                            </fieldset>
                        </div>
                        ...
                        <div class="col-3 mt-2">
                            ...
                            <div class="form-group input-group">
                                ...
                                <input type="text" name="search_date_from" class="form-control pickadate bg-primary border-primary white rounded-right" id="search_date_from" placeholder="Date (From)" data-value="{{ Carbon\Carbon::now() }}" data-rule-required="true" data-msg-required="This field is required">
                            </div>
                        </div>
                        <div class="col-3 mt-2">
                            <div class="form-group input-group">
                                ...
                                <input type="text" name="search_date_to" class="form-control pickadate bg-primary border-primary white rounded-right" id="search_date_to" placeholder="Date (To)" data-value="{{ Carbon\Carbon::now() }}" data-rule-required="true" data-msg-required="This field is required">
                            </div>
                        </div>
        ...
        $(document).ready(function () {
            ...
            $('#search_form').validate({
                ...
                submitHandler: function(form) {
                    ...
                    var search_date_from = $('#search_form input[name="search_date_from_formatted"]').val();
