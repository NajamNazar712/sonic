            ...
            <div class="card-body">
                ...
                <table class="table table-bordered datatable" id="datatable" style="z-index: 3;">
                    ...
                    <tr role="row" class="bg-primary white">
                        ...
                        <th class="border-primary border-darken-1">Quantiry</th>
                        ...
                        <th class="border-primary border-darken-1">Transit Status</th>
        ...
        $(document).ready(function () {
            ...
            var table = $('#datatable').DataTable({
                ...
                columns: [
                    ...
                    {data:'sub_segment' ,name: 'u.name', class: 'align-middle'},
                    {data:'order_id' ,name: 'shipments.order_id', class: 'align-middle'},
                    // {data:'origin' ,name: 'oc.name', class: 'align-middle origin'},
                    // {data:'origin_hub' ,name: 'oc.name', class: 'align-middle origin_hub'},
                    ...
                    // {data:'shipping_mode' ,name: 'dz.name', class: 'align-middle shipping_mode'},
                    // {data:'service_type' ,name: 'dz.name', class: 'align-middle service_type'},
                    // {data:'category' ,name: 'dz.name', class: 'align-middle category'},
                    // {data:'description' ,name: 'dz.name', class: 'align-middle description'},
                    // {data:'arrival_date' ,name: 'dz.name', class: 'align-middle arrival_date'},
                    // {data:'quantity' ,name: 'dz.name', class: 'align-middle quantity'},
                    // {data:'weight' ,name: 'dz.name', class: 'align-middle weight'},
                    // {data:'rider_trax_id' ,name: 'dz.name', class: 'align-middle rider_trax_id'},
                    // {data:'rider' ,name: 'dz.name', class: 'align-middle rider'},
                    // {data:'status_hub' ,name: 'dz.name', class: 'align-middle status_hub'},
                    // {data:'first_status' ,name: 'dz.name', class: 'align-middle first_status'},
                    // {data:'first_reason' ,name: 'dz.name', class: 'align-middle first_reason'},
                    // {data:'first_status_date' ,name: 'dz.name', class: 'align-middle first_status_date'},
                    // {data:'current_status' ,name: 'dz.name', class: 'align-middle current_status'},
                    // {data:'current_reason' ,name: 'dz.name', class: 'align-middle current_reason'},
                    // {data:'remarks' ,name: 'dz.name', class: 'align-middle remarks'},
                    // {data:'current_status_date' ,name: 'dz.name', class: 'align-middle current_status_date'},
                    // {data:'total_attempt' ,name: 'dz.name', class: 'align-middle total_attempt'},
                    // {data:'return_reason' ,name: 'dz.name', class: 'align-middle return_reason'},
                    // {data:'transit_date' ,name: 'dz.name', class: 'align-middle transit_date'},
                    // {data:'transit_status' ,name: 'dz.name', class: 'align-middle transit_status'},
                    // {data:'arrive_at_destination_date' ,name: 'dz.name', class: 'align-middle arrive_at_destination_date'},
                    // {data:'rcp_confirm_date' ,name: 'dz.name', class: 'align-middle rcp_confirm_date'},
                    // {data:'first_attempt_lead_days' ,name: 'dz.name', class: 'align-middle first_attempt_lead_days'},
                    // {data:'transit_lead_days' ,name: 'dz.name', class: 'align-middle transit_lead_days'},
                    // {data:'last_status_lead_days' ,name: 'dz.name', class: 'align-middle last_status_lead_days'},
                ],
