        ...
        $(document).ready(function () {
            ...
            var table = $('#datatable').DataTable({
                ...
                columns: [
                    ...
                    { data:'shipper' ,name: 'u.name', class: 'align-middle sub_segment'},
                    { data:'shipper' ,name: 'u.name', class: 'align-middle vendor'},
                    { data:'shipper' ,name: 'u.name', class: 'align-middle order_id'},
                    { data:'shipper' ,name: 'u.name', class: 'align-middle current_status'},
                    { data: 'shipper' ,name:'u.name', class: 'align-middle reason'},
                    { data: 'shipper' ,name:'u.name', class: 'align-middle remark'},
                    { data:'shipper' ,name: 'u.name', class: 'align-middle total_attempt'},
                    { data:'shipper' ,name: 'u.name', class: 'align-middle payment_status'},
                    { data:'shipper' ,name: 'u.name', class: 'align-middle text-center invoice_number'},
                    { data:'shipper' ,name: 'u.name', class: 'align-middle payment_status'},
                    { data:'shipper' ,name: 'u.name', class: 'align-middle service_type'},
                    { data:'shipper' ,name: 'u.name', class: 'align-middle arrival_date'},
                    { data:'shipper' ,name: 'u.name', class: 'align-middle ridername'},
                    { data:'shipper' ,name: 'u.name', class: 'align-middle origin'},
                    { data:'shipper' ,name: 'u.name', class: 'align-middle destination'},
                    { data:'shipper' ,name: 'u.name', class: 'align-middle consignee_address'},
                    { data:'shipper' ,name: 'u.name', class: 'align-middle hub'},
                    { data:'shipper', name: 'u.name', class: 'align-middle return_city'},
                    { data:'shipper' ,name: 'u.name', class: 'align-middle zone'},
                    { data:'shipper' ,name: 'zu.name', class: 'align-middle class'},
                    { data:'shipper' ,name: 'u.name', class: 'align-middle attempts',sortable:false},
                ],
