        ...
        $(document).ready(function () {
            ...
            var table = $('#datatable').DataTable({
                ...
                columns: [
                    ...
                    { data:'booked_date' ,name:'shipments.created_at', class: 'align-middle remark'},
                    ...
                    { data:'booking_to_arrival_date_count' ,name: 'booking_to_arrival_date_count', class: 'align-middle'},
