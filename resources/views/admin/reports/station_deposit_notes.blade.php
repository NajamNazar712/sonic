                ...
                <div class="row mb-2 justify-content-center">
                    ...
                    <div class="col-3">
                        ...
                        <div class="form-group input-group ml">
                            ...
                            <input type="text" name="search_date_from" class="form-control pickadate bg-primary border-primary white rounded-right" id="search_date_from" placeholder="Creation Date (From)" title="Creation Date (From)" data-value="{{ Carbon\Carbon::today() }}">
                        </div>
                    </div>
                    <div class="col-3">
                        <div class="form-group input-group ml">
                            ...
                            <input type="text" name="search_date_to" class="form-control pickadate bg-primary border-primary white rounded-right" id="search_date_to" placeholder="Creation Date (To)" title="Creation Date (To)" data-value="{{ Carbon\Carbon::today() }}">
                        </div>
        ...
        $(document).ready(function () {
            ...
            var table = $('#datatable').DataTable({
                ...
                columns: [
                    ...
                    { data:'difference_amount' ,name: 'difference_amount', class: 'align-middle difference_amount',orderable: false},
