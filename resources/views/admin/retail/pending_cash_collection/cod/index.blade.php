...
@section('title', 'Pending Cash Collection COD')
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            var table = $('#datatable').DataTable({
                ...
                buttons: [
                {
                    ...
                    action: function (e, dt, node, config) {
                        ...
                        extend: 'excel',
                        title: 'Pending Cash Collection COD',
                ...
                serverSide: true,
                ajax: {
                    url:'{{ route('admin.delivery.cash_collection.retail.cod.list') }}',
                    data:function (d) {
            ...
            $('#datatable tbody').on('click','tr td.delivered_shipments_link button',function () {
                ...
                $.ajax({
                    url: '{!! route('admin.delivery.cash_collection.retail.pending.shipments.delivered') !!}',
                    method: 'POST',
                    data: {
                        '_token': '{{ csrf_token() }}',
                        'delivery_note_id': id
