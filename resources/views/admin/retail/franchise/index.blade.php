                ...
                <div class="modal-body text-center">
                    <form id="add_franchise_form" class="form-horizontal mb-1 justify-content-center" method="POST" action="{{ route('admin.retail.franchise.add') }}" novalidate="novalidate">
                        ...
                        <div class="form-group">
                            <input type="text" name="name" id="name" class="form-control" placeholder="Franchise Name*" data-rule-required="true" data-msg-required="Name is required" data-rule-remote="{{ route('admin.retail.users.name') }}" data-msg-remote="Name must be unique">
                        </div>
                        <div class="form-group">
...
@section('js')
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#edit_franchise_form #edit_hub').select2({
                width: '100%',
                placeholder: 'Select Default Hub',
                allowClear:true
            });
