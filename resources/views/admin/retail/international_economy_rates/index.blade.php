                                ...
                                <div class="row align-items-center justify-content-center">
                                    ...
                                    <div class="col ml-auto">
                                        <div class="form-group text-right">
                                            <a href="{{ asset('file/Retail International Economy Rates Upload Template.xlsx') }}?id=26-09-2024" class="btn btn-primary"><i class="la la-download"></i> Download Template</a>
                                        </div>
                                    </div>
                                </div>
                            </form>
...
@section('js')
    ...
    <script>
        ...
        var table1 = $('#document_datatable').DataTable({
            ...
            columns: [
                {orderable: false, searchable: false, name: 'serial_number', class: 'align-middle serial_number', render: function (data, type, row) { return ''; }},
