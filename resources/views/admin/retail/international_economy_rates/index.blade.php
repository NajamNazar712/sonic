...
@section('title', 'International Economy Rates Excel Upload')
    ...
    <div class="app-content content">
        <div class="content-wrapper">
            ...
            <div class="content-body">
                <h1 class="mb-1">
                    Retail International Economy Rates Excel Upload
                </h1>
                ...
                <div class="card">
                    <div class="card-content" aria-expanded="true">
                        <div class="card-body">
                            ...
                            <form id="retail_international_rates_upload_form" class="form-horizontal" method="POST" action="{{ route('admin.retail.international.economy_rates.excel') }}" novalidate="novalidate" enctype="multipart/form-data">
                                {{ csrf_field() }}
                            ...
                            <form id="non_document_upload_form" class="form-horizontal" method="POST" action="{{ route('admin.retail.international.economy_rates.excel') }}" novalidate="novalidate" enctype="multipart/form-data">
                                {{ csrf_field() }}
                            ...
                            <form id="box_upload_form" class="form-horizontal" method="POST" action="{{ route('admin.retail.international.economy_rates.excel') }}" novalidate="novalidate" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                <div class="row align-items-center justify-content-center">
                                    <div class="col-md-4">
                                        <div class="form-group">
    ...
    <script>
        ...
        /* jQuery.fn.DataTable.Api.register( 'buttons.exportData()', function ( options ) {
             if ( this.context.length ) {
                 ...
                 params.excel = true;
                 var jsonResult = $.ajax({
                     url: '{{ route('admin.retail.international.economy_rates.list') }}',
                    data: params,
