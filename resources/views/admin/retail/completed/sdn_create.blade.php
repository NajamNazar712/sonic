    ...
    <div class="card">
        <div class="card-content" aria-expanded="true">
            <div class="card-body">
                ...
                <form id="sdn_form" action="{{route('admin.delivery.completed.retail.sdn.create.submit')}}" method="post">
                    @csrf
                    <input type="hidden" name="sdn_pncc_ids" id="sdn_pncc_ids">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var table = $('#datatable').DataTable({
                ...
                serverSide: true,
                ajax: '{{ route('admin.delivery.completed.retail.pncc.list') }}',
                rowId: 'retail_pickup_note_id',
                columns: [
                    {orderable: false, searchable: false, name: 'serial_number', class: 'align-middle serial_number', targets: 0, render: function (data, type, row) {return '';}},
                    { data:'retail_pickup_note_id_padded' ,name: 'retail_pickup_notes.id', class: 'align-middle text-center retail_pickup_note_id_padded',orderable: false, searchable: false},
                    ...
                    { data:'shipment_count' ,name: 'retail_pickup_notes.shipments', class: 'align-middle shipment_count',orderable: false, searchable: false},
                    { data:'amount' ,name: 'retail_pickup_notes.amount', class: 'align-middle amount',orderable: false, searchable: false},
                ...
                initComplete: function() {
                    ...
                    //table pncc count
                    var pncc_count = table.rows().count();
                    $('#sdn_count').val(pncc_count);
