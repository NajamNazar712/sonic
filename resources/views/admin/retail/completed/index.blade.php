        ...
        $(document).ready(function() {
            ...
            var table = $('#datatable').DataTable({
                ...
                columns: [
                    ...
                    { data:'retail_pickup_note_id' ,name: 'retail_cash_deposits.id', class: 'align-middle text-center retail_pickup_note_id'},
                    ...
                    { data:'assigned_at' ,name: 'rpn.assigned_at', class: 'align-middle assigned_at'},
                    { data:'collected_by' ,name: 'cc.name', class: 'align-middle collected_by'},
                    { data:'cash_collected_at' ,name: 'rpn.cash_collected_at', class: 'align-middle cash_collected_at'},
