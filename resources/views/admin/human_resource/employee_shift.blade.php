        ...
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    <form action="{{route('admin.human_resource.employee_shifts.add_shift')}}" class="form-horizontal mb-1 justify-content-center" method="POST" id="addLocationForm" novalidate="novalidate">
                        {{csrf_field()}}
                        <div class="form-group">
                            <label><b>Shift Name</b></label>
                            <input type="text" name="name" id="name" class="form-control" data-rule-required="true" data-msg-required="Name is required">
                        </div>
                        <div class="form-group">
                            <label><b>Shift Start-time</b></label>
                            <input type="time" name="start_time" id="start_time" class="form-control" data-rule-required="true" data-msg-required="Start-time is required">
                        </div>
                        <div class="form-group">
                            <label for="end_time"><b>Shift End-time</b></label>
                            <input type="time" name="end_time" id="end_time" class="form-control" data-rule-required="true" data-msg-required="End-time is required">
                        </div>
                        <div class="form-group">
                            <label><b>Grace Minutes</b></label>
                            <input type="text" name="extension_minutes" id="extension_minutes" class="form-control extension_minutes" data-rule-required="true" data-msg-required="Grace Minutes is required" data-rule-min="0" data-msg-min="Grace minutes can not be less than 0" value="0">
                        </div>
    ...
    <div class="modal fade text-left" id="editShiftModal" data-backdrop="static" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    <form action="{{route('admin.human_resource.employee_shifts.edit_shift')}}" class="form-horizontal mb-1 justify-content-center" method="POST" id="editLocationForm" novalidate="novalidate">
                        {{csrf_field()}}
                        <input type="hidden" name="shift_id" id="shift_id" value="">
                        <div class="form-group">
                            <label><b>Shift Name</b></label>
                            <input type="text" name="name" id="edit_name" class="form-control" data-rule-required="true" data-msg-required="Name is required">
                        </div>
                        <div class="form-group">
                            <label><b>Shift Start-time</b></label>
                            <input type="time" name="start_time" id="edit_start_time" class="form-control" data-rule-required="true" data-msg-required="Start-time is required">
                        </div>
                        <div class="form-group">
                            <label for="end_time"><b>Shift End-time</b></label>
                            <input type="time" name="end_time" id="edit_end_time" class="form-control" data-rule-required="true" data-msg-required="End-time is required">
                        </div>
                        <div class="form-group">
                            <label><b>Grace Minutes</b></label>
                            <input type="text" name="extension_minutes" id="edit_extension_minutes" class="form-control extension_minutes" data-rule-required="true" data-msg-required="Grace Minutes is required" data-rule-min="0" data-msg-min="Grace minutes can not be less than 0" value="0">
                        </div>
        ...
        $(document).ready(function () {
            ...
            var table = $('#datatable').DataTable({
                ...
                columns: [
                    ...
                    {data: 'start_time_formatted', name: 'start_time', class: 'align-middle start_time_formatted'},
                    {data: 'end_time_formatted', name: 'end_time', class: 'align-middle end_time_formatted'},
                    {data: 'extension_minutes', name: 'extension_minutes', class: 'align-middle extension_minutes'},
                ...
                initComplete: function () {
                    ...
                    this.api().columns().every(function (column_id) {
                        ...
                        if ($(header).is('.serial_number') || $(header).is('.action') || $(header).is('.start_time_formatted') || $(header).is('.end_time_formatted')) {
                            $(td).appendTo($(search));
