...
@section('title', 'FNF Status History')

@section('content')
<h1>FNF Status History</h1>
...
*/
        ...
        serverSide: true,
            ajax: {
            url: '{{ route('admin.human_resource.fnf.status_history_list',$id) }}',
                data: function (d) {
                d.id = $('#fnf_id').val();
            }
        },
       // rowId: 'shId',
            ...
            {data: 'section_name', name: 'fs.name', class: 'align-middle section_name'},
            {data: 'status_name', name: 'fss.name', class: 'align-middle status_name'},
