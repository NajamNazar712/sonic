...
@section('title', 'Edit FNF Request')
                ...
                <div class="card">
                    <div class="card-content" aria-expanded="true">
                        <div class="card-body">
                            ...
                            <form id="edit_fnf_form" action="{{route('admin.human_resource.fnf.update_fnf_request')}}" method="post"  novalidate="novalidate">
                                    ...
                                    <div class="row mb-1">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control required" placeholder="Employee Name (Alphabet Only)" name="employee_name" id="employee_name" data-rule-required="true" data-msg-required="Name is required" disabled value="{{$fnf->employee->name}}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row mb-1">
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-md-6 text-center">
                                        <button type="submit" id="submit_employee_info" class="btn btn-primary">Update</button>
                                    </div>
                                </div>
                            </form>
                        </div>
