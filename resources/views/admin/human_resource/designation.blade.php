            ...
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    <form action="{{route('admin.human_resource.designation.edit')}}" class="form-horizontal mb-1 justify-content-center" method="POST" id="editDesignationForm" novalidate="novalidate">
                        ...
                        <div class="form-group">
                            <select name="department_id" id="department_edit" readonly="" class="select2 form-control " data-rule-required="true" data-msg-required="Department is required" style="width: 100%">
                                @foreach($departments as $department)
                                    <option value="{{$department->id}}">{{$department->name}}</option>
                                @endforeach
                            </select>
