...
@section('title','Rejected Petty Cash Statements')

@section('content')
    <h1 class="mb-1">
        Rejected Petty Cash Statements
    </h1>
        ...
        $(document).ready(function () {
            jQuery.fn.DataTable.Api.register( 'buttons.exportData()', function ( options ) {
                if ( this.context.length ) {
                    ...
                    params.excel = true;
                    var jsonResult = $.ajax({
                        url: '{{ route('admin.petty_cash.rejected.list') }}',
                        data: params,
            ...
            var table = $('#datatable').DataTable({
                ...
                serverSide: true,
                ajax: '{{ route('admin.petty_cash.rejected.list') }}',
                rowId: 'statement_id',
                order: [1, 'desc'],
                columns: [
