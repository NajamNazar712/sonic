        ...
        $(document).ready(function () {
            ...
            var table = $('#datatable').DataTable({
                ...
                buttons:[
                    {
                        ...
                        action: function (e, dt, node, config) {
                            window.location = '{{ route('admin.petty_cash.advance.index')  }}'
                        }
                    },
                    {
                        extend: 'selectAll',
                ...
                columns: [
                    ...
                    {data: 'statement_link', name: 'advance_petty_cash_statements.id', class: 'align-middle statement_link'},
                    ...
                    {data: 'status', name: 'advance_petty_cash_statements.status', class: 'align-middle status'},
            ...
            $('body').on('click','.sdn_update_logs button.sdn_logs',function(){
                ...
                $.ajax({
                    url: '{!! route('admin.petty_cash.advance.statements.advance_sdn_logs') !!}',
                    method: 'POST',
                    data: {
                        '_token': '{{ csrf_token() }}',
                        'statement_id': id
            ...
            function printStatement(id) {
                $.ajax({
                    url: '{!! route('admin.petty_cash.advance.statements.advance_print') !!}',
                    method: 'POST',
                    data: {
                        'id': id,
                        '_token': '{{ csrf_token() }}'
