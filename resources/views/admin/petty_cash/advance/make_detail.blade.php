    ...
    <div class="card">
        <div class="card-content" aria-expanded="true">
            <div class="card-body">
                ...
                <form id="make_statement_form" action="{{route('admin.petty_cash.advance.statements.make_detail_submit')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row">
                        <div class="col">
                            <fieldset class="form-group">
                                <select name="select_statement_zone" id="select_statement_zone" disabled class="form-control select2" data-rule-required="true" data-msg-required="Zone is required">
                        ...
                        <div class="col">
                            <fieldset class="form-group">
                                <select name="select_statement_hub" id="select_statement_hub" disabled class="form-control select2" data-rule-required="true" data-msg-required="Hub is required">
                                    @foreach($hubs as $hub)
...
@section('js')
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            {{--var hub_id = @json($petty_statement->hub_id);--}}
            {{--console.log(hub_id,11111111);--}}
            ...
            var hub_array = @json($hub_array[$petty_statement->zone_id]);
            console.log(hub_array);
            cities_data = $.map(hub_array, function (obj) {
                obj.id = obj.id;
                obj.text = obj.name;
                return obj;
            });
    ...
    function add_row() {
        ...
        var remarks_input = '<textarea class="form-control form-control-sm" rows="5" name="remarks['+rows_count+']" maxlength="1000" placeholder="Remarks"></textarea>';

        var upload_image = '<input class="form-control form-control-sm" type="file" name="upload_image'+rows_count+'" data-rule-extension="jpeg|jpg|png|xls|xlsx|pdf|msg" data-msg-extension="Only file with extension jpeg, jpg, pdf, xls, xlsx, msg or png allowed" data-rule-required="true" data-msg-required="Reference Document is required" data-rule-maxsize="2097152" data-msg-maxsize="File Size must not exceed 2 MB (2048 KB)."><br><input class="form-control form-control-sm" type="file" name="upload_2_image'+rows_count+'" data-rule-extension="jpeg|jpg|png|xls|xlsx|pdf|msg" data-msg-extension="Only file with extension jpeg, jpg, pdf, xls, xlsx, msg or png allowed" data-rule-maxsize="2097152" data-msg-maxsize="File Size must not exceed 2 MB (2048 KB).">';
        if(rows_count == 1){
            var remove = '';
        }else{
