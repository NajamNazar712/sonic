            ...
            var table = $('#datatable').DataTable({
                ...
                columns: [
                    ...
                    },
                    {
                        data: 'shipper_name',
                        name: 'u.name',
                        class: 'align-middle text_center shipper_name '
                    },{
                        data: 'commission',
                        name: 'scu.commission',
                        class: 'align-middle text_center commission '
                    },
                ],
                ...
                initComplete: function () {
                    ...
                    this.api().columns().every(function (column_id) {
                        ...
                        if ($(header).is('.action') || $(header).is('.serial_number') || $(header).is('.shipper_name') || $(header).is('.commission')) {
                            $(td).appendTo($(search));
                        } else {
