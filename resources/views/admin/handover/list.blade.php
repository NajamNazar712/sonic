        ...
        $(document).ready(function () {
            ...
            var table = $('#datatable').DataTable({
                ...
                columns: [
                    ...
                    {data: 'handovers.from_dept_area_desg', name: 'from_dept_area_desg', class: 'align-middle from_dept_area_desg'},
                    ...
                    {data: 'handovers.to_dept_area_desg', name: 'to_dept_area_desg', class: 'align-middle to_dept_area_desg'},
