...
<script>
    $(document).ready(function() {
        ...
        var url = '{!! route('
        admin.shipment.book.print_air_waybill ') !!}';
        ...
        function print(id) {
            var url = '{!! route('
            cod.shipment.book.print_air_waybill ') !!}';
        ...
        var table = $('#datatable').DataTable({
            ...
            columns: [{
                ...
                {
                    name: 'rider_picked',
                    class: 'align-middle rider_picked',
                    orderable: false,
                    searchable: false
                },
                {
        ...
        var try_and_buy_table = $('#try_and_buy_datatable').DataTable({
            ...
            columns: [{
                    orderable: false,
                    searchable: false,
                    name: 'try_serial_number',
                    class: 'align-middle serial_number'
                },
                {
                    name: 'try_item_id',
                    class: 'align-middle item_id',
                    orderable: false,
                    searchable: false
                },
                {
                    name: 'try_tracking_number',
                    class: 'align-middle tracking_number',
                    orderable: false,
                    searchable: false
                },
        ...
        $('#add_shipment_form').validate({
            ...
            submitHandler: function(form) {
                ...
                if (table.columns('.tracking_number').data().eq(0).indexOf(parseInt(tracking_number)) === -1) {
                    $.ajax({
                        url: '{!! route('
                        admin.v3_pickups.arrival.individual.shipment_details ') !!}',
                        method: 'POST',
                        data: {
                            'tracking_number': tracking_number,
                            'weight': weight,
                        ...
                        error: function(data) {
                            ...
                            scan_sound(2);
                            toastr.error('Couldn\'t connect to server, check internet connection and re-enter!', 'Error!', {
        ...
        $('#scan_item').on('change', function() {
            ...
            if (item) {
                ...
                if (new_item_index === -1) {
                    ...
                    $.ajax({
                        url: '{!! route('
                        admin.v3_pickups.arrival.individual.try_and_buy.item_details ') !!}',
                        method: 'POST',
                        data: {
                    ...
                    toastr.error('Shipment Item has been added already', 'Error!', {
                        positionClass: 'toast-top-center',
                        containerId: 'toast-top-center'
                    });
                }
        ...
        $('#add_try_and_buy_shipment_form').validate({
            ...
            submitHandler: function(form) {
                ...
                $.ajax({
                    url: '{!! route('
                    admin.v3_pickups.arrival.individual.try_and_buy.shipment_details ') !!}',
                    method: 'POST',
                    data: {
                        'tracking_number': tracking_number,
                        'weight': weight,
        ...
        $('#datatable tbody').on('click', 'tr td.remove button', function() {
            ...
            $.ajax({
                url: '{!! route('
                admin.v3_pickups.arrival.individual.shipment_remove ') !!}',
                method: 'POST',
                data: {
                    'id': id,
                    '_token': '{{ csrf_token() }}'
        ...
        var piece_table = $('#piece_datatable').DataTable({
            ...
            columns: [{
                    orderable: false,
                    searchable: false,
                    name: 'piece_serial_number',
                    class: 'align-middle serial_number'
                },
                {
                    name: 'piece_id',
                    class: 'align-middle piece_id',
                    orderable: false,
                    searchable: false
                },
                {
                    name: 'piece_tracking_number',
                    class: 'align-middle tracking_number',
                    orderable: false,
                    searchable: false
                },
        ...
        $('#scan_piece').on('change', function() {
            ...
            if (item) {
                ...
                if (new_item_index === -1) {
                    ...
                    $.ajax({
                        url: '{!! route('
                        admin.v3_pickups.arrival.bulk.piece.piece_details ') !!}',
                        method: 'POST',
                        data: {
                            'shipment_id': shipment_id,
                            'piece_id': item,
        ...
        $('#add_shipment_pieces_form').validate({
            ...
            submitHandler: function(form) {
                ...
                $.ajax({
                    url: '{!! route('
                    admin.v3_pickups.arrival.bulk.piece.shipment_details ') !!}',
                    method: 'POST',
                    data: {
                        'tracking_number': tracking_number,
                        'weight': weight,
