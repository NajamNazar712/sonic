								...
								<div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
										<div class="form-group input-group ">
                                            ...
                                            <input type="text" class="form-control bg-primary border-primary white rounded-right" min="{{$min_date}}" max="{{$max_date}}" name="call_date_time" id="call_date_time" placeholder="Date/Time" data-rule-required="true" data-msg-min="Cannot select date less than one year from current date."  data-msg-max="Cannot be greater than current date." data-msg-required="Date/Time is required">
										</div>
									</div>
                                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
										<div class="form-group">
