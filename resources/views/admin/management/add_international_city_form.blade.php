...
<form action="{{route('admin.management.international.city')}}" method="post" class="mt-2" id="addCityHubForm" novalidate="novalidate">
    ...
    <div class="row mb-2">
        ...
        <div class="col d-none" id="country_name_div">
            <fieldset class="form-group">
                <input type="text" class="form-control" name="cityName" placeholder="Add Country Name*" required data-rule-required="true" data-msg-required="This field is required">
            </fieldset>
        </div>
        <div class="col-3">
    ...
    <div class="modal-footer">
        <button type="submit" class="btn btn-warning btn-min-width btn-glow mr-1 mb-1" id="confirmAction">Add International City</button>
