...
@section('title', 'Incentive Riders')

@section('content')
    <h1>Incentive Riders</h1>
        ...
        $(document).ready(function() {
            ...
            jQuery.fn.DataTable.Api.register( 'buttons.exportData()', function ( options ) {
                if ( this.context.length ) {
                    ...
                    params.excel = true;
                    var jsonResult = $.ajax({
                        url: '{{ route('admin.management.riders.incentive.list') }}',
                        data: params,
            ...
            $('body').on('click','button.permanent',function (e) {
                var rider_id = $(this).parents('tr').attr('id');

                swal({
                    title: 'Are You Sure?',
                    text: 'Select Yes to Make this Rider as Permanent',
                    icon: 'warning',
                    buttons: {
                        cancel: {
                            text: 'No',
