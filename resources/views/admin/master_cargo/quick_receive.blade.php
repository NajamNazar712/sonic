                ...
                <div class="card">
                    <div class="card-content" aria-expanded="true">
                        <div class="card-body">
                            ...
                            <form id="receive_form" class="form-horizontal text-center" method="POST" action="{{ route('admin.master_cargo.receive.quick.store') }}" novalidate="novalidate">
                                {{ csrf_field() }}
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#add_bag_form').validate({
                ...
                submitHandler: function(form) {
                    ...
                    if (table.columns('.bag_number').data().eq(0).indexOf(parseInt(bag_number)) === -1) {
                        ...
                        $.ajax({
                            url: '{!! route('admin.master_cargo.receive.quick.bag_details') !!}',
                            method: 'POST',
                            data: {
            ...
            $('#receive_form').bind('submit', function(e) {
                ...
                var html = 'Are you sure, you want to confirm Master Cargo Bag(s) as received?';
