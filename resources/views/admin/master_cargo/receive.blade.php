...
@section('title', 'Receive Master Cargo')
                    ...
                    <div class="card-content" aria-expanded="true">
                        <div class="card-body">
                            ...
                            <div id="information" class="information text-center">
                                Master Cargo No #{{ str_pad(session('cargo_consignment_id'), 6, '0', STR_PAD_LEFT) }} | Scanned: <span class="scanned">0</span>/<span class="total">{{ $total }}</span>
                            </div>
                            ...
                            <form id="receive_form" class="form-horizontal text-center" method="POST" action="{{ route('admin.master_cargo.receive.store') }}" novalidate="novalidate">
                                {{ csrf_field() }}
                    ...
                    .done(function(data) {
                        if (data.status == 0) {
                            ...
                            if (data.short_received) {
                                ...
                                html += 'Are you sure, you want to confirm this Master Cargo received?';

                                $('#receive_form input.short_received').val(1);
                            }
                            else {
                                var html = 'Are you sure, you want to confirm Master Cargo No#' + cargo_consignment_id + ' as received?';
