                                        ...
                                        <form class="form-horizontal" method="POST" action="{{ route('admin.master_cargo.bag.create.store') }}" novalidate="novalidate">
                                            ...
                                            <div class="modal-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col">
                                                        <div class="form-group">
                                                            <input type="text" name="seal_number" class="form-control rounded-right seal_number" placeholder="Seal Number*" data-rule-required="true" data-msg-required="Seal Number is required" data-rule-minlength="5" data-msg-minlength="Seal Number needs to be at-least 5 numbers" data-rule-remote="{{ route('admin.master_cargo.bag.create.seal_number') }}" data-msg-remote="Seal Number must be unique">
                                                        </div>
                                                    </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#cargo_consignment_confirm').bind('click', function() {
                ...
                blockPagePermanently();
                $.ajax({
                    url: '{!! route('admin.master_cargo.bag.create.bag_details') !!}',
                    method: 'POST',
                    data: {
                    ...
                    success: function (data) {
                        ...
                        $('#cargo_consignment form .bag_type').val(bag_type);
