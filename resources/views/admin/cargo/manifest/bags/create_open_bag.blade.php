                    ...
                    <div class="card-content" aria-expanded="true">
                        <div class="card-body">
                            ...
                            <div class="text-center">
                                ...
                                <form class="form-horizontal" id="cargo_consignment" method="POST" action="{{ route('admin.cargo_manifest.bags.create.open_bag.store') }}" novalidate="novalidate">
                                    {{ csrf_field() }}
                                    ...
                                    <div class="modal-footer text-center justify-content-around">
                                        <button type="submit" id="cargo_consignment_confirm" name="submit_form" class="btn btn-primary mr-2" disabled="disabled">Submit</button>
                                    </div>
                                </form>
                            </div>
                        </div>
...
*/
            ...
            $('#cargo_consignment').validate({
                ...
                submitHandler: function(form) {
                    ...
                    $('#cargo_consignment .shipment_ids').val(shipment_ids);
                    $('#cargo_consignment .open_box_ids').val(open_box_ids);
                    ...
                    swal({
                        ...
                        if(confirm) {
                            swal({
                                title: 'Please Wait!',
                                text: 'Your Bag(s) are being created!',
                                icon: 'info',
                                buttons: false,
                                closeOnClickOutside: false,
                                closeOnEsc: false
