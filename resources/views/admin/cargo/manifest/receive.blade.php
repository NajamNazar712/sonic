                            ...
                            .done(function(data) {
                                if (data.status == 0) {
                                    ...
                                    if (index === -1) {
                                        ...
                                        table.row.add([rowNo + 1,data.details.bag_number,data.details.manifest_id,data.details.bag_type,data.details.origin,data.details.destination,data.details.last_junction,data.details.actual_weight,$action,data.details.misroute,data.details.without_manifest]).node().id = data.details.bag_id;
                                        table.draw(false);
