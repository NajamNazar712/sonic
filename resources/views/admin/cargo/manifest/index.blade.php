                                    ...
                                    <div class="col-3 mt-1">
                                        ...
                                        <span class="input-group-text bg-primary bg-darken-2 border-primary white rounded-left">
                                            ...
                                            <input type="text" name="search_date_from"
                                                   ...
                                                   id="search_date_from" placeholder="Select From Date" data-value="{{ Carbon\Carbon::today() }}">
                                        </div>
                                    </div>
                                    <div class="col-3 mt-1">
                                        <div class="form-group input-group">
                                        ...
                                        <span class="input-group-text bg-primary bg-darken-2 border-primary white rounded-left">
                                            ...
                                            <input type="text" name="search_date_to"
                                                   class="form-control pickadate bg-primary border-primary white rounded-right"
                                                   id="search_date_to" placeholder="Select To Date" data-value="{{ Carbon\Carbon::today() }}">
                                        </div>
                                    </div>
