                            ...
                            $.ajax({
                                ...
                                if(data.status == 0){
                                    ...
                                    $.each(data.data,function (key,value){
                                        ...
                                        var total_delivered_units = "<input type='text' value='"+value.units_per_item+"' class='form-control text-center total_delivered_units' data-rule-required='true' data-msg-required='Delivered Units is required' name='total_delivered_units["+value.pid+"]' id='total_delivered_units["+value.pid+"]' form='distribution_form'>";
