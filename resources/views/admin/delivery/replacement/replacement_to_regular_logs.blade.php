...
@section('title','Replacement To Regular Log')

@section('content')
    <h1 class="mb-1">
        Replacement To Regular Log
    </h1>
        ...
        $(document).ready(function () {
            ...
            jQuery.fn.DataTable.Api.register( 'buttons.exportData()', function ( options ) {
                if ( this.context.length ) {
                    ...
                    var jsonResult = $.ajax({
                        url: '{{ route('admin.delivery.replacement.logs.list') }}',
                        data: {
                            'page': 'all',
                        },
            ...
            var table = $('#datatable').DataTable({
                ...
                buttons: [
                    {
                        extend: 'excel',
                        title: 'Replacement To Regular Log',
                ...
                columns: [
                    ...
                    {data: 'type', name: 'replacement_to_regular_logs.type', class: 'align-middle type'},
