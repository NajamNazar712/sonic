...
@section('title', 'Replacement Collected')
        ...
        $(document).ready(function() {
            ...
            $('#search_form').validate({
                ...
                submitHandler: function(form) {
                    ...
                    $.ajax({
                        url: '{!! route('admin.delivery.replacement.collected.shipment_details') !!}',
                        method: 'POST',
                        data: {
                            '_token': '{{ csrf_token() }}',
                        ...
                        .done(function(data) {
                            if (data.status == 0) {
                                ...
                                $('#change_booking_type_form').removeClass('d-none');
                                $('#change_booking_type_form input.shipment_id').val(details.id);
