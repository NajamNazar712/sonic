...
{{--                                            </div>--}}
                            ...
                            <div class="text-center mt-2">
                                ...
                                <div class="form-group">
                                    ...
                                    @endif
                                    @if ((in_array($shipper->rate_status, [0, 1, 2]) && ($shipper->status == 1 || $shipper->status == 5) && (session('role_id') == 1 || in_array(8, session('permissions'))))|| ($shipper->rate_status ==1 && (session('role_id') == 1 || in_array(140, session('permissions')))))
