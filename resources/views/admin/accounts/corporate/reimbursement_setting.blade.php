    ...
    <script>
        $(document).ready(function() {
            ...
            $(".update").on('click',function (){
                ...
                let toggle = $("#status_on").is(':checked');
                if("{{$setting->setting_display}}" == toggle)
                {
                    toastr.error("Status must be changed before updating!!", 'Error!', {positionClass: 'toast-top-center', containerId: 'toast-top-center'});
                    return false;
                }
