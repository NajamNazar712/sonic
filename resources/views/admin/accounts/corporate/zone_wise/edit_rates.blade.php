                    ...
                    <div class="card-header">
                      {{--  <h2 class="font-large-1">{{$shipper->name}}
                        ...
                        <div class="row">
                            ...
                            <div class="col-3 mt-1">
                                <input type="checkbox" id="delivered_invoice_toggle" class="switchery delivered_invoice_toggle" data-size="xs" data-switchery="true" @if(isset($delivered_invoice->status) && $delivered_invoice->status == 1) checked @endif>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="weight-addition-overnight">
                                            ...
                                            @foreach($weight[1] as $index => $onweight)
                                                ...
                                                <div class="row on_door_weight_row" id="on_door_weight_row{{$index_row}}">
                                                    ...
                                                    <div class="col text-center">
                                                        <fieldset class="form-group">
                                                            <input type="text" class="form-control @if ((isset($e_weight[1][$on_index_row]) && $e_weight[1][$on_index_row]->delivery_type_id == 1) && ($e_weight[1][$on_index_row]->local != $onweight->local)) changed @elseif(((isset($e_weight[1][$on_index_row]) && $e_weight[1][$on_index_row]->delivery_type_id == 2) || !isset($e_weight[1][$on_index_row])) && $existing == 1) new @endif  numeric" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title=" @if ((isset($e_weight[1][$on_index_row]) && $e_weight[1][$on_index_row]->delivery_type_id == 1) && ($e_weight[1][$on_index_row]->local != $onweight->local)) {{$e_weight[1][$on_index_row]->local}} @endif" data-rule-required="true" data-msg-required="This field is required" value="{{$onweight->local}}" name="on_door_local_charges[{{$index_row}}]">
                                                        </fieldset>
                                                    </div>
                                                    <div class="col text-center">
                                                        <fieldset class="form-group">
                                                            <input type="text" class="form-control @if ((isset($e_weight[1][$on_index_row]) && $e_weight[1][$on_index_row]->delivery_type_id == 1) && ($e_weight[1][$on_index_row]->same_zone != $onweight->same_zone)) changed @elseif(((isset($e_weight[1][$on_index_row]) && $e_weight[1][$on_index_row]->delivery_type_id == 2) || !isset($e_weight[1][$on_index_row])) && $existing == 1) new @endif  dec-percent" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title=" @if ((isset($e_weight[1][$on_index_row]) && $e_weight[1][$on_index_row]->delivery_type_id == 1) && ($e_weight[1][$on_index_row]->same_zone != $onweight->same_zone)) {{$e_weight[1][$on_index_row]->same_zone}} @endif" data-rule-required="true" data-msg-required="This field is required" value="{{$onweight->same_zone}}" name="on_door_same_zone_charges[{{$index_row}}]">
                                                        </fieldset>
                                                    </div>
                                                    <div class="col text-center">
                                                        <fieldset class="form-group">
                                                            <input type="text" class="form-control @if ((isset($e_weight[1][$on_index_row]) && $e_weight[1][$on_index_row]->delivery_type_id == 1) && ($e_weight[1][$on_index_row]->different_zone != $onweight->different_zone)) changed @elseif(((isset($e_weight[1][$on_index_row]) && $e_weight[1][$on_index_row]->delivery_type_id == 2) || !isset($e_weight[1][$on_index_row])) && $existing == 1) new @endif  dec-percent" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="@if ((isset($e_weight[1][$on_index_row]) && $e_weight[1][$on_index_row]->delivery_type_id == 1) && ($e_weight[1][$on_index_row]->different_zone != $onweight->different_zone)) {{$e_weight[1][$on_index_row]->different_zone}} @endif" data-rule-required="true" data-msg-required="This field is required" value="{{$onweight->different_zone}}" name="on_door_different_zone_charges[{{$index_row}}]">
                                                        </fieldset>
                                                    </div>
                                            ...
                                            @endforeach
                                                ...
                                                <div class="row on_door_weight_row" id="on_door_weight_row0">
                                                    ...
                                                    <div class="col text-center">
                                                        <fieldset class="form-group">
                                                            <input type="text" class="form-control dec-percent" data-rule-required="true" data-msg-required="This field is required" value="" name="on_door_same_zone_charges[1]">
                                                        </fieldset>
                                                    </div>
                                                    <div class="col text-center">
                                                        <fieldset class="form-group">
                                                            <input type="text" class="form-control dec-percent" data-rule-required="true" data-msg-required="This field is required" value="" name="on_door_different_zone_charges[1]">
                                                        </fieldset>
                                                    </div>
                                        ...
                                        <div class="hub-weight-addition-overnight">
                                            ...
                                            @foreach($weight[1] as $index => $onweight)
                                                @if($onweight->delivery_type_id == 2)
                                                    ...
                                                    <div class="col text-center">
                                                        <fieldset class="form-group">
                                                            <input type="text" class="form-control @if ((isset($e_weight[1][$on_index_row]) && $e_weight[1][$on_index_row]->delivery_type_id == 2) && ($e_weight[1][$on_index_row]->local != $onweight->local)) changed @elseif((!isset($e_weight[1][$on_index_row])) && $existing == 1) new @endif numeric" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="@if ((isset($e_weight[1][$on_index_row]) && $e_weight[1][$on_index_row]->delivery_type_id == 2) && ($e_weight[1][$on_index_row]->local != $onweight->local)) {{$e_weight[1][$on_index_row]->local}} @endif" data-rule-required="true" data-msg-required="This field is required" value="{{$onweight->local}}" name="on_hub_local_charges[{{$index_row}}]">
                                                        </fieldset>
                                                    </div>
                                                    <div class="col text-center">
                                                        <fieldset class="form-group">
                                                            <input type="text" class="form-control @if ((isset($e_weight[1][$on_index_row]) && $e_weight[1][$on_index_row]->delivery_type_id == 2) && ($e_weight[1][$on_index_row]->same_zone != $onweight->same_zone)) changed @elseif((!isset($e_weight[1][$on_index_row])) && $existing == 1) new @endif dec-percent" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="@if ((isset($e_weight[1][$on_index_row]) && $e_weight[1][$on_index_row]->delivery_type_id == 2) && ($e_weight[1][$on_index_row]->same_zone != $onweight->same_zone)) {{$e_weight[1][$on_index_row]->same_zone}} @endif" data-rule-required="true" data-msg-required="This field is required" value="{{$onweight->same_zone}}" name="on_hub_same_zone_charges[{{$index_row}}]">
                                                        </fieldset>
                                                    </div>
                                                    <div class="col text-center">
                                                        <fieldset class="form-group">
                                                            <input type="text" class="form-control @if ((isset($e_weight[1][$on_index_row]) && $e_weight[1][$on_index_row]->delivery_type_id == 2) && ($e_weight[1][$on_index_row]->different_zone != $onweight->different_zone)) changed @elseif((!isset($e_weight[1][$on_index_row])) && $existing == 1) new @endif dec-percent" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="@if ((isset($e_weight[1][$on_index_row]) && $e_weight[1][$on_index_row]->delivery_type_id == 2) && ($e_weight[1][$on_index_row]->different_zone != $onweight->different_zone)) {{$e_weight[1][$on_index_row]->different_zone}} @endif" data-rule-required="true" data-msg-required="This field is required" value="{{$onweight->different_zone}}" name="on_hub_different_zone_charges[{{$index_row}}]">
                                                        </fieldset>
                                                    </div>
                                                    <div class="col-1">
                                                        @if($index_row>1)
                                            ...
                                            @endforeach
                                                ...
                                                <div class="row on_hub_weight_row" id="on_hub_weight_row0">
                                                    ...
                                                    <div class="col text-center">
                                                        <fieldset class="form-group">
                                                            <input type="text" class="form-control dec-percent" data-rule-required="true" data-msg-required="This field is required" value="" name="on_hub_same_zone_charges[1]" disabled>
                                                        </fieldset>
                                                    </div>
                                                    <div class="col text-center">
                                                        <fieldset class="form-group">
                                                            <input type="text" class="form-control dec-percent" data-rule-required="true" data-msg-required="This field is required" value="" name="on_hub_different_zone_charges[1]" disabled>
                                                        </fieldset>
                                                    </div>
                                                    <div class="col-1">
                                                    </div>
                                        ...
                                        <div class="row return-charges-div-overnight">
                                            ...
                                            <div class="col text-center">
                                                ...
                                                <fieldset class="form-group">
                                                    <input type="text" data-rule-required="true" data-msg-required="This field is required" class="form-control @if(isset($e_returnCharges[1][0]) && isset($returnCharges[1][0]) && $e_returnCharges[1][0]->same_zone != $returnCharges[1][0]->same_zone) changed @elseif(!isset($e_returnCharges[1][0]) && $existing == 1) new @endif dec-percent" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="@if(isset($e_returnCharges[1][0]) && isset($returnCharges[1][0]) && $e_returnCharges[1][0]->same_zone != $returnCharges[1][0]->same_zone) {{$e_returnCharges[1][0]->same_zone}} @endif" name="on_return_same_zone_charges"  value="{{ (isset($returnCharges[1][0]) && $returnCharges[1][0]->same_zone !== '')? $returnCharges[1][0]->same_zone : ''}}" {{$on_return_sw}}>
                                                </fieldset>
                                            </div>
                                            <div class="col text-center">
                                                <label class="card-title">Different Zone</label>
                                                <fieldset class="form-group">
                                                    <input type="text" data-rule-required="true" data-msg-required="This field is required" class="form-control @if(isset($e_returnCharges[1][0]) && isset($returnCharges[1][0]) && $e_returnCharges[1][0]->different_zone != $returnCharges[1][0]->different_zone) changed @elseif(!isset($e_returnCharges[1][0]) && $existing == 1) new @endif dec-percent" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="@if(isset($e_returnCharges[1][0]) && isset($returnCharges[1][0]) && $e_returnCharges[1][0]->different_zone != $returnCharges[1][0]->different_zone) {{$e_returnCharges[1][0]->different_zone}} @endif" name="on_return_different_zone_charges"  value="{{ (isset($returnCharges[1][0]) && $returnCharges[1][0]->different_zone !== '')? $returnCharges[1][0]->different_zone : ''}}" {{$on_return_sw}}>
                                                </fieldset>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="weight-addition-overland">
                                            ...
                                            @foreach($weight[2] as $index => $olweight)
                                                ...
                                                <div class="row ol_door_weight_row" id="ol_door_weight_row{{$index_row}}">
                                                    ...
                                                    <div class="col text-center">
                                                        <fieldset class="form-group">
                                                            <input type="text" class="form-control @if ((isset($e_weight[2][$ol_index_row]) && $e_weight[2][$ol_index_row]->delivery_type_id == 1) && ($e_weight[2][$ol_index_row]->local != $olweight->local)) changed @elseif(((isset($e_weight[2][$ol_index_row]) && $e_weight[2][$ol_index_row]->delivery_type_id == 2) || !isset($e_weight[2][$ol_index_row])) && $existing == 1) new @endif decimal" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="@if ((isset($e_weight[2][$ol_index_row]) && $e_weight[2][$ol_index_row]->delivery_type_id == 1) && ($e_weight[2][$ol_index_row]->local != $olweight->local)) {{$e_weight[2][$ol_index_row]->local}} @endif" data-rule-required="true" data-msg-required="This field is required" value="{{$olweight->local}}" name="ol_door_local_charges[{{$index_row}}]">
                                                        </fieldset>
                                                    </div>
                                                    <div class="col text-center">
                                                        <fieldset class="form-group">
                                                            <input type="text" class="form-control @if ((isset($e_weight[2][$ol_index_row]) && $e_weight[2][$ol_index_row]->delivery_type_id == 1) && ($e_weight[2][$ol_index_row]->same_zone != $olweight->same_zone)) changed @elseif(((isset($e_weight[2][$ol_index_row]) && $e_weight[2][$ol_index_row]->delivery_type_id == 2) || !isset($e_weight[2][$ol_index_row])) && $existing == 1) new @endif dec-percent" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="@if ((isset($e_weight[2][$ol_index_row]) && $e_weight[2][$ol_index_row]->delivery_type_id == 1) && ($e_weight[2][$ol_index_row]->same_zone != $olweight->same_zone)) {{$e_weight[2][$ol_index_row]->same_zone}} @endif" data-rule-required="true" data-msg-required="This field is required" value="{{$olweight->same_zone}}" name="ol_door_same_zone_charges[{{$index_row}}]">
                                                        </fieldset>
                                                    </div> <div class="col text-center">
                                                        <fieldset class="form-group">
                                                            <input type="text" class="form-control @if ((isset($e_weight[2][$ol_index_row]) && $e_weight[2][$ol_index_row]->delivery_type_id == 1) && ($e_weight[2][$ol_index_row]->different_zone != $olweight->different_zone)) changed @elseif(((isset($e_weight[2][$ol_index_row]) && $e_weight[2][$ol_index_row]->delivery_type_id == 2) || !isset($e_weight[2][$ol_index_row])) && $existing == 1) new @endif dec-percent" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="@if ((isset($e_weight[2][$ol_index_row]) && $e_weight[2][$ol_index_row]->delivery_type_id == 1) && ($e_weight[2][$ol_index_row]->different_zone != $olweight->different_zone)) {{$e_weight[2][$ol_index_row]->different_zone}} @endif" data-rule-required="true" data-msg-required="This field is required" value="{{$olweight->different_zone}}" name="ol_door_different_zone_charges[{{$index_row}}]">
                                                        </fieldset>
                                                    </div>
                                                    <div class="col-1">
                                                        @if($index_row>1)
                                            ...
                                            @endforeach
                                                ...
                                                <div class="row ol_door_weight_row" id="ol_door_weight_row1">
                                                    ...
                                                    <div class="col text-center">
                                                        <fieldset class="form-group">
                                                            <input type="text" class="form-control dec-percent" data-rule-required="true" data-msg-required="This field is required" value="" name="ol_door_same_zone_charges[1]">
                                                        </fieldset>
                                                    </div> <div class="col text-center">
                                                        <fieldset class="form-group">
                                                            <input type="text" class="form-control dec-percent" data-rule-required="true" data-msg-required="This field is required" value="" name="ol_door_different_zone_charges[1]">
                                                        </fieldset>
                                                    </div>
                                                    <div class="col-1">
                                                    </div>
                                        ...
                                        <div class="hub-weight-addition-overland">
                                            ...
                                            @foreach($weight[2] as $index => $olweight)
                                                ...
                                                <div class="row ol_hub_weight_row" id="ol_hub_weight_row{{$index_row}}">
                                                    ...
                                                    <div class="col text-center">
                                                        <fieldset class="form-group">
                                                            <input type="text" class="form-control @if ((isset($e_weight[2][$ol_index_row]) && $e_weight[2][$ol_index_row]->delivery_type_id == 2) && ($e_weight[2][$ol_index_row]->local != $olweight->local)) changed @elseif(((isset($e_weight[2][$ol_index_row]) && $e_weight[2][$ol_index_row]->delivery_type_id == 1) || !isset($e_weight[2][$ol_index_row])) && $existing == 1) new @endif amount" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="@if ((isset($e_weight[2][$ol_index_row]) && $e_weight[2][$ol_index_row]->delivery_type_id == 2) && ($e_weight[2][$ol_index_row]->local != $olweight->local)) {{$e_weight[2][$ol_index_row]->local}} @endif" data-rule-required="true" data-msg-required="This field is required" value="{{$olweight->local}}" name="ol_hub_local_charges[{{$index_row}}]">
                                                        </fieldset>
                                                    </div>
                                                    <div class="col text-center">
                                                        <fieldset class="form-group">
                                                            <input type="text" class="form-control @if ((isset($e_weight[2][$ol_index_row]) && $e_weight[2][$ol_index_row]->delivery_type_id == 2) && ($e_weight[2][$ol_index_row]->same_zone != $olweight->same_zone)) changed @elseif(((isset($e_weight[2][$ol_index_row]) && $e_weight[2][$ol_index_row]->delivery_type_id == 1) || !isset($e_weight[2][$ol_index_row])) && $existing == 1) new @endif dec-percent" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="@if ((isset($e_weight[2][$ol_index_row]) && $e_weight[2][$ol_index_row]->delivery_type_id == 2) && ($e_weight[2][$ol_index_row]->same_zone != $olweight->same_zone)) {{$e_weight[2][$ol_index_row]->same_zone}} @endif" data-rule-required="true" data-msg-required="This field is required" value="{{$olweight->same_zone}}" name="ol_hub_same_zone_charges[{{$index_row}}]">
                                                        </fieldset>
                                                    </div> <div class="col text-center">
                                                        <fieldset class="form-group">
                                                            <input type="text" class="form-control @if ((isset($e_weight[2][$ol_index_row]) && $e_weight[2][$ol_index_row]->delivery_type_id == 2) && ($e_weight[2][$ol_index_row]->different_zone != $olweight->different_zone)) changed @elseif(((isset($e_weight[2][$ol_index_row]) && $e_weight[2][$ol_index_row]->delivery_type_id == 1) || !isset($e_weight[2][$ol_index_row])) && $existing == 1) new @endif dec-percent" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="@if ((isset($e_weight[2][$ol_index_row]) && $e_weight[2][$ol_index_row]->delivery_type_id == 2) && ($e_weight[2][$ol_index_row]->different_zone != $olweight->different_zone)) {{$e_weight[2][$ol_index_row]->different_zone}} @endif" data-rule-required="true" data-msg-required="This field is required" value="{{$olweight->different_zone}}" name="ol_hub_different_zone_charges[{{$index_row}}]">
                                                        </fieldset>
                                                    </div>
                                                    <div class="col-1">
                                                        @if($index_row>1)
                                            ...
                                            @endforeach
                                                ...
                                                <div class="row ol_hub_weight_row" id="ol_hub_weight_row1">
                                                    ...
                                                    <div class="col text-center">
                                                        <fieldset class="form-group">
                                                            <input type="text" class="form-control dec-percent" data-rule-required="true" data-msg-required="This field is required" value="" name="ol_hub_same_zone_charges[1]" disabled>
                                                        </fieldset>
                                                    </div> <div class="col text-center">
                                                        <fieldset class="form-group">
                                                            <input type="text" class="form-control dec-percent" data-rule-required="true" data-msg-required="This field is required" value="" name="ol_hub_different_zone_charges[1]" disabled>
                                                        </fieldset>
                                                    </div>
                                                    <div class="col-1">
                                                    </div>
                                        ...
                                        <div class="row return-charges-div-overland justify-content-center">
                                            ...
                                            <div class="col text-center">
                                                <label class="card-title">Same Zone</label>
                                                <fieldset class="form-group">
                                                    <input type="text" data-rule-required="true" data-msg-required="This field is required" class="form-control @if(isset($e_returnCharges[2][0]) && isset($returnCharges[2][0]) && $e_returnCharges[2][0]->same_zone != $returnCharges[2][0]->same_zone) changed @elseif(!isset($e_returnCharges[2][0]) && $existing == 1) new @endif dec-percent" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="@if(isset($e_returnCharges[2][0]) && isset($returnCharges[2][0]) && $e_returnCharges[2][0]->same_zone != $returnCharges[2][0]->same_zone) {{$e_returnCharges[2][0]->same_zone}} @endif" name="ol_return_same_zone_charges"  value="{{ (isset($returnCharges[2][0]) && $returnCharges[2][0]->same_zone !== '')? $returnCharges[2][0]->same_zone : ''}}" {{$ol_return_sw}}>
                                                </fieldset>
                                            </div>
                                            <div class="col text-center">
                                                <label class="card-title">Different Zone</label>
                                                <fieldset class="form-group">
                                                    <input type="text" data-rule-required="true" data-msg-required="This field is required" class="form-control @if(isset($e_returnCharges[2][0]) && isset($returnCharges[2][0]) && $e_returnCharges[2][0]->different_zone != $returnCharges[2][0]->different_zone) changed @elseif(!isset($e_returnCharges[2][0]) && $existing == 1) new @endif dec-percent" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="@if(isset($e_returnCharges[2][0]) && isset($returnCharges[2][0]) && $e_returnCharges[2][0]->different_zone != $returnCharges[2][0]->different_zone) {{$e_returnCharges[2][0]->different_zone}} @endif" name="ol_return_different_zone_charges"  value="{{ (isset($returnCharges[2][0]) && $returnCharges[2][0]->different_zone !== '')? $returnCharges[2][0]->different_zone : ''}}" {{$ol_return_sw}}>
                                                </fieldset>
                                            </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="weight-addition-detain">
                                            ...
                                            @foreach($weight[3] as $index => $detweight)
                                                ...
                                                <div class="row detain_door_weight_row" id="detain_door_weight_row{{$index_row}}">
                                                    ...
                                                    <div class="col text-center">
                                                        <fieldset class="form-group">
                                                            <input type="text" class="form-control @if ((isset($e_weight[3][$det_index_row]) && $e_weight[3][$det_index_row]->delivery_type_id == 1) && ($e_weight[3][$det_index_row]->local != $detweight->local)) changed @elseif(((isset($e_weight[3][$det_index_row]) && $e_weight[3][$det_index_row]->delivery_type_id == 2) || !isset($e_weight[3][$det_index_row])) && $existing == 1) new @endif decimal" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="@if ((isset($e_weight[3][$det_index_row]) && $e_weight[3][$det_index_row]->delivery_type_id == 1) && ($e_weight[3][$det_index_row]->local != $detweight->local)) {{$e_weight[3][$det_index_row]->local}} @endif" data-rule-required="true" data-msg-required="This field is required" value="{{$detweight->local}}" name="detain_door_local_charges[{{$index_row}}]">
                                                        </fieldset>
                                                    </div>
                                                    <div class="col">
                                                        <fieldset class="form-group">
                                                            <input type="text" class="form-control @if ((isset($e_weight[3][$det_index_row]) && $e_weight[3][$det_index_row]->delivery_type_id == 1) && ($e_weight[3][$det_index_row]->same_zone != $detweight->same_zone)) changed @elseif(((isset($e_weight[3][$det_index_row]) && $e_weight[3][$det_index_row]->delivery_type_id == 2) || !isset($e_weight[3][$det_index_row])) && $existing == 1) new @endif dec-percent" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="@if ((isset($e_weight[3][$det_index_row]) && $e_weight[3][$det_index_row]->delivery_type_id == 1) && ($e_weight[3][$det_index_row]->same_zone != $detweight->same_zone)) {{$e_weight[3][$det_index_row]->same_zone}} @endif" data-rule-required="true" data-msg-required="This field is required" value="{{$detweight->same_zone}}" name="detain_door_same_zone_charges[{{$index_row}}]">
                                                        </fieldset>
                                                    </div>
                                                    <div class="col">
                                                        <fieldset class="form-group">
                                                            <input type="text" class="form-control @if ((isset($e_weight[3][$det_index_row]) && $e_weight[3][$det_index_row]->delivery_type_id == 1) && ($e_weight[3][$det_index_row]->different_zone != $detweight->different_zone)) changed @elseif(((isset($e_weight[3][$det_index_row]) && $e_weight[3][$det_index_row]->delivery_type_id == 2) || !isset($e_weight[3][$det_index_row])) && $existing == 1) new @endif dec-percent" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="@if ((isset($e_weight[3][$det_index_row]) && $e_weight[3][$det_index_row]->delivery_type_id == 1) && ($e_weight[3][$det_index_row]->different_zone != $detweight->different_zone)) {{$e_weight[3][$det_index_row]->different_zone}} @endif" data-rule-required="true" data-msg-required="This field is required" value="{{$detweight->different_zone}}" name="detain_door_different_zone_charges[{{$index_row}}]">
                                                        </fieldset>
                                                    </div>
                                            ...
                                            @endforeach
                                                ...
                                                <div class="row detain_door_weight_row" id="detain_door_weight_row1">
                                                    ...
                                                    <div class="col">
                                                        <fieldset class="form-group">
                                                            <input type="text" class="form-control dec-percent" data-rule-required="true" data-msg-required="This field is required" value="" name="detain_door_same_zone_charges[1]">
                                                        </fieldset>
                                                    </div>
                                                    <div class="col">
                                                        <fieldset class="form-group">
                                                            <input type="text" class="form-control dec-percent" data-rule-required="true" data-msg-required="This field is required" value="" name="detain_door_different_zone_charges[1]">
                                                        </fieldset>
                                                    </div>
                                                    <div class="col-1">
                                                    </div>
                                        ...
                                        <div class="hub-weight-addition-detain">
                                            ...
                                            @foreach($weight[3] as $index => $detweight)
                                                ...
                                                <div class="row detain_hub_weight_row" id="detain_hub_weight_row{{$index_row}}">
                                                    ...
                                                    <div class="col text-center">
                                                        <fieldset class="form-group">
                                                            <input type="text" class="form-control @if ((isset($e_weight[3][$det_index_row]) && $e_weight[3][$det_index_row]->delivery_type_id == 2) && ($e_weight[3][$det_index_row]->local != $detweight->local)) changed @elseif(((isset($e_weight[3][$det_index_row]) && $e_weight[3][$det_index_row]->delivery_type_id == 1) || !isset($e_weight[3][$det_index_row])) && $existing == 1) new @endif decimal" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="@if ((isset($e_weight[3][$det_index_row]) && $e_weight[3][$det_index_row]->delivery_type_id == 2) && ($e_weight[3][$det_index_row]->local != $detweight->local)) {{$e_weight[3][$det_index_row]->local}} @endif" data-rule-required="true" data-msg-required="This field is required" value="{{$detweight->local}}" name="detain_hub_local_charges[{{$index_row}}]">
                                                        </fieldset>
                                                    </div>
                                                    <div class="col">
                                                        <fieldset class="form-group">
                                                            <input type="text" class="form-control @if ((isset($e_weight[3][$det_index_row]) && $e_weight[3][$det_index_row]->delivery_type_id == 2) && ($e_weight[3][$det_index_row]->same_zone != $detweight->same_zone)) changed @elseif(((isset($e_weight[3][$det_index_row]) && $e_weight[3][$det_index_row]->delivery_type_id == 1) || !isset($e_weight[3][$det_index_row])) && $existing == 1) new @endif dec-percent" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="@if ((isset($e_weight[3][$det_index_row]) && $e_weight[3][$det_index_row]->delivery_type_id == 2) && ($e_weight[3][$det_index_row]->same_zone != $detweight->same_zone)) {{$e_weight[3][$det_index_row]->same_zone}} @endif" data-rule-required="true" data-msg-required="This field is required" value="{{$detweight->same_zone}}" name="detain_hub_same_zone_charges[{{$index_row}}]">
                                                        </fieldset>
                                                    </div>
                                                    <div class="col">
                                                        <fieldset class="form-group">
                                                            <input type="text" class="form-control @if ((isset($e_weight[3][$det_index_row]) && $e_weight[3][$det_index_row]->delivery_type_id == 2) && ($e_weight[3][$det_index_row]->different_zone != $detweight->different_zone)) changed @elseif(((isset($e_weight[3][$det_index_row]) && $e_weight[3][$det_index_row]->delivery_type_id == 1) || !isset($e_weight[3][$det_index_row])) && $existing == 1) new @endif dec-percent" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="@if ((isset($e_weight[3][$det_index_row]) && $e_weight[3][$det_index_row]->delivery_type_id == 2) && ($e_weight[3][$det_index_row]->different_zone != $detweight->different_zone)) {{$e_weight[3][$det_index_row]->different_zone}} @endif" data-rule-required="true" data-msg-required="This field is required" value="{{$detweight->different_zone}}" name="detain_hub_different_zone_charges[{{$index_row}}]">
                                                        </fieldset>
                                                    </div>
                                                    <div class="col-1">
                                                        @if($index_row>1)
                                            ...
                                            @endforeach
                                                ...
                                                <div class="row detain_hub_weight_row" id="detain_hub_weight_row1">
                                                    ...
                                                    <div class="col">
                                                        <fieldset class="form-group">
                                                            <input type="text" class="form-control dec-percent" data-rule-required="true" data-msg-required="This field is required" value="" name="detain_hub_same_zone_charges[1]" disabled>
                                                        </fieldset>
                                                    </div>
                                                    <div class="col">
                                                        <fieldset class="form-group">
                                                            <input type="text" class="form-control dec-percent" data-rule-required="true" data-msg-required="This field is required" value="" name="detain_hub_different_zone_charges[1]" disabled>
                                                        </fieldset>
                                                    </div>
                                                    <div class="col-1">
                                                    </div>
                                        ...
                                        <div class="row return-charges-div-detain justify-content-center">
                                            ...
                                            <div class="col text-center">
                                                <label class="card-title">Same Zone</label>
                                                <fieldset class="form-group">
                                                    <input type="text" data-rule-required="true" data-msg-required="This field is required" class="form-control @if(isset($e_returnCharges[3][0]) && isset($returnCharges[3][0]) && $e_returnCharges[3][0]->same_zone != $returnCharges[3][0]->same_zone) changed @elseif(!isset($e_returnCharges[3][0]) && $existing == 1) new @endif dec-percent" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="@if(isset($e_returnCharges[3][0]) && isset($returnCharges[3][0]) && $e_returnCharges[3][0]->same_zone != $returnCharges[3][0]->same_zone) {{$e_returnCharges[3][0]->same_zone}} @endif" name="detain_return_same_zone_charges"  value="{{ (isset($returnCharges[3][0]) && $returnCharges[3][0]->same_zone !== '')? $returnCharges[3][0]->same_zone : ''}}" {{$det_return_sw}}>
                                                </fieldset>
                                            </div>
                                            <div class="col text-center">
                                                <label class="card-title">Different Zone</label>
                                                <fieldset class="form-group">
                                                    <input type="text" data-rule-required="true" data-msg-required="This field is required" class="form-control @if(isset($e_returnCharges[3][0]) && isset($returnCharges[3][0]) && $e_returnCharges[3][0]->different_zone != $returnCharges[3][0]->different_zone) changed @elseif(!isset($e_returnCharges[3][0]) && $existing == 1) new @endif dec-percent" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="@if(isset($e_returnCharges[3][0]) && isset($returnCharges[3][0]) && $e_returnCharges[3][0]->different_zone != $returnCharges[3][0]->different_zone) {{$e_returnCharges[3][0]->different_zone}} @endif" name="detain_return_different_zone_charges"  value="{{ (isset($returnCharges[3][0]) && $returnCharges[3][0]->different_zone !== '')? $returnCharges[3][0]->different_zone : ''}}" {{$det_return_sw}}>
                                                </fieldset>
                                            </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="weight-addition-sameday">
                                            ...
                                            @foreach($weight[4] as $index => $sameweight)
                                                ...
                                                <div class="row sameday_door_weight_row" id="sameday_door_weight_row{{$index_row}}">
                                                    ...
                                                    <div class="col text-center">
                                                        <fieldset class="form-group">
                                                            <input type="text" class="form-control @if ((isset($e_weight[4][$same_index_row]) && $e_weight[4][$same_index_row]->delivery_type_id == 1) && ($e_weight[4][$same_index_row]->local != $sameweight->local)) changed @elseif(((isset($e_weight[4][$same_index_row]) && $e_weight[4][$same_index_row]->delivery_type_id == 2) || !isset($e_weight[4][$same_index_row])) && $existing == 1) new @endif dec-percent" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="@if ((isset($e_weight[4][$same_index_row]) && $e_weight[4][$same_index_row]->delivery_type_id == 1) && ($e_weight[4][$same_index_row]->local != $sameweight->local)) {{$e_weight[4][$same_index_row]->local}} @endif" data-rule-required="true" data-msg-required="This field is required" value="{{$sameweight->local}}" name="sameday_door_local_charges[{{$index_row}}]">
                                                        </fieldset>
                                                    </div>
                                                    <div class="col text-center">
                                                        <fieldset class="form-group">
                                                            <input type="text" class="form-control @if ((isset($e_weight[4][$same_index_row]) && $e_weight[4][$same_index_row]->delivery_type_id == 1) && ($e_weight[4][$same_index_row]->same_zone != $sameweight->same_zone)) changed @elseif(((isset($e_weight[4][$same_index_row]) && $e_weight[4][$same_index_row]->delivery_type_id == 2) || !isset($e_weight[4][$same_index_row])) && $existing == 1) new @endif dec-percent" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="@if ((isset($e_weight[4][$same_index_row]) && $e_weight[4][$same_index_row]->delivery_type_id == 1) && ($e_weight[4][$same_index_row]->same_zone != $sameweight->same_zone)) {{$e_weight[4][$same_index_row]->same_zone}} @endif" data-rule-required="true" data-msg-required="This field is required" value="{{$sameweight->same_zone}}" name="sameday_door_same_zone_charges[{{$index_row}}]">
                                                        </fieldset>
                                                    </div>
                                                    <div class="col-1">
                                                        @if($index_row>1)
                                            ...
                                            @endforeach
                                                ...
                                                <div class="row sameday_door_weight_row" id="sameday_door_weight_row0">
                                                    ...
                                                    <div class="col text-center">
                                                        <fieldset class="form-group">
                                                            <input type="text" class="form-control dec-percent" data-rule-required="true" data-msg-required="This field is required" value="" name="sameday_door_local_charges[1]">
                                                        </fieldset>
                                                    </div>
                                                    <div class="col text-center">
                                                        <fieldset class="form-group">
                                                            <input type="text" class="form-control dec-percent" data-rule-required="true" data-msg-required="This field is required" value="" name="sameday_door_same_zone_charges[1]">
                                                        </fieldset>
                                                    </div>
                                                    <div class="col-1">
                                                    </div>
                                        ...
                                        <div class="hub-weight-addition-sameday">
                                            ...
                                            @foreach($weight[4] as $index => $sameweight)
                                                ...
                                                <div class="row sameday_hub_weight_row" id="sameday_hub_weight_row{{$index_row}}">
                                                    ...
                                                    <div class="col text-center">
                                                        <fieldset class="form-group">
                                                            <input type="text" class="form-control @if ((isset($e_weight[4][$same_index_row]) && $e_weight[4][$same_index_row]->delivery_type_id == 2) && ($e_weight[4][$same_index_row]->local != $sameweight->local)) changed @elseif(((isset($e_weight[4][$same_index_row]) && $e_weight[4][$same_index_row]->delivery_type_id == 1) || !isset($e_weight[4][$same_index_row])) && $existing == 1) new @endif dec-percent" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="@if ((isset($e_weight[4][$same_index_row]) && $e_weight[4][$same_index_row]->delivery_type_id == 2) && ($e_weight[4][$same_index_row]->local != $sameweight->local)) {{$e_weight[4][$same_index_row]->local}} @endif" data-rule-required="true" data-msg-required="This field is required" value="{{$sameweight->local}}" name="sameday_hub_local_charges[{{$index_row}}]">
                                                        </fieldset>
                                                    </div>
                                                    <div class="col text-center">
                                                        <fieldset class="form-group">
                                                            <input type="text" class="form-control @if ((isset($e_weight[4][$same_index_row]) && $e_weight[4][$same_index_row]->delivery_type_id == 2) && ($e_weight[4][$same_index_row]->same_zone != $sameweight->same_zone)) changed @elseif(((isset($e_weight[4][$same_index_row]) && $e_weight[4][$same_index_row]->delivery_type_id == 1) || !isset($e_weight[4][$same_index_row])) && $existing == 1) new @endif dec-percent" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="@if ((isset($e_weight[4][$same_index_row]) && $e_weight[4][$same_index_row]->delivery_type_id == 2) && ($e_weight[4][$same_index_row]->same_zone != $sameweight->same_zone)) {{$e_weight[4][$same_index_row]->same_zone}} @endif" data-rule-required="true" data-msg-required="This field is required" value="{{$sameweight->same_zone}}" name="sameday_hub_same_zone_charges[{{$index_row}}]">
                                                        </fieldset>
                                                    </div>
                                                    <div class="col-1">
                                                        @if($index_row>1)
                                            ...
                                            @endforeach
                                                ...
                                                <div class="row sameday_hub_weight_row" id="sameday_hub_weight_row0">
                                                    ...
                                                    <div class="col text-center">
                                                        <fieldset class="form-group">
                                                            <input type="text" class="form-control dec-percent" data-rule-required="true" data-msg-required="This field is required" value="" name="sameday_hub_same_zone_charges[1]" disabled>
                                                        </fieldset>
                                                    </div>
                                                    <div class="col-1">
                                        ...
                                        <div class="row return-charges-div-sameday">
                                            ...
                                            <div class="col-md-2 text-center">
                                                ...
                                                <fieldset class="form-group">
                                                    <input type="text" data-rule-required="true" data-msg-required="This field is required" class="form-control @if(isset($e_returnCharges[4][0]) && isset($returnCharges[4][0]) && $e_returnCharges[4][0]->same_zone != $returnCharges[4][0]->same_zone) changed @elseif(!isset($e_returnCharges[4][0]) && $existing == 1) new @endif dec-percent" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="@if(isset($e_returnCharges[4][0]) && isset($returnCharges[4][0]) && $e_returnCharges[4][0]->same_zone != $returnCharges[4][0]->same_zone) {{$e_returnCharges[4][0]->same_zone}} @endif" name="sameday_return_same_zone_charges" value="{{ (isset($returnCharges[4][0]) && $returnCharges[4][0]->same_zone !== '')? $returnCharges[4][0]->same_zone : ''}}" {{$same_return_sw}}>
                                                </fieldset>
                                            </div>
                                        </div>
