...
{{--                                    @endif--}}
                            ...
                            <div class="text-center mt-2">
                                <div class="form-group">
                                    ...
                                    @if ($shipper->rate_status ==1 && $shipper->status == 3 && (session('role_id') == 1 && $shipper->new_rate_type_id == null || in_array(140, session('permissions'))))
                                    ...
                                    @endif
                                    @if (($shipper->rate_status ==0 && ($shipper->status == 1 || $shipper->status == 5) && $shipper->new_rate_type_id == null  && (session('role_id') == 1 || in_array(8, session('permissions'))))|| ($shipper->rate_status ==1 && (session('role_id') == 1 || in_array(140, session('permissions')))))
