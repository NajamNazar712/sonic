                                                ...
                                                <div class="row on_door_weight_row" id="on_door_weight_row{{$index_row}}">
                                                    ...
                                                    <div class="col text-center">
                                                        ...
                                                        <div class="form-group " style="padding-top: 8px;">
                                                            <input type="checkbox" id="OvernightDoorSwitch{{$index_row}}" class="switchery weightAdditionDoorOvernight" data-color="success" data-size="sm" name="on_door_wa_switch[{{$index_row}}]" {{ ($onweight->weight_addition == 1) ? 'checked' : '' }}/>
                                                        </div>
                                                    </div>
                                                    <div class="col-2 text-center">
                                                        ...
                                                        <fieldset style="padding-top: 5px;">
                                                            <div class="input-group input-group-sm form-group">
                                                                <input type="text" class="touchspin-color @if ((isset($e_weight[1][$on_index_row]) && $e_weight[1][$on_index_row]->delivery_type_id == 1) && ($e_weight[1][$on_index_row]->spkg != $onweight->spkg)) changed @elseif(((isset($e_weight[1][$on_index_row]->id) && $e_weight[1][$on_index_row]->delivery_type_id == 2) || !isset($e_weight[1][$on_index_row]->id)) && $existing == 1) new @endif input-sm spkg" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="@if ((isset($e_weight[1][$on_index_row]) && $e_weight[1][$on_index_row]->delivery_type_id == 1) && ($e_weight[1][$on_index_row]->spkg != $onweight->spkg)) {{$e_weight[1][$on_index_row]->spkg}} @endif" value="{{$onweight->spkg}}" {{ ($onweight->weight_addition == 1) ? '' : 'disabled' }} data-bts-button-down-class="btn btn-success" data-bts-button-up-class="btn btn-success" name="on_door_wa_spkg[{{$index_row}}]" data-rule-required="true" data-msg-required="This field is required">
                                                            </div>
                                                        </fieldset>
                                                    </div>
                                                    <div class="col text-center">
                                                        ...
                                                        <fieldset style="padding-top: 5px;">
                                                            <div class="input-group input-group-sm form-group">
                                                                <input type="text" class="touchspin-color input-sm spkg" value="0" disabled data-bts-button-down-class="btn btn-success"
                                                                       data-bts-button-up-class="btn btn-success" name="on_door_wa_spkg[0]" data-rule-required="true" data-msg-required="This field is required">
                                                            </div>
                                                        </fieldset>
                                                    </div>
                                                    <div class="col text-center">
                                                        <fieldset class="form-group">
                                                            <input type="text" class="form-control numeric" data-rule-required="true" data-msg-required="This field is required" value="" name="on_door_local_charges[0]">
                                                        </fieldset>
                                                    </div>
                                                    <div class="col text-center">
                                                        <fieldset class="form-group">
                                                            <input type="text" class="form-control numeric" data-rule-required="true" data-msg-required="This field is required" value="" name="on_door_class_0_charges[0]">
                                                        </fieldset>
                                                    </div>
                                                    <div class="col text-center">
                                                        <fieldset class="form-group">
                                                            <input type="text" class="form-control dec-percent" data-rule-required="true" data-msg-required="This field is required" value="" name="on_door_class_1_charges[]">
                                                        </fieldset>
                                                    </div>
                                                    <div class="col text-center">
                                                        <fieldset class="form-group">
                                                            <input type="text" class="form-control dec-percent" data-rule-required="true" data-msg-required="This field is required" value="" name="on_door_class_2_charges[0]">
                                                        </fieldset>
                                                    </div>
                                                    <div class="col text-center">
                                                        <fieldset class="form-group">
                                                            <input type="text" class="form-control dec-percent" data-rule-required="true" data-msg-required="This field is required" value="" name="on_door_class_3_charges[0]">
                                                        </fieldset>
                                                    </div>
                                                    <div class="col-1">
                                                    </div>
                                                    ...
                                                    <fieldset class="form-group">
                                                        ...
                                                        @foreach($min_weight[1] as $index => $mweight)
                                                            @if($mweight->delivery_type_id == 2)
                                                                    ...
                                                                    <input type="text" class="form-control @if ((isset($e_min_weight[1]) && $e_min_weight[1][$index]->delivery_type_id == 2) && ($e_min_weight[1][$index]->min_chargeable_weight != $mweight->min_chargeable_weight)) changed @endif decimal" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="@if ((isset($e_min_weight[1]) && $e_min_weight[1][$index]->delivery_type_id == 2) && ($e_min_weight[1][$index]->min_chargeable_weight != $mweight->min_chargeable_weight)) {{$e_min_weight[1][$index]->min_chargeable_weight}} @endif" data-rule-required="true" data-msg-required="Minimum Chargeable Weight is required" value="{{$mweight->min_chargeable_weight}}" name="on_hub_mcw_charges" placeholder="Minimum Chargeable Weight">
                                                            @endif
                                                        @endforeach
                                                            @else
                                            ...
                                            @foreach($weight[1] as $index => $onweight)
                                                @if($onweight->delivery_type_id == 2)
                                                    ...
                                                    <div class="col text-center">
                                                        ...
                                                        <div class="form-group " style="padding-top: 8px;">
                                                            <input type="checkbox" id="OvernightHubSwitch{{$index_row}}" class="switchery weightAdditionHubOvernight" data-color="success" data-size="sm" name="on_hub_wa_switch[{{$index_row}}]" {{ ($onweight->weight_addition == 1) ? 'checked' : '' }}/>
                                                        </div>
                                                    </div>
                                                    <div class="col-2 text-center">
                                                        ...
                                                        <fieldset style="padding-top: 5px;">
                                                            <div class="input-group input-group-sm form-group">
                                                                <input type="text" class="touchspin-color @if ((isset($e_weight[1][$on_index_row]) && $e_weight[1][$on_index_row]->delivery_type_id == 2) && ($e_weight[1][$on_index_row]->spkg != $onweight->spkg)) changed @elseif(((isset($e_weight[1][$on_index_row]->id) && $e_weight[1][$on_index_row]->delivery_type_id == 1) || !isset($e_weight[1][$on_index_row]->id)) && $existing == 1) new @endif input-sm spkg" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="@if ((isset($e_weight[1][$on_index_row]) && $e_weight[1][$on_index_row]->delivery_type_id == 2) && ($e_weight[1][$on_index_row]->spkg != $onweight->spkg)) {{$e_weight[1][$on_index_row]->spkg}} @endif" value="{{$onweight->spkg}}" {{ ($onweight->weight_addition == 1) ? '' : 'disabled' }} data-bts-button-down-class="btn btn-success" data-bts-button-up-class="btn btn-success" name="on_hub_wa_spkg[{{$index_row}}]" data-rule-required="true" data-msg-required="This field is required">
                                                            </div>
                                                        </fieldset>
                                                    </div>
                                                    <div class="col text-center">
                                                ...
                                                <div class="row on_hub_weight_row" id="on_hub_weight_row0">
                                                    ...
                                                    <div class="col-2 text-center">
                                                        ...
                                                        <fieldset style="padding-top: 5px;">
                                                            <div class="input-group input-group-sm form-group">
                                                                <input type="text" class="touchspin-color input-sm spkg" value="0" disabled data-bts-button-down-class="btn btn-success"
                                                                       data-bts-button-up-class="btn btn-success" name="on_hub_wa_spkg[0]" data-rule-required="true" data-msg-required="This field is required">
                                                            </div>
                                                        </fieldset>
                                                    </div>
                                                    <div class="col text-center">
                                                        <fieldset class="form-group">
                                                            <input type="text" class="form-control numeric" data-rule-required="true" data-msg-required="This field is required" value="" name="on_hub_local_charges[0]">
                                                        </fieldset>
                                                    </div>
                                                    <div class="col text-center">
                                                        <fieldset class="form-group">
                                                            <input type="text" class="form-control numeric" data-rule-required="true" data-msg-required="This field is required" value="" name="on_hub_class_0_charges[0]">
                                                        </fieldset>
                                                    </div>
                                                    <div class="col text-center">
                                                        <fieldset class="form-group">
                                                            <input type="text" class="form-control dec-percent" data-rule-required="true" data-msg-required="This field is required" value="" name="on_hub_class_1_charges[0]">
                                                        </fieldset>
                                                    </div>
                                                    <div class="col text-center">
                                                        <fieldset class="form-group">
                                                            <input type="text" class="form-control dec-percent" data-rule-required="true" data-msg-required="This field is required" value="" name="on_hub_class_2_charges[0]">
                                                        </fieldset>
                                                    </div>
                                                    <div class="col text-center">
                                                        <fieldset class="form-group">
                                                            <input type="text" class="form-control dec-percent" data-rule-required="true" data-msg-required="This field is required" value="" name="on_hub_class_3_charges[0]">
                                                        </fieldset>
                                                    </div>
                                                    <div class="col-1">
                                                    </div>
                                            ...
                                            @foreach($weight[2] as $index => $olweight)
                                                ...
                                                <div class="row ol_door_weight_row" id="ol_door_weight_row{{$index_row}}">
                                                    ...
                                                    <div class="col text-center">
                                                        ...
                                                        <div class="form-group " style="padding-top: 8px;">
                                                            <input type="checkbox" id="OverlandDoorSwitch{{$index_row}}" class="switchery weightAdditionDoorOverland" data-color="success" data-size="sm" name="ol_door_wa_switch[{{$index_row}}]" {{ ($olweight->weight_addition == 1) ? 'checked' : '' }}/>
                                                        </div>
                                                    </div>
                                                    <div class="col-2 text-center">
                                                        ...
                                                        <fieldset style="padding-top: 5px;">
                                                            <div class="input-group input-group-sm form-group">
                                                                <input type="text" class="touchspin-color @if ((isset($e_weight[2][$ol_index_row]) && $e_weight[2][$ol_index_row]->delivery_type_id == 1) && ($e_weight[1][$ol_index_row]->spkg != $olweight->spkg)) changed @elseif(((isset($e_weight[2][$ol_index_row]->id) && $e_weight[2][$ol_index_row]->delivery_type_id == 2) || !isset($e_weight[2][$ol_index_row]->id)) && $existing == 1) new @endif input-sm spkg" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="@if ((isset($e_weight[2][$ol_index_row]) && $e_weight[2][$ol_index_row]->delivery_type_id == 1) && ($e_weight[2][$ol_index_row]->spkg != $olweight->spkg)) {{$e_weight[2][$ol_index_row]->spkg}} @endif" value="{{$olweight->spkg}}" {{ ($olweight->weight_addition == 1) ? '' : 'disabled' }} data-bts-button-down-class="btn btn-success" data-bts-button-up-class="btn btn-success" name="ol_door_wa_spkg[{{$index_row}}]" data-rule-required="true" data-msg-required="This field is required">
                                                            </div>
                                                        </fieldset>
                                                    </div>
                                                    <div class="col text-center">
                                                        <fieldset class="form-group">
                                                            <input type="text" class="form-control @if ((isset($e_weight[2][$ol_index_row]) && $e_weight[2][$ol_index_row]->delivery_type_id == 1) && ($e_weight[2][$ol_index_row]->local_or_6hr != $olweight->local_or_6hr)) changed @elseif(((isset($e_weight[2][$ol_index_row]->id) && $e_weight[2][$ol_index_row]->delivery_type_id == 2) || !isset($e_weight[2][$ol_index_row]->id)) && $existing == 1) new @endif amount" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="@if ((isset($e_weight[2][$ol_index_row]) && $e_weight[2][$ol_index_row]->delivery_type_id == 1) && ($e_weight[2][$ol_index_row]->local_or_6hr != $olweight->local_or_6hr)) {{$e_weight[2][$ol_index_row]->local_or_6hr}} @endif" data-rule-required="true" data-msg-required="This field is required" value="{{$olweight->local_or_6hr}}" name="ol_door_local_charges[{{$index_row}}]">
                                                        </fieldset>
                                                    </div>
                                                    <div class="col text-center">
                                                        <fieldset class="form-group">
                                            ...
                                            @endforeach
                                                ...
                                                <div class="row ol_door_weight_row" id="ol_door_weight_row0">
                                                        ...
                                                        <fieldset style="padding-top: 5px;">
                                                            <div class="input-group input-group-sm form-group">
                                                                <input type="text" class="touchspin-color input-sm spkg" value="" disabled data-bts-button-down-class="btn btn-success"
                                                                       data-bts-button-up-class="btn btn-success" name="ol_door_wa_spkg[0]" data-rule-required="true" data-msg-required="This field is required">
                                                            </div>
                                                        </fieldset>
                                                    </div>
                                                    <div class="col text-center">
                                                    ...
                                                    <div class="col text-center">
                                                        ...
                                                        <fieldset class="form-group">
                                                            <input type="text" class="form-control dec-percent" data-rule-required="true" data-msg-required="This field is required" value="" name="ol_door_class_1_charges[0]">
                                                        </fieldset>
                                                    </div>
                                                    <div class="col text-center">
                                                        <fieldset class="form-group">
                                                            <input type="text" class="form-control dec-percent" data-rule-required="true" data-msg-required="This field is required" value="" name="ol_door_class_2_charges[0]">
                                                        </fieldset>
                                                    </div>
                                                    <div class="col text-center">
                                                        <fieldset class="form-group">
                                                            <input type="text" class="form-control dec-percent" data-rule-required="true" data-msg-required="This field is required" value="" name="ol_door_class_3_charges[0]">
                                                        </fieldset>
                                                    </div>
                                                    <div class="col-1">
                                                    </div>
                                                    ...
                                                    <fieldset class="form-group">
                                                        ...
                                                        @foreach($min_weight[2] as $index => $mweight)
                                                            @if($mweight->delivery_type_id == 2)
                                                                    ...
                                                                    <input type="text" class="form-control @if ((isset($e_min_weight[2]) && $e_min_weight[2][$index]->delivery_type_id == 2) && ($e_min_weight[2][$index]->min_chargeable_weight != $mweight->min_chargeable_weight)) changed @endif decimal" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="@if ((isset($e_min_weight[2]) && $e_min_weight[2][$index]->delivery_type_id == 2) && ($e_min_weight[2][$index]->min_chargeable_weight != $mweight->min_chargeable_weight)) {{$mweight->min_chargeable_weight}} @endif" data-rule-required="true" data-msg-required="Minimum Chargeable Weight is required" value="{{$mweight->min_chargeable_weight}}" name="ol_hub_mcw_charges" placeholder="Minimum Chargeable Weight">
                                                            @endif
                                                        @endforeach
                                                            @else
                                            ...
                                            @foreach($weight[2] as $index => $olweight)
                                                ...
                                                <div class="row ol_hub_weight_row" id="ol_hub_weight_row{{$index_row}}">
                                                    ...
                                                    <div class="col text-center">
                                                        ...
                                                        <div class="form-group " style="padding-top: 8px;">
                                                            <input type="checkbox" id="OverlandHubSwitch{{$index_row}}" class="switchery weightAdditionHubOverland" data-color="success" data-size="sm" name="ol_hub_wa_switch[{{$index_row}}]" {{ ($olweight->weight_addition == 1) ? 'checked' : '' }}/>
                                                        </div>
                                                    </div>
                                                    <div class="col-2 text-center">
                                                        ...
                                                        <fieldset style="padding-top: 5px;">
                                                            <div class="input-group input-group-sm form-group">
                                                                <input type="text" class="touchspin-color @if ((isset($e_weight[2][$ol_index_row]) && $e_weight[2][$ol_index_row]->delivery_type_id == 2) && ($e_weight[1][$ol_index_row]->spkg != $olweight->spkg)) changed @elseif(((isset($e_weight[2][$ol_index_row]->id) && $e_weight[2][$ol_index_row]->delivery_type_id == 1) || !isset($e_weight[2][$ol_index_row]->id)) && $existing == 1) new @endif input-sm spkg" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="@if ((isset($e_weight[2][$ol_index_row]) && $e_weight[2][$ol_index_row]->delivery_type_id == 2) && ($e_weight[2][$ol_index_row]->spkg != $olweight->spkg)) {{$e_weight[2][$ol_index_row]->spkg}} @endif" value="{{$olweight->spkg}}" {{ ($olweight->weight_addition == 1) ? '' : 'disabled' }} data-bts-button-down-class="btn btn-success" data-bts-button-up-class="btn btn-success" name="ol_hub_wa_spkg[{{$index_row}}]" data-rule-required="true" data-msg-required="This field is required">
                                                            </div>
                                                        </fieldset>
                                                    </div>
                                                    <div class="col text-center">
                                                ...
                                                <div class="row ol_hub_weight_row" id="ol_hub_weight_row0">
                                                    ...
                                                    <div class="col-2 text-center">
                                                        ...
                                                        <fieldset style="padding-top: 5px;">
                                                            <div class="input-group input-group-sm form-group">
                                                                <input type="text" class="touchspin-color input-sm spkg" value="" disabled data-bts-button-down-class="btn btn-success"
                                                                       data-bts-button-up-class="btn btn-success" name="ol_hub_wa_spkg[0]" data-rule-required="true" data-msg-required="This field is required">
                                                            </div>
                                                        </fieldset>
                                                    </div>
                                                    <div class="col text-center">
                                                    ...
                                                    <div class="col text-center">
                                                        <fieldset class="form-group">
                                                            <input type="text" class="form-control amount" data-rule-required="true" data-msg-required="This field is required" value="" name="ol_hub_class_0_charges[0]">
                                                        </fieldset>
                                                    </div> <div class="col text-center">
                                                        <fieldset class="form-group">
                                                            <input type="text" class="form-control dec-percent" data-rule-required="true" data-msg-required="This field is required" value="" name="ol_hub_class_1_charges[0]">
                                                        </fieldset>
                                                    </div>
                                                    <div class="col text-center">
                                                        <fieldset class="form-group">
                                                            <input type="text" class="form-control dec-percent" data-rule-required="true" data-msg-required="This field is required" value="" name="ol_hub_class_2_charges[0]">
                                                        </fieldset>
                                                    </div>
                                                    <div class="col text-center">
                                                        <fieldset class="form-group">
                                                            <input type="text" class="form-control dec-percent" data-rule-required="true" data-msg-required="This field is required" value="" name="ol_hub_class_3_charges[0]">
                                                        </fieldset>
                                                    </div>
                                                    <div class="col-1">
                                                    </div>
                                            ...
                                            @if(isset($cashHandling[2]))
                                                @foreach($cashHandling[2] as $index => $cash)
                                                    <div class="row ol_cash_handling_row" id="ol_cash_handle_0">
                                                        ...
                                                        <div class="col-md-2 text-center">
                                                            <fieldset class="form-group">
                                                                <input name="ol_cash_range_up[{{$index}}]" type="text" class="form-control @if(isset($e_cashHandling[2][$index]->id) && $e_cashHandling[2][$index]->range_up != $cash->range_up) changed @elseif(!isset($e_cashHandling[2][$index]->id) && $existing == 1) new @endif numeric" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="@if(isset($e_cashHandling[2][$index]->id) && $e_cashHandling[2][$index]->range_up != $cash->range_up) {{$e_cashHandling[2][$index]->range_up}} @endif" data-rule-required="true" data-msg-required="This field is required" value="{{$cash->range_up}}" {{$ol_cash_sw}}>
                                                            </fieldset>
                                                        </div>
                                                        <div class="col-md-2 text-center">
                                                            <fieldset class="form-group">
                                        ...
                                        <div class="weight-addition-detain">
                                            ...
                                            @foreach($weight[3] as $index => $detweight)
                                                ...
                                                <div class="row detain_door_weight_row" id="detain_door_weight_row{{$index_row}}">
                                                    ...
                                                    <div class="col text-center">
                                                        <fieldset class="form-group">
                                                            <input type="text" class="form-control @if ((isset($e_weight[3][$det_index_row]) && $e_weight[3][$det_index_row]->delivery_type_id == 1) && ($e_weight[3][$det_index_row]->range_up != $detweight->range_up)) changed @elseif(((isset($e_weight[3][$det_index_row]->id) && $e_weight[3][$det_index_row]->delivery_type_id == 2) || !isset($e_weight[3][$det_index_row]->id)) && $existing == 1) new @endif decimal weight_range" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="@if ((isset($e_weight[3][$det_index_row]) && $e_weight[3][$det_index_row]->delivery_type_id == 1) && ($e_weight[3][$det_index_row]->range_up != $detweight->range_up)) {{$e_weight[3][$det_index_row]->range_up}} @endif" data-rule-required="true" data-msg-required="This field is required" value="{{$detweight->range_up}}" name="detain_door_range_up[{{$index_row}}]" {{ (($index_row == 0 || $index_row == 1) ? 'disabled' : '') }}>
                                                        </fieldset>
                                                    </div>
                                                    <div class="col text-center">
                                                        <fieldset class="form-group">
                                                    ...
                                                    <div class="col text-center">
                                                        ...
                                                        <div class="form-group " style="padding-top: 8px;">
                                                            <input type="checkbox" id="DetainDoorSwitch{{$index_row}}" class="switchery weightAdditionDoorDetain" data-color="success" data-size="sm" name="detain_door_wa_switch[{{$index_row}}]" {{ ($detweight->weight_addition == 1) ? 'checked' : '' }}/>
                                                        </div>
                                                    </div>
                                                    <div class="col-2 text-center">
                                                        ...
                                                        <fieldset style="padding-top: 5px;">
                                                            <div class="input-group input-group-sm form-group">
                                                                <input type="text" class="touchspin-color @if ((isset($e_weight[3][$on_index_row]) && $e_weight[3][$on_index_row]->delivery_type_id == 1) && ($e_weight[3][$on_index_row]->spkg != $detweight->spkg)) changed @elseif(((isset($e_weight[3][$on_index_row]->id) && $e_weight[3][$on_index_row]->delivery_type_id == 2) || !isset($e_weight[3][$on_index_row]->id)) && $existing == 1) new @endif input-sm spkg" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="@if ((isset($e_weight[3][$on_index_row]) && $e_weight[3][$on_index_row]->delivery_type_id == 1) && ($e_weight[3][$on_index_row]->spkg != $detweight->spkg)) {{$e_weight[3][$on_index_row]->spkg}} @endif" value="{{$detweight->spkg}}" {{ ($detweight->weight_addition == 1) ? '' : 'disabled' }} data-bts-button-down-class="btn btn-success" data-bts-button-up-class="btn btn-success" name="detain_door_wa_spkg[{{$index_row}}]" data-rule-required="true" data-msg-required="This field is required">
                                                            </div>
                                                        </fieldset>
                                                    </div>
                                                    <div class="col text-center">
                                                    ...
                                                    <div class="col">
                                                        <fieldset class="form-group">
                                                            <input type="text" class="form-control @if ((isset($e_weight[3][$det_index_row]) && $e_weight[3][$det_index_row]->delivery_type_id == 1) && ($e_weight[3][$det_index_row]->national_charges_class_0 != $detweight->national_charges_class_0)) changed @elseif(((isset($e_weight[3][$det_index_row]->id) && $e_weight[3][$det_index_row]->delivery_type_id == 2) || !isset($e_weight[3][$det_index_row]->id)) && $existing == 1) new @endif amount" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="@if ((isset($e_weight[3][$det_index_row]) && $e_weight[3][$det_index_row]->delivery_type_id == 1) && ($e_weight[3][$det_index_row]->national_charges_class_0 != $detweight->national_charges_class_0)) {{$e_weight[3][$det_index_row]->national_charges_class_0}} @endif" data-rule-required="true" data-msg-required="This field is required" value="{{$detweight->national_charges_class_0}}" name="detain_door_class_0_charges[{{$index_row}}]">
                                                        </fieldset>
                                                    </div>
                                                    <div class="col">
                                                        <fieldset class="form-group">
                                                            <input type="text" class="form-control @if ((isset($e_weight[3][$det_index_row]) && $e_weight[3][$det_index_row]->delivery_type_id == 1) && ($e_weight[3][$det_index_row]->national_charges_class_1 != $detweight->national_charges_class_1)) changed @elseif(((isset($e_weight[3][$det_index_row]->id) && $e_weight[3][$det_index_row]->delivery_type_id == 2) || !isset($e_weight[3][$det_index_row]->id)) && $existing == 1) new @endif dec-percent" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="@if ((isset($e_weight[3][$det_index_row]) && $e_weight[3][$det_index_row]->delivery_type_id == 1) && ($e_weight[3][$det_index_row]->national_charges_class_1 != $detweight->national_charges_class_1)) {{$e_weight[3][$det_index_row]->national_charges_class_1}} @endif" data-rule-required="true" data-msg-required="This field is required" value="{{$detweight->national_charges_class_1}}" name="detain_door_class_1_charges[{{$index_row}}]">
                                                        </fieldset>
                                                    </div>
                                                    <div class="col">
                                                        <fieldset class="form-group">
                                                            <input type="text" class="form-control @if ((isset($e_weight[3][$det_index_row]) && $e_weight[3][$det_index_row]->delivery_type_id == 1) && ($e_weight[3][$det_index_row]->national_charges_class_2 != $detweight->national_charges_class_2)) changed @elseif(((isset($e_weight[3][$det_index_row]->id) && $e_weight[3][$det_index_row]->delivery_type_id == 2) || !isset($e_weight[3][$det_index_row]->id)) && $existing == 1) new @endif dec-percent" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="@if ((isset($e_weight[3][$det_index_row]) && $e_weight[3][$det_index_row]->delivery_type_id == 1) && ($e_weight[3][$det_index_row]->national_charges_class_2 != $detweight->national_charges_class_2)) {{$e_weight[3][$det_index_row]->national_charges_class_2}} @endif" data-rule-required="true" data-msg-required="This field is required" value="{{$detweight->national_charges_class_2}}" name="detain_door_class_2_charges[{{$index_row}}]">
                                                        </fieldset>
                                                    </div>
                                                    <div class="col">
                                                        <fieldset class="form-group">
                                                            <input type="text" class="form-control @if ((isset($e_weight[3][$det_index_row]) && $e_weight[3][$det_index_row]->delivery_type_id == 1) && ($e_weight[3][$det_index_row]->national_charges_class_3 != $detweight->national_charges_class_3)) changed @elseif(((isset($e_weight[3][$det_index_row]->id) && $e_weight[3][$det_index_row]->delivery_type_id == 2) || !isset($e_weight[3][$det_index_row]->id)) && $existing == 1) new @endif dec-percent" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="@if ((isset($e_weight[3][$det_index_row]) && $e_weight[3][$det_index_row]->delivery_type_id == 1) && ($e_weight[3][$det_index_row]->national_charges_class_3 != $detweight->national_charges_class_3)) {{$e_weight[3][$det_index_row]->national_charges_class_3}} @endif" data-rule-required="true" data-msg-required="This field is required" value="{{$detweight->national_charges_class_3}}" name="detain_door_class_3_charges[{{$index_row}}]">
                                                        </fieldset>
                                                    </div>
                                                    <div class="col-1">
                                                        @if($index_row>1)
                                            ...
                                            @endforeach
                                                ...
                                                <div class="row detain_door_weight_row" id="detain_door_weight_row0">
                                                    ...
                                                    <div class="col text-center">
                                                        <fieldset class="form-group">
                                                            <input type="text" class="form-control decimal weight_range" data-rule-required="true" data-msg-required="This field is required" value="0.01" name="detain_door_range_up[0]"  disabled>
                                                        </fieldset>
                                                    </div>
                                                    <div class="col text-center">
                                                    ...
                                                    <div class="col-2 text-center">
                                                        ...
                                                        <fieldset style="padding-top: 5px;">
                                                            <div class="input-group input-group-sm form-group">
                                                                <input type="text" class="touchspin-color input-sm spkg" value="0" disabled data-bts-button-down-class="btn btn-success"
                                                                       data-bts-button-up-class="btn btn-success" name="detain_door_wa_spkg[0]" data-rule-required="true" data-msg-required="This field is required">
                                                            </div>
                                                        </fieldset>
                                                    </div>
                                                    <div class="col text-center">
                                                    ...
                                                    <div class="col">
                                                        <fieldset class="form-group">
                                                            <input type="text" class="form-control amount" data-rule-required="true" data-msg-required="This field is required" value="" name="detain_door_class_0_charges[0]">
                                                        </fieldset>
                                                    </div>
                                                    <div class="col">
                                                        <fieldset class="form-group">
                                                            <input type="text" class="form-control dec-percent" data-rule-required="true" data-msg-required="This field is required" value="" name="detain_door_class_1_charges[0]">
                                                        </fieldset>
                                                    </div>
                                                    <div class="col">
                                                        <fieldset class="form-group">
                                                            <input type="text" class="form-control dec-percent" data-rule-required="true" data-msg-required="This field is required" value="" name="detain_door_class_2_charges[0]">
                                                        </fieldset>
                                                    </div>
                                                    <div class="col">
                                                        <fieldset class="form-group">
                                                            <input type="text" class="form-control dec-percent" data-rule-required="true" data-msg-required="This field is required" value="" name="detain_door_class_3_charges[0]">
                                                        </fieldset>
                                                    </div>
                                                    <div class="col-1">
                                                    </div>
                                        ...
                                        <div class="hub-weight-addition-detain">
                                                    ...
                                                    <fieldset class="form-group">
                                                        ...
                                                        @foreach($min_weight[3] as $index => $mweight)
                                                            @if($mweight->delivery_type_id == 2)
                                                                    ...
                                                                    <input type="text" class="form-control @if ((isset($e_min_weight[3]) && $e_min_weight[3][$index]->delivery_type_id == 2) && ($e_min_weight[3][$index]->min_chargeable_weight != $mweight->min_chargeable_weight)) changed @endif decimal" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="@if ((isset($e_min_weight[3]) && $e_min_weight[3][$index]->delivery_type_id == 2) && ($e_min_weight[3][$index]->min_chargeable_weight != $mweight->min_chargeable_weight)) {{$e_min_weight[3][$index]->min_chargeable_weight}} @endif" data-rule-required="true" data-msg-required="Minimum Chargeable Weight is required" value="{{$mweight->min_chargeable_weight}}" name="detain_hub_mcw_charges" placeholder="Minimum Chargeable Weight">
                                                            @endif
                                                        @endforeach
                                                            @else
                                            ...
                                            @foreach($weight[3] as $index => $detweight)
                                                ...
                                                <div class="row detain_hub_weight_row" id="detain_hub_weight_row{{$index_row}}">
                                                    ...
                                                    <div class="col text-center">
                                                        <fieldset class="form-group">
                                                            <input type="text" class="form-control @if ((isset($e_weight[3][$det_index_row]) && $e_weight[3][$det_index_row]->delivery_type_id == 2) && ($e_weight[3][$det_index_row]->range_up != $detweight->range_up)) changed @elseif(((isset($e_weight[3][$det_index_row]->id) && $e_weight[3][$det_index_row]->delivery_type_id == 1) || !isset($e_weight[3][$det_index_row]->id)) && $existing == 1) new @endif decimal weight_range" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="@if ((isset($e_weight[3][$det_index_row]) && $e_weight[3][$det_index_row]->delivery_type_id == 2) && ($e_weight[3][$det_index_row]->range_up != $detweight->range_up)) {{$e_weight[3][$det_index_row]->range_up}} @endif" data-rule-required="true" data-msg-required="This field is required" value="{{$detweight->range_up}}" name="detain_hub_range_up[{{$index_row}}]" {{ (($index_row == 0 || $index_row == 1) ? 'disabled' : '') }}>
                                                        </fieldset>
                                                    </div>
                                                    <div class="col text-center">
                                                    ...
                                                    <div class="col text-center">
                                                        ...
                                                        <div class="form-group " style="padding-top: 8px;">
                                                            <input type="checkbox" id="DetainHubSwitch{{$index_row}}" class="switchery weightAdditionHubDetain" data-color="success" data-size="sm" name="detain_hub_wa_switch[{{$index_row}}]" {{ ($detweight->weight_addition == 1) ? 'checked' : '' }}/>
                                                        </div>
                                                    </div>
                                                    <div class="col-2 text-center">
                                                        ...
                                                        <fieldset style="padding-top: 5px;">
                                                            <div class="input-group input-group-sm form-group">
                                                                <input type="text" class="touchspin-color @if ((isset($e_weight[3][$on_index_row]) && $e_weight[3][$on_index_row]->delivery_type_id == 2) && ($e_weight[3][$on_index_row]->spkg != $detweight->spkg)) changed @elseif(((isset($e_weight[3][$on_index_row]->id) && $e_weight[3][$on_index_row]->delivery_type_id == 1) || !isset($e_weight[3][$on_index_row]->id)) && $existing == 1) new @endif input-sm spkg" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="@if ((isset($e_weight[3][$on_index_row]) && $e_weight[3][$on_index_row]->delivery_type_id == 2) && ($e_weight[3][$on_index_row]->spkg != $detweight->spkg)) {{$e_weight[3][$on_index_row]->spkg}} @endif" value="{{$detweight->spkg}}" {{ ($detweight->weight_addition == 1) ? '' : 'disabled' }} data-bts-button-down-class="btn btn-success" data-bts-button-up-class="btn btn-success" name="detain_hub_wa_spkg[{{$index_row}}]" data-rule-required="true" data-msg-required="This field is required">
                                                            </div>
                                                        </fieldset>
                                                    </div>
                                                    <div class="col text-center">
                                                    ...
                                                    <div class="col">
                                                        <fieldset class="form-group">
                                                            <input type="text" class="form-control @if ((isset($e_weight[3][$det_index_row]) && $e_weight[3][$det_index_row]->delivery_type_id == 2) && ($e_weight[3][$det_index_row]->national_charges_class_0 != $detweight->national_charges_class_0)) changed @elseif(((isset($e_weight[3][$det_index_row]->id) && $e_weight[3][$det_index_row]->delivery_type_id == 1) || !isset($e_weight[3][$det_index_row]->id)) && $existing == 1) new @endif amount" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="@if ((isset($e_weight[3][$det_index_row]) && $e_weight[3][$det_index_row]->delivery_type_id == 2) && ($e_weight[3][$det_index_row]->national_charges_class_0 != $detweight->national_charges_class_0)) {{$e_weight[3][$det_index_row]->national_charges_class_0}} @endif" data-rule-required="true" data-msg-required="This field is required" value="{{$detweight->national_charges_class_0}}" name="detain_hub_class_0_charges[{{$index_row}}]">
                                                        </fieldset>
                                                    </div>
                                                    <div class="col">
                                                        <fieldset class="form-group">
                                                            <input type="text" class="form-control @if ((isset($e_weight[3][$det_index_row]) && $e_weight[3][$det_index_row]->delivery_type_id == 2) && ($e_weight[3][$det_index_row]->national_charges_class_1 != $detweight->national_charges_class_1)) changed @elseif(((isset($e_weight[3][$det_index_row]->id) && $e_weight[3][$det_index_row]->delivery_type_id == 1) || !isset($e_weight[3][$det_index_row]->id)) && $existing == 1) new @endif dec-percent" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="@if ((isset($e_weight[3][$det_index_row]) && $e_weight[3][$det_index_row]->delivery_type_id == 2) && ($e_weight[3][$det_index_row]->national_charges_class_1 != $detweight->national_charges_class_1)) {{$e_weight[3][$det_index_row]->national_charges_class_1}} @endif" data-rule-required="true" data-msg-required="This field is required" value="{{$detweight->national_charges_class_1}}" name="detain_hub_class_1_charges[{{$index_row}}]">
                                                        </fieldset>
                                                    </div>
                                                    <div class="col">
                                                        <fieldset class="form-group">
                                                            <input type="text" class="form-control @if ((isset($e_weight[3][$det_index_row]) && $e_weight[3][$det_index_row]->delivery_type_id == 2) && ($e_weight[3][$det_index_row]->national_charges_class_2 != $detweight->national_charges_class_2)) changed @elseif(((isset($e_weight[3][$det_index_row]->id) && $e_weight[3][$det_index_row]->delivery_type_id == 1) || !isset($e_weight[3][$det_index_row]->id)) && $existing == 1) new @endif dec-percent" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="@if ((isset($e_weight[3][$det_index_row]) && $e_weight[3][$det_index_row]->delivery_type_id == 2) && ($e_weight[3][$det_index_row]->national_charges_class_2 != $detweight->national_charges_class_2)) {{$e_weight[3][$det_index_row]->national_charges_class_2}} @endif" data-rule-required="true" data-msg-required="This field is required" value="{{$detweight->national_charges_class_2}}" name="detain_hub_class_2_charges[{{$index_row}}]">
                                                        </fieldset>
                                                    </div>
                                                    <div class="col">
                                                        <fieldset class="form-group">
                                                            <input type="text" class="form-control @if ((isset($e_weight[3][$det_index_row]) && $e_weight[3][$det_index_row]->delivery_type_id == 2) && ($e_weight[3][$det_index_row]->national_charges_class_3 != $detweight->national_charges_class_3)) changed @elseif(((isset($e_weight[3][$det_index_row]->id) && $e_weight[3][$det_index_row]->delivery_type_id == 1) || !isset($e_weight[3][$det_index_row]->id)) && $existing == 1) new @endif dec-percent" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="@if ((isset($e_weight[3][$det_index_row]) && $e_weight[3][$det_index_row]->delivery_type_id == 2) && ($e_weight[3][$det_index_row]->national_charges_class_3 != $detweight->national_charges_class_3)) {{$e_weight[3][$det_index_row]->national_charges_class_3}} @endif" data-rule-required="true" data-msg-required="This field is required" value="{{$detweight->national_charges_class_3}}" name="detain_hub_class_3_charges[{{$index_row}}]">
                                                        </fieldset>
                                                    </div>
                                                    <div class="col-1">
                                                        @if($index_row>1)
                                            ...
                                            @endforeach
                                                ...
                                                <div class="row detain_hub_weight_row" id="detain_hub_weight_row0">
                                                    ...
                                                    <div class="col text-center">
                                                        <fieldset class="form-group">
                                                            <input type="text" class="form-control decimal weight_range" data-rule-required="true" data-msg-required="This field is required" value="0.01" name="detain_hub_range_up[0]" disabled>
                                                        </fieldset>
                                                    </div>
                                                    <div class="col text-center">
                                                    ...
                                                    <div class="col-2 text-center">
                                                        ...
                                                        <fieldset style="padding-top: 5px;">
                                                            <div class="input-group input-group-sm form-group">
                                                                <input type="text" class="touchspin-color input-sm spkg" value="0" disabled data-bts-button-down-class="btn btn-success"
                                                                       data-bts-button-up-class="btn btn-success" name="detain_hub_wa_spkg[0]" data-rule-required="true" data-msg-required="This field is required">
                                                            </div>
                                                        </fieldset>
                                                    </div>
                                                    <div class="col text-center">
                                                    ...
                                                    <div class="col">
                                                        <fieldset class="form-group">
                                                            <input type="text" class="form-control amount" data-rule-required="true" data-msg-required="This field is required" value="" name="detain_hub_class_0_charges[0]">
                                                        </fieldset>
                                                    </div>
                                                    <div class="col">
                                                        <fieldset class="form-group">
                                                            <input type="text" class="form-control dec-percent" data-rule-required="true" data-msg-required="This field is required" value="" name="detain_hub_class_1_charges[0]">
                                                        </fieldset>
                                                    </div>
                                                    <div class="col">
                                                        <fieldset class="form-group">
                                                            <input type="text" class="form-control dec-percent" data-rule-required="true" data-msg-required="This field is required" value="" name="detain_hub_class_2_charges[0]">
                                                        </fieldset>
                                                    </div>
                                                    <div class="col">
                                                        <fieldset class="form-group">
                                                            <input type="text" class="form-control dec-percent" data-rule-required="true" data-msg-required="This field is required" value="" name="detain_hub_class_3_charges[0]">
                                                        </fieldset>
                                                    </div>
                                                    <div class="col-1">
                                                    </div>
                                            ...
                                            @foreach($weight[4] as $index => $sameweight)
                                                ...
                                                <div class="row sameday_door_weight_row" id="sameday_door_weight_row{{$index_row}}">
                                                    ...
                                                    <div class="col text-center">
                                                        ...
                                                        <div class="form-group " style="padding-top: 8px;">
                                                            <input type="checkbox" id="SamedayDoorSwitch{{$index_row}}" class="switchery weightAdditionDoorSameday" data-color="success" data-size="sm" name="sameday_door_wa_switch[{{$index_row}}]" {{ ($sameweight->weight_addition == 1) ? 'checked' : '' }}/>
                                                        </div>
                                                    </div>
                                                    <div class="col-2 text-center">
                                                        ...
                                                        <fieldset style="padding-top: 5px;">
                                                            <div class="input-group input-group-sm form-group">
                                                                <input type="text" class="touchspin-color @if ((isset($e_weight[4][$on_index_row]) && $e_weight[4][$on_index_row]->delivery_type_id == 1) && ($e_weight[4][$on_index_row]->spkg != $sameweight->spkg)) changed @elseif(((isset($e_weight[4][$on_index_row]->id) && $e_weight[4][$on_index_row]->delivery_type_id == 2) || !isset($e_weight[4][$on_index_row]->id)) && $existing == 1) new @endif input-sm spkg" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="@if ((isset($e_weight[4][$on_index_row]) && $e_weight[4][$on_index_row]->delivery_type_id == 1) && ($e_weight[4][$on_index_row]->spkg != $sameweight->spkg)) {{$e_weight[4][$on_index_row]->spkg}} @endif" value="{{$sameweight->spkg}}" {{ ($sameweight->weight_addition == 1) ? '' : 'disabled' }} data-bts-button-down-class="btn btn-success" data-bts-button-up-class="btn btn-success" name="sameday_door_wa_spkg[{{$index_row}}]" data-rule-required="true" data-msg-required="This field is required">
                                                            </div>
                                                        </fieldset>
                                                    </div>
                                                    <div class="col text-center">
                                                ...
                                                <div class="row sameday_door_weight_row" id="sameday_door_weight_row0">
                                                    ...
                                                    <div class="col-2 text-center">
                                                        ...
                                                        <fieldset style="padding-top: 5px;">
                                                            <div class="input-group input-group-sm form-group">
                                                                <input type="text" class="touchspin-color input-sm spkg" value="0" disabled data-bts-button-down-class="btn btn-success"
                                                                       data-bts-button-up-class="btn btn-success" name="sameday_door_wa_spkg[0]" data-rule-required="true" data-msg-required="This field is required">
                                                            </div>
                                                        </fieldset>
                                                    </div>
                                                    <div class="col text-center">
                                        ...
                                        <div class="hub-weight-addition-sameday">
                                                    ...
                                                    <fieldset class="form-group">
                                                        ...
                                                        @foreach($min_weight[4] as $index => $mweight)
                                                            @if($mweight->delivery_type_id == 2)
                                                                    ...
                                                                    <input type="text" class="form-control @if ((isset($e_min_weight[4]) && $e_min_weight[4][$index]->delivery_type_id == 2) && ($e_min_weight[4][$index]->min_chargeable_weight != $mweight->min_chargeable_weight)) changed @endif decimal" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="@if ((isset($e_min_weight[4]) && $e_min_weight[4][$index]->delivery_type_id == 2) && ($e_min_weight[4][$index]->min_chargeable_weight != $mweight->min_chargeable_weight)) {{$e_min_weight[4][$index]->min_chargeable_weight}} @endif" data-rule-required="true" data-msg-required="Minimum Chargeable Weight is required" value="{{$mweight->min_chargeable_weight}}" name="sameday_hub_mcw_charges" placeholder="Minimum Chargeable Weight">
                                                            @endif
                                                        @endforeach
                                                            @else
                                            ...
                                            @foreach($weight[4] as $index => $sameweight)
                                                ...
                                                <div class="row sameday_hub_weight_row" id="sameday_hub_weight_row{{$index_row}}">
                                                    ...
                                                    <div class="col text-center">
                                                        ...
                                                        <div class="form-group " style="padding-top: 8px;">
                                                            <input type="checkbox" id="SamedayHubSwitch{{$index_row}}" class="switchery weightAdditionHubSameday" data-color="success" data-size="sm" name="sameday_hub_wa_switch[{{$index_row}}]" {{ ($sameweight->weight_addition == 1) ? 'checked' : '' }}/>
                                                        </div>
                                                    </div>
                                                    <div class="col-2 text-center">
                                                        ...
                                                        <fieldset style="padding-top: 5px;">
                                                            <div class="input-group input-group-sm form-group">
                                                                <input type="text" class="touchspin-color @if ((isset($e_weight[4][$on_index_row]) && $e_weight[4][$on_index_row]->delivery_type_id == 2) && ($e_weight[4][$on_index_row]->spkg != $sameweight->spkg)) changed @elseif(((isset($e_weight[4][$on_index_row]->id) && $e_weight[4][$on_index_row]->delivery_type_id == 1) || !isset($e_weight[4][$on_index_row]->id)) && $existing == 1) new @endif input-sm spkg" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="@if ((isset($e_weight[4][$on_index_row]) && $e_weight[4][$on_index_row]->delivery_type_id == 2) && ($e_weight[4][$on_index_row]->spkg != $sameweight->spkg)) {{$e_weight[4][$on_index_row]->spkg}} @endif" value="{{$sameweight->spkg}}" {{ ($sameweight->weight_addition == 1) ? '' : 'disabled' }} data-bts-button-down-class="btn btn-success" data-bts-button-up-class="btn btn-success" name="sameday_hub_wa_spkg[{{$index_row}}]" data-rule-required="true" data-msg-required="This field is required">
                                                            </div>
                                                        </fieldset>
                                                    </div>
                                                    <div class="col text-center">
                                            ...
                                            @endforeach
                                                ...
                                                <div class="row sameday_hub_weight_row" id="sameday_hub_weight_row0">
                                                    ...
                                                    <div class="col text-center">
                                                        <fieldset class="form-group">
                                                            <input type="text" class="form-control decimal weight_range" data-rule-required="true" data-msg-required="This field is required" value="0.01" name="sameday_hub_range_up[0]" disabled>
                                                        </fieldset>
                                                    </div>
                                                    <div class="col text-center">
                                                    ...
                                                    <div class="col-2 text-center">
                                                        ...
                                                        <fieldset style="padding-top: 5px;">
                                                            <div class="input-group input-group-sm form-group">
                                                                <input type="text" class="touchspin-color input-sm spkg" value="0" disabled data-bts-button-down-class="btn btn-success"
                                                                       data-bts-button-up-class="btn btn-success" name="sameday_hub_wa_spkg[0]" data-rule-required="true" data-msg-required="This field is required">
                                                            </div>
                                                        </fieldset>
                                                    </div>
                                                    <div class="col text-center">
                                                    ...
                                                    <div class="col text-center">
                                                        <fieldset class="form-group">
                                                            <input type="text" class="form-control amount" data-rule-required="true" data-msg-required="This field is required" value="" name="sameday_hub_class_0_charges[0]">
                                                        </fieldset>
                                                    </div>
                                                    <div class="col-1">
