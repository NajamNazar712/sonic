...
@section('title', 'Special Dashboard Account')
				...
				<div class="card">
					<div class="card-content" aria-expanded="true">
						<div class="card-body">
							...
							<form id="substitute_account_form" class="form-horizontal" method="POST" action="{{ route("admin.accounts.substitute_account_management.add.store", "$shipper_id") }}" novalidate="novalidate">
								{{ csrf_field() }}
								...
								<div class="row">
									...
									<div class="col-xs-12 col-sm-12 col-md-6 col-lg-4">
										<div class="form-group">
											<input type="email" name="email" class="form-control" placeholder="Email*" data-rule-required="true" data-msg-required="Email is required" data-rule-remote="{{ route("admin.accounts.substitute_account_management.check_email", 0) }}" data-msg-remote="Email must be unique">
										</div>
									</div>
