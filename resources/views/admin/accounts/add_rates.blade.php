...
@section('js')
    ...
    <script type="text/javascript">
        ...
        $('body').on('click','#waddition_btn',function () {
            ...
            var on_range_down = parseInt($('#on_range_down' + new_count).val());
        ...
        $('body').on('click','#overland_weightadd',function () {
            ...
            var row_count = new_count+1;
            var ol_range_down = parseInt($('#ol_range_down' + new_count).val());
        ...
        $('body').on('click','#detain_weightadd',function () {
            ...
            var row_count = new_count+1;
            var detain_range_down = parseInt($('#detain_range_down' + new_count).val());
        ...
        $('body').on('click','#sameday_weightadd',function () {
            ...
            var row_count = new_count+1;
            var sameday_range_down = parseInt($('#sameday_range_down' + new_count).val());
