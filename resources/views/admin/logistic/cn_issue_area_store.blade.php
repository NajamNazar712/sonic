                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="issue_date" class="form-control rounded-right issue_date" id="issue_date_datepicker" value="{{ Carbon\Carbon::today()->format('Y-m-d') }}">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Product</label>
                                    <select class="select select2 mb-1" name="segment_id" id="segment_id_select">
...
@section('js')
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('#segment_id_select').prepend('<option value="" selected="selected">Select Origin</option>').select2({
