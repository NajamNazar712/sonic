                                ...
                                {{ csrf_field() }}
                                    ...
                                    <div class="row">
                                        <div class="col-md-8">
                                            ...
                                            <hr style="background-color: black;">
                                            <div class="row">
                                                <div class="col-md-2"><span class="btn btn-primary mb-3" data-toggle="collapse" data-target="#sp_ins">Special Instruction</span></div>
                                                <div class="col-md-2"><span class="btn btn-primary float-left" data-toggle="collapse" data-target="#item_sp">Item Specification</span></div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" name="ship_ref_no" class="form-control "   >
                                                                </div>
                                                    </div>
                                                </div>
                                            </div>
            ...
            $("#shipper_address_select").empty();
                    ...
                    $.ajax({
                        ...
                        if (data.status == 0) {
                            ...
                            var product = new Option(data.product.name, data.product.id, false, false);
            ...
            $.ajax({
                ...
                if(data.status==0){
                    ...
                    $.each(data.services,function(key,value) {
                                var service = new Option(value.name, value.id, false, false);
