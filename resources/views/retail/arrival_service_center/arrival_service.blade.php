...
@section('title', 'Arrival Service Center')
                ...
                <div class="card">
                    <div class="card-content" aria-expanded="true">
                        <div class="card-body">
                            ...
                            <form id="arrival_of_shipments_form" class="form-horizontal text-center" method="POST" action="{{ route('retail.arrival_service.service.store') }}" novalidate="novalidate">
                                {{ csrf_field() }}
        ...
        $(document).ready(function() {
            ...
            $('#add_shipment_form').validate({
                ...
                submitHandler: function(form) {
                    ...
                    if (table.columns('.tracking_number').data().eq(0).indexOf(parseInt(tracking_number)) === -1) {
                        $.ajax({
                            url: '{!! route('retail.arrival_service.service.shipment_details') !!}',
                            method: 'POST',
                            data: {
            ...
            $('#add_try_and_buy_shipment_form').validate({
                ...
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        url: '{!! route('retail.arrival_service.service.try_and_buy.shipment_details') !!}',
                        method: 'POST',
                        data: {
                            'tracking_number': tracking_number,
                            '_token': '{{ csrf_token() }}'
            ...
            $('#scan_piece').on('change', function () {
                ...
                if(item){
                    ...
                    if (new_item_index === -1) {
                        ...
                        $.ajax({
                            url: '{!! route('retail.arrival_service.service.piece.piece_details') !!}',
                            method: 'POST',
                            data: {
                                'shipment_id': shipment_id,
                                'piece_id': item,
            ...
            $('#add_shipment_pieces_form').validate({
                ...
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        url: '{!! route('retail.arrival_service.service.piece.shipment_details') !!}',
                        method: 'POST',
                        data: {
                            'tracking_number': tracking_number,
                            '_token': '{{ csrf_token() }}'
