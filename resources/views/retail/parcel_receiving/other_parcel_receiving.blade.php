                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-bordered datatable" id="datatable" style="z-index: 3;">
                            ...
                            <tr role="row" class="bg-primary white">
                                ...
                                <th class="border-primary border-darken-1">Staff Name</th>
        ...
        $(document).ready(function () {
            ...
            jQuery.fn.DataTable.Api.register( 'buttons.exportData()', function ( options ) {
                if ( this.context.length ) {
                    ...
                    params.length = -1;
                    var jsonResult = $.ajax({
                        url: '{{ route('retail.parcel_receiving.other_list') }}',
                        data: params,
            ...
            var table = $('#datatable').DataTable({
                ...
                buttons: [
                    {
                        text: 'Generate Parcel Receiving-Performa',
                        className: 'btn btn-primary assign',
                        enabled: true,
                        action: function (e, dt, node, config) {
                                swal({
                                    text: 'Are you sure, you want to generate Performa?',
                                    icon: 'info',
                                    buttons: {
                                        cancel: {
                                            text: 'No',
                                    ...
                                    if (confirm) {
                                        $.ajax({
                                            url: '{!! route('retail.parcel_receiving.other_generate') !!}',
                                            method: 'POST',
                                            data: {
                                                '_token': '{{ csrf_token() }}'
                                            }
                                            ...
                                            .done(function (data) {
                                                if (data.status == 0) {
                                                    ...
                                                    print(data.other_parcel_receiving_id);
                                                } else {
                ...
                columns: [
                    ...
                    {data: 'shipments_button', name: 'other_parcel_receivings.total_cn', class: 'align-middle text-center shipments_button'},
                    {data: 'performa_button', name: 'other_parcel_receivings.id', class: 'align-middle text-center performa_button'},
                    {data: 'category', name: 'other_parcel_receivings.category', class: 'align-middle text-center category'},
                    {data: 'booking_code', name: 'ru.id', class: 'align-middle text-center booking_code'},
                    {data: 'user', name: 'ru.name', class: 'align-middle text-center user'},
                    {data: 'booking_date', name: 'other_parcel_receivings.created_at', class: 'align-middle text-center booking_date'}
                ],
            ...
            $('#datatable tbody').on('click','tr td.shipments_button button',function () {
                ...
                $.ajax({
                    url: '{!! route('retail.parcel_receiving.other_shipments') !!}',
                    method: 'POST',
                    data: {
                        '_token': '{{ csrf_token() }}',
                        'performa_no': id
            ...
            function print(id) {
                $.ajax({
                    url: '{!! route('retail.parcel_receiving.other_print') !!}',
                    method: 'POST',
                    data: {
                        'id': id,
                        '_token': '{{ csrf_token() }}'
