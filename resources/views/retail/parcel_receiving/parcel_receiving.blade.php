        ...
        $(document).ready(function () {
            ...
            jQuery.fn.DataTable.Api.register( 'buttons.exportData()', function ( options ) {
                if ( this.context.length ) {
                    ...
                    params.length = -1;
                    var jsonResult = $.ajax({
                        url: '{{ route('retail.parcel_receiving.list') }}',
                        data: params,
            ...
            var table = $('#datatable').DataTable({
                ...
                buttons: [
                    {
                        ...
                        action: function (e, dt, node, config) {
                                swal({
                                    ...
                                    if (confirm) {
                                        $.ajax({
                                            url: '{!! route('retail.parcel_receiving.generate') !!}',
                                            method: 'POST',
                                            data: {
                                                '_token': '{{ csrf_token() }}'
                                            }
                ...
                columns: [
                    ...
                    {data: 'shipments_button', name: 'retail_parcel_receivings.total_cn', class: 'align-middle text-center shipments_button'},
                    {data: 'performa_button', name: 'retail_parcel_receivings.id', class: 'align-middle text-center performa_button'},
                    {data: 'category', name: 'retail_parcel_receivings.category', class: 'align-middle text-center category'},
                    {data: 'booking_code', name: 'ru.id', class: 'align-middle text-center booking_code'},
                    {data: 'total_cash', name: 'retail_parcel_receivings.total_cash', class: 'align-middle text-center total_cash'},
                    {data: 'user', name: 'ru.name', class: 'align-middle text-center user'},
                    {data: 'booking_date', name: 'retail_parcel_receivings.created_at', class: 'align-middle text-center booking_date'}
                ],
            ...
            function print(id) {
                $.ajax({
                    url: '{!! route('retail.parcel_receiving.print') !!}',
                    method: 'POST',
                    data: {
                        'id': id,
                        '_token': '{{ csrf_token() }}'
