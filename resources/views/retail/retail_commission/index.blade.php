...
@section('title', 'Commission View')

@section('content')
    <h1 class="mb-1">Commission View</h1>
...

                                        {
                                            ...
                                            action: function () {
                                                ...
                                                if (franchiseCodes.length > 0) {
                                                    $.ajax({
                                                        url: '{{ route('retail.retail_commission.franchise_commission_invoice_print') }}',
                                                        method: 'POST',
                                                        data: {
                                                            franchise: franchiseCodes,
                                                            _token: '{{ csrf_token() }}'
                                                        }
...

                                        {
                                            ...
                                            action: function () {
                                                ...
                                                if (franchiseNames.length > 0) {
                                                    $.ajax({
                                                        url: '{{ route('retail.retail_commission.user_commission_invoice_print') }}',
                                                        method: 'POST',
                                                        data: {
