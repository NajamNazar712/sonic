    ...
    public function handle()
    {
        ...
        if (!$today->isSunday()) {
            ...
            // if(!empty($excludedUserIds)){
                ...
                ->whereNotIn('user_id', [46611, 47392, 47394, 47813, 33952, 27424, 44309, 44149, 3719, 2634, 18179, 49456, 043576, 22071, 2121, 39282, 49028, 12240, 1458, 7626, 23009,27519,25229, 4429, 4251,35393,44233, 25231, 10661, 51274, 14299]) // Remove Test Shipper
                ->pluck('user_id')
                ->toArray();
