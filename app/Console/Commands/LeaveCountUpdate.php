...
use App\Http\Models\HR\EmployeeLeaveLog;
use Carbon\Carbon;
use Illuminate\Console\Command;
use Illuminate\Support\Facades\DB;

class LeaveCountUpdate extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'employee:leave_count';
     ...
     * @var string
     */
    protected $description = 'Update leave count for employee every month';
