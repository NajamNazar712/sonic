...
class DailyPickupSalesKAEIndividualEmail extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'email:dailypickupsalesreportindividualforkae';
     ...
     * @var string
     */
    protected $description = 'Send Daily Pickup & Sales Report Email to KAEs';
