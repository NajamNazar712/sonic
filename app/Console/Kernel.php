...
//        $schedule->command('email:revenuereport')->monthlyOn(1, '00:00')->runInBackground();
        ...
        $schedule->command('email:revenuereportcutoffdays')->monthlyOn(21, '01:15')->runInBackground();
        ...
        $schedule->command('email:revenuereportbydeliverycutoffdays')->monthlyOn(21, '01:40')->runInBackground();
        ...
        $schedule->command('email:retailsalesreportcutoffdays')->monthlyOn(21, '01:20')->runInBackground();
        ...
        $schedule->command('email:retailsalesreportbydeliverycutoffdays')->monthlyOn(21, '01:55')->runInBackground();
