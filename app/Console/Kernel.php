...
//        $schedule->command('email:revenuereport')->monthlyOn(1, '00:00')->runInBackground();
        ...
        $schedule->command('email:revenuereportcutoffdays')->monthlyOn(11, '00:00')->runInBackground();
        $schedule->command('email:revenuereportremainingdays')->monthlyOn(21, '00:00')->runInBackground();
        ...
        $schedule->command('email:revenuereportbydeliverycutoffdays')->monthlyOn(11, '00:00')->runInBackground();
        $schedule->command('email:revenuereportbydeliveryremainingdays')->monthlyOn(21, '00:00')->runInBackground();
