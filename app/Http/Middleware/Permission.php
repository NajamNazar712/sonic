...
class Permission
{
    private $actions = [
        ...
        'management.city.index' => 89,
        'management.city.ajax' => 89,
        'management.city.form' => 90,
        'management.city.edit' => 91,
        'management.city' => 90,
        'management.city.status' => 92,
        'management.city.status.ajax' => 92,

        'management.route.index' => 93,
        'management.route.ajax' => 93,
        'management.route.add' => 94,
        'management.route.edit' => 95,
        'management.route.status' => 96,

        'management.rider.index' => 97,
        'management.rider.ajax' => 97,
        'management.rider.add' => 98,
        'management.rider.edit' => 99,
        'management.rider.status' => 100,

        'notifications.index' => 101,
        'notifications.list' => 101,
        'notifications.send_custom_email' => 104,
        'notifications.details' => 102,
        'notifications.status' => 103,
        'notifications.edit' => 102,

        'settings.pickup.index' => 105,
        'settings.pickup.weight.add' => 105
    ];
    ...
    public function handle($request, Closure $next) {
        ...
        if (session('role_id') == 1 || !isset($this->actions[$action]) || in_array($this->actions[$action], session('permissions'))) {
            return $next($request);
        }
        else {
