...
class Permission
{
    private $actions = [
        'admin' => [
            ...
            'delivery.receive.status.verify' => 38,
            'delivery.receive.verify.status.list' => 38,
            'delivery.receive.verify.status.submit' => 38,
            'delivery.receive.dncc.print' => 36,
            ...
            'packaging.send.submit' => 77,
            'packaging.requests.index' => 78,
            'packaging.requests.list' => 78,
            'packaging.requests.dispatch' => 79,
        ...
        'shipper' => [
            ...
            'shipment.receiving_sheet_history.list' => 3,
