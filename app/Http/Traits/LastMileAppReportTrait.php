         ...
         if($rider->exists()){
             ...
             $delivery_note_data = DeliveryNote::join('cities as c', 'c.id', 'delivery_notes.hub_id')
                 ...
                 if($check_summary->exists())
                 {
                     ...
                     $check_existing_shipment = RiderWiseDeliveryNoteShipment::where('shipment_ids',$shipment_id)->where('rwdn_id',$check_existing_note->latest()->first()->id);
                     $this->createDeliveryNoteErrorLog($delivery_note_id,$shipment_id,'first-'.$check_existing_note->latest()->first()->id);
