...
trait RvTrait
{
    ...
    {
        $statusReasonId = ShipmentsJourney::where('shipment_id',$shipment)->where('status_reason_id',12)->first()->status_reason_id;
        ...
        if($shipments_journey){
            ...
            if($shipment_exist)
            {
                ...
                //agent is udating the status
                    ...
                    $existing_completed_shipment->updated_type_id = 1; 
