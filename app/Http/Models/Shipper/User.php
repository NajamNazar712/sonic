...
//            ->where('hub',1);
    ...
    public function shipping(){
        return $this->hasMany('App\Http\Models\Shipper\UserShippingInfo', 'user_id','id');
    }
