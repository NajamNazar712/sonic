...
class User extends Authenticatable
{
     ...
     */
    protected $fillable = [
        'name', 'email', 'password','address','poc','phone','phone2','cnic','ntn_no','url','city_id','status','blacklist', 'api_token','rates_added_by','rates_authorized_by','account_activated_by','activated_at'
    ];
