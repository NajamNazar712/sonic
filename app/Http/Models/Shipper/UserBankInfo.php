...
{
    protected $fillable = ['user_id','bank_name','bank_branch','account_no','account_title','iban','city_id','payment_cycle','invoicing_cycle_id','generation_date','billing_person_name','billing_person_phone', 'billing_person_email','billing_address','default_bank'];
