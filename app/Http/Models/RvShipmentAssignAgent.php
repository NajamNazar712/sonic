...
class RvShipmentAssignAgent extends Model
{
   ...
   public function assign_agent_status()
   {
      return $this->belongsTo('App\Http\Models\RvAssignAgentStatus');
   }

   public function assign_agent_sub_status()
   {
      return $this->HasMany('App\RvAssignAgentSubStatus');
   }
}
