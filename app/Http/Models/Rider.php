...
{
    protected $fillable = [
        'city_id', 'name', 'phone', 'cnic', 'address', 'route_id', 'rider_category_id', 'status', 'pin', 'special_rider_checkbox', 'created_by', 'updated_by', 'trax_id', 'rider_type_id', 'operation_rider_id', 'employee_id', 'ccd'
    ];
