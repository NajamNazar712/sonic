        ...
        if (count($regular_pickups) > 0){
            foreach ($regular_pickups as $regular_pickup) {
                ...
                if(in_array($day, $pickup_days)){
                    ...
                    if($pickup_request){
                        $pickup_request_id = AddV3PickupController::add($pickup_request->shipper_id, $pickup_request->pickup_type, $pickup_request->pickup_address_id, $today, $pickup_request->city_id, $pickup_request->time_range_id, $pickup_request->pickup_shipment_type_id, $pickup_request->weight, $pickup_request->booked, $pickup_request->pieces, $pickup_request->special_request, 1, 346, NULL, NULL, NULL, $pickup_request->segment_id, $pickup_request->sub_segment_id);
