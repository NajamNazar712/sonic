    ...
    public function rider_signup_store(Request $request)
    {
        if ($request->isMethod('post')) {
            $rules = [
                ...
                'cnic' => ['required','mimes:png,jpeg,jpg'],
                ...
                'cnic_nominee' => ['required','mimes:png,jpeg,jpg'],
                'utility_bill' => ['required','mimes:png,jpeg,jpg'],
                'affidavit' => ['required','mimes:png,jpeg,jpg'],
                'cheque' => ['required','mimes:png,jpeg,jpg'],
