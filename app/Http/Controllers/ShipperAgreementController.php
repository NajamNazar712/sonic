            ...
            if($international_rates){
                ...
                if($international_rate_status){
                  ...
                  $margin = array('margin_1' => 0,'margin_2' => 0,'margin_3' => 0,'margin_4' => 0,'margin_5' => 0,'margin_6' => 0,'margin_7' => 0,'margin_8' => 0,'margin_9' => 0,'margin_10' => 0,'margin_11' => 0,'margin_12' => 0,'margin_13' => 0,);
                    ...
                    $margin['margin_12'] = (float)$international_rate_status->margin_12;
                    $margin['margin_13'] = (float)$international_rate_status->margin_13;
                    ...
                    if(count($intl_weight_charges) > 0){
                        ...
                        $intl_weight_charges_details .= '<table class="table table-sm table-bordered mb-0"><thead><tr><th>Range Up</th><th>Range Down</th><th>Zone 1</th><th>Zone 2</th><th>Zone 3</th><th>Zone 4</th><th>Zone 5</th><th>Zone 6</th><th>Zone 7</th><th>Zone 8</th><th>Zone 9</th><th>Zone 10</th><th>Zone 11</th><th>Zone 12</th><th>Zone 13</th></tr></thead><tbody>';
                        ...
                        foreach ($intl_weight_charges as $weight_charge) {
                            ...
                            $zone_12_charges = self::international_charges_calculate($weight_charge->zone_12, $fuel_surcharge_flat, $exchange_rate_charges,  $margin['margin_12'], $gst_flat);
                            $zone_13_charges = self::international_charges_calculate($weight_charge->zone_13, $fuel_surcharge_flat, $exchange_rate_charges,  $margin['margin_13'], $gst_flat);

                            $intl_weight_charges_details .= '<tr><td>' . $weight_charge->range_up . '</td><td>' . $weight_charge->range_down . '</td><td>' . $zone_1_charges . '</td><td>' . $zone_2_charges . '</td><td>' . $zone_3_charges . '</td><td>' . $zone_4_charges . '</td><td>' . $zone_5_charges . '</td><td>' . $zone_6_charges . '</td><td>' . $zone_7_charges . '</td><td>' . $zone_8_charges . '</td><td>' . $zone_9_charges . '</td><td>' . $zone_10_charges . '</td><td>' . $zone_11_charges . '</td><td>' . $zone_12_charges . '</td><td>' . $zone_13_charges . '</td></tr>';
                        }
