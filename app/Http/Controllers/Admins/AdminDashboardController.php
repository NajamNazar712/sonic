...
//    }
    ...
    public function viewRates($id,$date = null){
            ...
            if($date == null){
                ...
                $rate_destination_hubs = HistoryRateDestinationHub::pluck('hub_id')->where('user_id',$id)->where('created_at', '>=', $date)->where('created_at', '<', $tomorrow)->groupBy('shipping_mode_id')->toArray();
