...
//                    $discount_weight = $request->sameday_discount_weight_rate;
    ...
    {        
        ...
        return Datatables::of($users)
            ...
            ->editColumn('sms_charges_type_id', function ($users) {
