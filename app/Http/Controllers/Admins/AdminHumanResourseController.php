...
//                    if ($employee->employee_type_id == 2) {
    ...
    public function employee_directory_edit(Employee $employee)
    {
        ...
        //dd($employee);
        // $employee_designation = EmployeeType::where('id', $employee->employee_type_id)->pluck('name')->toArray();
        // $employee_designation = $employee_designation[0];

        // $employee_designation = Str::contains($employee_designation, ['Staff', 'Rider']);
...
//            $admins = Admin::where('designation_id',$designation->id)->get();
    ...
    public function employee_penalty_list(Request $request)
    {
        ...
        ->where('el.status',6)->groupBy(['employee_penalties.employee_id']);
