...
//            }
    ...
    public function leave_list(Request $request)
    {
        ...
        $employee_leaves = EmployeeLeave::leftjoin('employees as a', 'a.id', 'employee_leaves.employee_id')
