...
class AdminPowerBIController extends Controller
{
    ...
    public function sales_dashboard_index(){
        ...
        if (session('role_id') == 1 || in_array(session('user_id'), [12,70,57,69,32,8,2,36])) {
    ...
    public function operation_dashboard_index(){
        ...
        else if (in_array(session('user_id'), [239,20])) {
        ...
        else if (in_array(session('user_id'), [277,276,263])) {
        ...
        else if (in_array(session('user_id'), [214,347])) {
        ...
        else if (in_array(session('user_id'), [33,126])) {
