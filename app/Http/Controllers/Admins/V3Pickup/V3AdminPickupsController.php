        ...
        ->setRowAttr([
            ...
            ->addColumn('shipments_picked', function ($pickup_request) {
                if ($pickup_request->shipment_picked > 0  ) {
                    return '<button class="btn btn-sm btn-outline-info align-middle">' . $pickup_request->shipment_picked . '</button>';
                } else {
                    return 0;
                }
            })
