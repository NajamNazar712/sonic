...
class AdminCnController extends Controller
{
    ...
    public function add_cn_area_store(Request $request)
    {
        ...
        try {
            ...
            $cn_issue_area_store->segment_id = $request->segment_id;
    ...
    public  function cn_receive_admin_store_store(Request  $request)
    {
        ...
        try {
            ...
            $cn_receive_admin_store->segment_id = $request->segment_id;
    ...
    {
        $trax_cn_issue_rider = TraxCnIssueToRider::Join('segments as s','trax_cn_issue_to_riders.segment_id','=','s.id')
            ->join('riders as rd','rd.id','=','trax_cn_issue_to_riders.rider_id')
            ->SELECT('trax_cn_issue_to_riders.issue_date','trax_cn_issue_to_riders.company_code','rd.name as rider_name','rd.trax_id as rider_trax_id','trax_cn_issue_to_riders.segment_id','s.name as segment_name','trax_cn_issue_to_riders.cn_from','trax_cn_issue_to_riders.cn_to','trax_cn_issue_to_riders.quantity')
    ...
    public function cn_issue_to_rider_store(Request $request)
    {
        ...
        try {
            ...
            $trax_cn_issue_rider->segment_id = $request->segment_id;
