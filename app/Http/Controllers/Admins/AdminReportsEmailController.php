...
class AdminReportsEmailController extends Controller
{
    ...
    static public function hub_wise_split($date){
        ...
        foreach ($hub_wise_splits as $hub_wise_split) {
            ...
            $hub_wise_split_array[] = ['serial' => $serial, 'Hub' => $hub_wise_split->hub, 'Count of Parcels' => $hub_wise_split->shipment_count, 'Ratio' => $ratio[$hub_wise_split->hub_id] * 100, 'Actual Weight' => round($actual_weight, 2), 'Avg Actual Weight/Shipment' => round($avg_actual_weight[$hub_wise_split->hub_id], 2)];
