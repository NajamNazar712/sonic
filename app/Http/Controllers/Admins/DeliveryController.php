...
class DeliveryController extends Controller
{
    ...
    public function pending_list(Request $request)
    {
        ...
        $status = array(2, 4, 6, 10, 13, 49, 55, 59); //for pending deliveries
