                ...
                if ($shipment_details) {
                    ...
                    if ($selected_status == 7 || $selected_status == 18) {
                        if ($shipment_details->shipper_status_id != $selected_status) {
                            ShipmentsJourneyController::add($shipment, $selected_status, NULL, $selected_reason, $request->remarks[$journey_remarks], NULL, Auth::id(), $delivery_note_id, NULL, 0);
                        }
                        ...
                        if ($shipment_details->booking_type_id == 2) {
                            if ($shipment_details->shipper_status_id != $selected_status) {
                                ShipmentsJourneyController::add($shipment, $selected_status, $selected_status, $selected_reason, $request->remarks[$journey_remarks], NULL, Auth::id(), $delivery_note_id, NULL, 0);
                            }
