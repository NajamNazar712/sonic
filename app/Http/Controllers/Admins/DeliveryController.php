    ...
    public function receive_delivery_verify_status_list(Request $request, $id)
    {
        ...
        return Datatables::of($deliveries)
            ...
            ->addColumn('status', function ($deliveries) {
                ...
                $rc_flag = false;
                if(($deliveries->status_reason_id) == 8 && ($deliveries->otp_entered == 1)){
