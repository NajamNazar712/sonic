                ...
                if($shipment_details){
                    ...
                    else if($selected_status == 14)
                    {
                        if ($shipment_details->booking_type_id == 2) {
                            ShipmentsJourneyController::add($shipment, 30, 30, NULL, NULL, NULL, Auth::id(), $delivery_note_id, NULL, 0);
                            ...
                            if ($shipment_details->package_type == 0) {
                                ShipmentsJourneyController::add($shipment, 37, 37, NULL, NULL, NULL, Auth::id(), $delivery_note_id, NULL, 0);
                                ...
                                ShipmentsJourneyController::add($shipment, 36, 36, NULL, NULL, NULL, Auth::id(), $delivery_note_id, NULL, 0);
                                ...
                                if ($shipper_status_details->shipper_status_id != $request->status_drop[$shipment]) {
                                    if ($request->status_drop[$shipment] == 7 || $request->status_drop[$shipment] == 18) {
                                        ...
                                        if ($parcel->booking_type_id == 2) {
                                            ...
                                            if ($parcel->charges_mode_id == 1) {
                                                Shipment::where('id', $shipment)->update(['received_amount' => 0, 0, PHP_ROUND_HALF_DOWN), 'shipper_status_id' => $request->status_drop[$shipment], 'consignee_status_id' => $request->status_drop[$shipment]]);
                                            }
                                            else {
                                                Shipment::where('id', $shipment)->update(['received_amount' => $parcel->amount, 0, PHP_ROUND_HALF_DOWN), 'shipper_status_id' => $request->status_drop[$shipment], 'consignee_status_id' => $request->status_drop[$shipment]]);
                                            }
