                            ...
                            try{
                                $response = $client->post('DailyExp', [
                                    'form_params' => [
                                        ...
                                        'pin_creation_date' => $petty_cash_statement->created_at->format('m/d/Y'),
                                        'pin_period_from_date' => $petty_cash_statement->from->format('m/d/Y'),
                                        'pin_period_to_date' => $petty_cash_statement->to->format('m/d/Y'),
