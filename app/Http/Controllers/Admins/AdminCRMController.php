...
//            }
    ...
    public function special_request_appvove(Request $request){
     ...
     if($admin_ids){
         ...
         return redirect()->route('admin.crm.in_process.index')->with(['success'=> "Request Submitted"]);
     }
     else{
