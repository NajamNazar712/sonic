            ...
            if(!$existing_pickup_request_attempt->exists()){
                ...
                if ($previous_rider_id != null) {
                    ...
                    if ($rider_device_token->exists()) {
                        ...
                        $message = "Dear Rider Pickup of : " . $pickup_request->shipper->name . " has been reassigned to";
                ...
                if ($rider_id != null) {
                    ...
                    if ($rider_device_token->exists()) {
                        ...
                        $message = "Dear Rider Pickup Request : " . $pickup_request->shipper->name . " Assigned To You";
