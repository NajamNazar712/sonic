...
//            ->leftJoin('v2_rider_pickups as vpr', 'vpr.pickup_request_id', '=', 'v2_pickup_requests.id')
            ...
            ->whereNotNull('v2_pickup_requests.current_rider_id')
