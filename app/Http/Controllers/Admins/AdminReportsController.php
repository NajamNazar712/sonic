...
//            $hubid = $c->id;
    ...
    public function completed_delivery_notes_list(Request $request){
        ...
        join('cities AS oc', 'delivery_notes.hub_id', '=', 'oc.id')
            ...
            ->select(['delivery_notes.id as delivery_note','delivery_notes.id as delivery_note_id','delivery_notes.id as delivery_note_link','oc.id as hub_id','oc.name as hub','riders.name as rider','routes.code as route','routes.start','routes.end','admins.name as assignee','ub.name as updated_by','delivery_notes.updated_at as updated_at','delivery_notes.delivered_shipments','delivery_notes.delivered_shipments as delivered_shipments_link','delivery_notes.created_at as created_at','delivery_notes.total_cod_amount as amount','delivery_notes.shipments_count','delivery_notes.shipments_count as shipments_count_link','delivery_notes.last_updated as verified_time','vb.name as verified_by'])
