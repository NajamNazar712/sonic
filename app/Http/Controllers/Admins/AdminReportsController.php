...
use Yajra\Datatables\Datatables;
    ...
    //        }
            ...
            $datatable = Datatables::of($sales)
                ...
                ->editColumn('sic', function($shipment){
                    return number_format($shipment->sic, 2);
                })
