            ...
            foreach ($zones as $key => $zone) {
                ...
                foreach ($route_distribution_summary as $rds_key => $rds_value) {
                    if($rds_value->zone_id == $zone->id)
                    {
                        ...
                        $cash_collection = [
                            'cod_submitted_via_cash' => [],
                            'cod_submitted_by_rider' => [],
                        ];
                        ...
                        foreach ($dn_ids as $dn_id) {
                            ...
                            if ($dn) {
                                ...
                                } elseif ($dn->cash_collection_status == 0) {
                        ...
                        $data['cod_submitted_via_cash'] = $cash_collection['cod_submitted_by_rider'][0] - ($hbl_connect_amount + $fintech_amount);
                        $data['cod_submitted_by_rider'] = $cash_collection['cod_submitted_via_cash'][0]  ?? 0;
