...
//        }
    ...
    public function last_mile_status_data($from, $to, $destination, $hub, $zone, $rider){
        ...
        foreach ($time_slots as $id => $slot){
            ...
            $total_status_updated_count = $total_status_updated->latest('created_at')->count('shipment_id');
            ...
            $out_for_delivery_count = $out_for_delivery->latest('created_at')->count('shipment_id');
            ...
            $bolt_status_updated_count = $bolt_status_updated->latest('created_at')->count('shipment_id');
            ...
            $sonic_status_updated_count = $sonic_status_updated->latest('created_at')->count('shipment_id');
            ...
            $bolt_status_undelivered_count = $bolt_status_undelivered->latest('created_at')->count('shipment_id');
            ...
            $bolt_status_delivered_count = $bolt_status_delivered->latest('created_at')->count('shipment_id');
            ...
            $sonic_status_undelivered_count = $sonic_status_undelivered->latest('created_at')->count('shipment_id');
            ...
            $sonic_status_delivered_count = $sonic_status_delivered->latest('created_at')->count('shipment_id');
