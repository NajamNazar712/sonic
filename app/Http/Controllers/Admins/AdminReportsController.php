...
//        }
    ...
    public function last_mile_status_data($from, $to, $destination, $hub, $zone, $rider){
        ...
        foreach ($time_slots as $id => $slot){
            ...
            $total_status_updated_count = $total_status_updated->distinct('shipment_id')->get()->count();
            ...
            $out_for_delivery_count = $out_for_delivery->distinct('shipment_id')->get()->count();
            ...
            $bolt_status_updated_count = $bolt_status_updated->distinct('shipment_id')->get()->count();
            ...
            $sonic_status_updated_count = $sonic_status_updated->distinct('shipment_id')->get()->count();
            ...
            $bolt_status_undelivered_count = $bolt_status_undelivered->distinct('shipment_id')->get()->count();
            ...
            $bolt_status_delivered_count = $bolt_status_delivered->distinct('shipment_id')->get()->count();
            ...
            $sonic_status_undelivered_count = $sonic_status_undelivered->distinct('shipment_id')->get()->count();
            ...
            $sonic_status_delivered_count = $sonic_status_delivered->distinct('shipment_id')->get()->count();
