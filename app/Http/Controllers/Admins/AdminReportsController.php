...
//        }
    ...
    public function last_mile_status_data($from, $to, $destination, $hub, $zone, $rider){
        ...
        foreach ($time_slots as $id => $slot){
            ...
            $total_status_updated_count = $total_status_updated->select(DB::raw('DISTINCT shipment_id'))->count();
            ...
            $out_for_delivery_count = $out_for_delivery->select(DB::raw('DISTINCT shipment_id'))->count();
            ...
            $bolt_status_updated_count = $bolt_status_updated->select(DB::raw('DISTINCT shipment_id'))->count();
            ...
            $sonic_status_updated = ShipmentsJourney::whereNotNull('reference_1_id')->whereIn('shipper_status_id', $delivery_note_status)->whereNull('rider_id');
            ...
            $sonic_status_updated_count = $sonic_status_updated->select(DB::raw('DISTINCT shipment_id'))->count();
            ...
            $bolt_status_undelivered_count = $bolt_status_undelivered->select(DB::raw('DISTINCT shipment_id'))->count();


            $bolt_status_delivered = ShipmentsJourney::whereNotNull('reference_1_id')->whereIn('shipper_status_id', $delivered_status)->whereNotNull('rider_id');
            ...
            $bolt_status_delivered_count = $bolt_status_delivered->select(DB::raw('DISTINCT shipment_id'))->count();
            ...
            $sonic_status_undelivered_count = $sonic_status_undelivered->select(DB::raw('DISTINCT shipment_id'))->count();
            ...
            $sonic_status_delivered_count = $sonic_status_delivered->select(DB::raw('DISTINCT shipment_id'))->count();
