...
class ReturnController extends Controller
{
    ...
    public function return_marked_list(Request $request){ //status 12 shipments
        $shipments = Shipment::join('users as u', 'shipments.user_id', '=', 'u.id')
            ...
            ->leftJoin('shipments_journey as shipper_journey', function ($join) {
                $join->on('shipper_journey.shipment_id', '=', 'shipments.id')
                    ->where('shipper_journey.created_at','=',
