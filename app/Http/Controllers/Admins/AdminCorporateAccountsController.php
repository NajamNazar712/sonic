...
class AdminCorporateAccountsController extends Controller
{
    ...
    public function add_rates_index($id)
    {
        ...
        if (!CorporateRateStatus::where('user_id', $user->id)->exists()) {
            ...
            return view('admin.accounts.corporate.add_rates')->with(['shipper' => $user, 'weight' => $weight, 'shippingType' => $bookingType, 'cashHandling' => $cash, 'insuranceCharges' => $insurance, 'returnCharges' => $return, 'fuelCharges' => $fuel, 'packagingCharges' => $packaging, 'min_weight' => $min_weight]);
        }
    ...
    public function add_rates_submit(Request $request, $id){
        ...
        $messages = [
            ...
            'on_local_charges.*.required' => 'The overnight local charges field is required.',
            'on_local_charges.*.numeric' => 'The overnight local charges field must be numeric.',
...
//            'on_discount_packaging_rate.numeric' => 'The overnight discount packaging field must be numeric',
            ...
            'ol_local_charges.*.required' => 'The overland local charges field is required.',
            'ol_local_charges.*.numeric' => 'The overland local charges field must be numeric.',
...
//            'ol_discount_packaging_rate.numeric' => 'The overland discount packaging field must be numeric',
            ...
            'detain_local_charges.*.required' => 'The detain local charges field is required.',
            'detain_local_charges.*.numeric' => 'The detain local charges field must be numeric.',
...
//            'detain_discount_packaging_rate.numeric' => 'The detain discount packaging field must be numeric',
            ...
            'sameday_local_charges.*.required' => 'The sameday local charges field is required.',
            'sameday_local_charges.*.numeric' => 'The sameday local charges field must be numeric.',
