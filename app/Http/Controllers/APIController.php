...
//        }
        ...
        // sahban bhai said service type 3,5 then disabled this below condition
            if (Carbon::parse($user_type->activated_at)->lt(Carbon::now()->subDays(1)) && !PendingPayment::check_negative_payable($user_id,$user_type['account_type_id'],$request->input('amount')) && !in_array($request->input('service_type_id',1), [3,5])) {
