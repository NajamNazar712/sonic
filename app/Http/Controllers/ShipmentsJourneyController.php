...
{
    static public function add($shipment_id, $shipper_status_id, $consignee_status_id, $status_reason_id, $remarks, $user_id, $admin_id, $reference_1_id = NULL, $reference_2_id = NULL,$verification = 1, $received_or_refused_by = NULL, $rider_id = NULL,$cancel_reason = NULL) {
      ...
      $shipment_journey->received_or_refused_by = $received_or_refused_by;
      $shipment_journey->cancel_reason = $cancel_reason;
