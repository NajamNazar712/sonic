...
//                    ShipmentsPickupJourneyController::add($shipment->id, 4);
    ...
    public function userProfile()
    {
        ...
        return view('client.profile.index')->with(['user'=>$user,'product_name'=>$product->product_name,'banks'=>$banks,'pickup_city_list'=>$pickup_city_list, 'emails' => $emails, 'email_ids' => $email_ids, 'reference' => $reference, 'average_shipment_duration' => $average_shipment_duration, 'cities_list' => $city_list, 'segments' => $segments]);
    }
