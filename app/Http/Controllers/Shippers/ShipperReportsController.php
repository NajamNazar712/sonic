...
//                ->where('u.id', session('user_id'))
    ...
    public function summary_list(Request $request)
    {
        ...
        $shipments = DB::connection('reports')->table('shipments')->join('users as u', 'u.id', '=', 'shipments.user_id')
            ...
            'shipments.weight_charges', 'shipments.cash_handling_charges', 'ss.name as current_status', 'ss.updated_at as current_status_date', 'sps.name as payment_status', 'bt.booking_type as service_type', 
