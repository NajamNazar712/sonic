...
//                    }
                ...
                ';
                    ...
                    ';
                        ...
                        $table_end = '
                              <tr>
                                <td rowspan="2" colspan="2" class="color primary border twice-top twice-bottom twice-right"><strong>Special Instruction(s2)</strong></td>
...
//here
                    ...
                    if ($shipment->booking_type_id == 1 || $shipment->booking_type_id == 4 || $shipment->booking_type_id == 6) {
                        ...
                        $shippingService .= '
                            <td colspan="4" class="prominent" ><strong>' . $service_type . '</strong></td>
                    ';
                    } else if ($shipment->booking_type_id == 2) {
                        if ($type != 'pdf') {
                            $shippingService .= '
                                <td colspan="4"  class="replacement prominent"><strong class="align-middle">' . $shipment->booking_type->booking_type . '</strong><span class="d-inline-block align-middle float-right"><img src="' . asset('img/replacement.png') . '"></span></td>';
                        } else {
                            $shippingService .= '
                            <td colspan="4" class="replacement prominent"><strong class="align-middle">' . $shipment->booking_type->booking_type . '</strong></td>';
                        }
                    }
                    else {
                        $shippingService .= '
                        <td colspan="4" class="prominent"><strong>' . $shipment->booking_type->booking_type . '</strong></td>';
                    }
                    
                    $shippmentMode = '';
                    if ($shipment->business_category->id == 1) {
                        $shippmentMode .= '
                        <td colspan="2" class="prominent"><strong>' . $shipment->shipping_mode->mode . '</strong></td>';
                    } 
                    else {
                        $shippmentMode .= '
                        <td colspan="2" class="prominent"><strong>International</strong></td>';
                    }
                        ...
                        <tr>
                        <td colspan="1" style="font-size:13px;"><b>Shipping Mode</b></td>
                        '.$shippmentMode.'
                        <td colspan="1" style="font-size:13px;" class="text-center border twice-top"><b>Service</b></td>
                        '.$shippingService.'
                        </tr>
      ...
      ';
        ...
        if ($request->has('admin') || session('user_id') == $shipment->user_id) {
          ...
          ';
            ...
            $table_end = '
                          <tr>
                            <td rowspan="3" colspan="2" class="color primary border twice-top twice-bottom twice-right"><strong>Special Instruction(s3)</strong></td>
                            <td rowspan="3" colspan="4" class="border twice-top twice-bottom twice-right">' . $shipment->special_instructions . '</td>
