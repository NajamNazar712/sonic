...
class ShipperFinanceController extends Controller
{
    ...
    public function payments_list(Request $request)
    {
        ...
        $done_payments = DB::connection('reports')->table('done_payments')->join('users as u', 'done_payments.user_id', '=', 'u.id')
...
//                }
    ...
    public function invoice_list(Request $request)
    {
        ...
        $reim_invoice = DB::table('invoice_for_reimbursements as invoices')->join('users as u', 'invoices.user_id', '=', 'u.id')
            ->join('cities as c', 'u.city_id', '=', 'c.id')
...
';
    ...
    public function invoice_reimbursement_print(Request $request){
