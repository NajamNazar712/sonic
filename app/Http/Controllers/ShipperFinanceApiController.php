...
class ShipperFinanceApiController extends Controller
{
    ...
    private function shipper_payment_list($shipper_id,$payment_id)
    {
        ...
        $shipper_payments = DB::table('done_payments')
            ...
            ->whereBetween('done_payments.created_at', [Carbon::now()->subMonths(24)->startOfMonth(), Carbon::now()->endOfDay()])
    ...
    private function retail_payment_list($retail_id,$payment_id)
    {
        ...
        $retail_payments = DB::table('retail_done_payments')->join('retail_shipper_infos as rsi', 'retail_done_payments.user_id', '=', 'rsi.id')
            ...
            ->whereBetween('retail_done_payments.created_at', [Carbon::now()->subMonths(24)->startOfMonth(), Carbon::now()->endOfDay()])
