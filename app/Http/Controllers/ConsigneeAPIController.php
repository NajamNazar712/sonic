...
class ConsigneeAPIController extends Controller
{
    ...
    public function active_shipments(Request $request)
    {
        ...
        $consignee_shipments = Shipment::join('shipment_status as ss', 'shipments.shipper_status_id','=', 'ss.id')
            ...
            ->select('shipments.id as shipment_id','shipments.tracking_no as tracking_no','shipments.shipper_status_id as status_id','ss.name as status', 'shipments.amount as amount', 'shipments.delivery_in_route as delivery_in_route' )
