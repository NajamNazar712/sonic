...
class BookingDestinationMappingModulePermissionsSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('admins_screen_list')->insert(array(
            array('created_at' => $timestamp, 'updated_at' => $timestamp, 'name' => 'Settings > Last Mile > Booking Destination Keyword', 'url'=>'admin.settings.booking_destination_keyword.index', 'permission_id' => 772),
        ));
    }
}
