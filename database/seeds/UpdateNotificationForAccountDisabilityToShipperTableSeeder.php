...
class UpdateNotificationForAccountDisabilityToShipperTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('notifications')->insert(array(
            array('id' => 57, 'created_at' => $timestamp, 'updated_at' => $timestamp, 'name' => 'Account Disabled  7 days inactivity for Shipper', 'type_id' => 1, 'subject' => 'Account Disabled after 7 days of inactivity', 'body' => '[preview]'. PHP_EOL . 'TRAX Logistics'. PHP_EOL . '0213-877-22-22'. PHP_EOL .'info@trax.pk', 'updated_by' => 3, 'status' => 0),
