...
class PermissionsAndActivityTrailKAMBulkTaggingSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('admins_screen_list')->insert(array(
            array('created_at' => $timestamp, 'updated_at' => $timestamp, 'name' => 'Shippers > Accounts > KAM Bulk Tagging', 'url'=>'admin.settings.sms_notifications_limit.index', 'permission_id' => 991),
        ));
    }
}
