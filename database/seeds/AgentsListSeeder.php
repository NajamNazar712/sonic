...
class AgentsListSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('module_permissions')->insert(array(
            array('id' => 951, 'name' => 'Agents List - View', 'module_id' => 14),
        ));


        DB::table('activity_trail_actions')->insert(array(
            array('id' => 763, 'screen_name' => 'Agents List', 'action' => 'View'),
        ));

        DB::table('activity_trail_actions')->insert(array(
            array('id' => 764, 'screen_name' => 'Agents List', 'action' => 'Excel Download'),
        ));
