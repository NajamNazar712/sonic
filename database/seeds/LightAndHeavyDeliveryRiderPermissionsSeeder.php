...
class LightAndHeavyDeliveryRiderPermissionsSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('module_permissions')->insert(array(
            ...
            array('id' => 759, 'name' => 'Rider Category ByPass Request (Add Request) - Action', 'module_id' => 8),
            array('id' => 760, 'name' => 'Rider Category ByPass Request (Approved) - Button', 'module_id' => 8),
        ));
