...
class Seeder4617ForPermission extends Seeder
{
    ...
    public function run()
    {
        DB::table('module_permissions')->insert(array(
            array('id' => 669, 'name' => 'Movit Lead - View', 'module_id' => 25),
        ));

        DB::table('activity_trail_actions')->insert(array(
            array('id' => 489, 'screen_name' => 'Movit Lead', 'action'=> 'View'),
            array('id' => 490, 'screen_name' => 'Movit Lead', 'action'=> 'Excel Download'),
        ));
