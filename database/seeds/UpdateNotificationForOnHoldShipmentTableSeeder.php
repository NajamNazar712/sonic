...
class UpdateNotificationForOnHoldShipmentTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('notifications')->insert(array(
            ...
            array('id' => 109, 'created_at' => $timestamp, 'updated_at' => $timestamp, 'name' => 'Delivery On-Hold Shipments', 'type_id' => 1, 'subject' => 'Today is delivery date [date]', 'body' => 'Dear Concern,' . PHP_EOL .'Today is dispatch date for below listed shipments.'. PHP_EOL . '[preview]', 'updated_by' => 7, 'status' => 0)
        ));
    }
}
