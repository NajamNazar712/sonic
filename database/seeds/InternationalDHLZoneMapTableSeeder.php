...
class InternationalDHLZoneMapTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('international_dhl_zones')->insert(array(
            ...
            array('id' => 12, 'zone_id' => 28, 'zone_name' => "1b", 'created_at'=>$timestamp,'updated_at'=>$timestamp),
            array('id' => 13, 'zone_id' => 29, 'zone_name' => "8b", 'created_at'=>$timestamp,'updated_at'=>$timestamp),
