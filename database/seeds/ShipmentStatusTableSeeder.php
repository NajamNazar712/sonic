...
class ShipmentStatusTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('shipment_status')->insert(array(
			...
			array('id' => 31, 'code' => 'TB-AOC', 'name' => 'Try & Buy - Arrived at Origin Center', 'description' => 'Try & Buy shipment is received at the origin office for return'),
			array('id' => 32, 'code' => 'TB-DP', 'name' => 'Try & Buy - Dispatched', 'description' => 'Try & Buy shipment is dispatched to be sent back to the shipper'),
			array('id' => 33, 'code' => 'TB-AF', 'name' => 'Try & Buy - Attempt Failed', 'description' => 'Try & Buy shipment was attempted for delivery but could not be delivered'),
			array('id' => 34, 'code' => 'TB-DE', 'name' => 'Try & Buy - Delivered', 'description' => 'Try & Buy shipment is delivered to the consignee'),
			array('id' => 35, 'code' => 'TB-PD', 'name' => 'Try & Buy - Partial Delivered', 'description' => 'Some contents of the Try & Buy shipment are delivered and the rest are to be returned to the shipper'),
			array('id' => 36, 'code' => 'TB-DS', 'name' => 'Try & Buy - Delivered to Shipper', 'description' => 'Try & Buy shipment is sent back to the shipper'),
			array('id' => 37, 'code' => 'P-PR', 'name' => 'Payment - Processed', 'description' => 'Payment for the shipment is processed by TRAX'),
			array('id' => 38, 'code' => 'P-PA', 'name' => 'Payment - Paid', 'description' => 'Payment reimbursed to the shipper'),
			array('id' => 39, 'code' => 'P-RE', 'name' => 'Payment - Reverted', 'description' => 'Payment is reverted from the bank\'s end'),
			array('id' => 40, 'code' => 'P-AD', 'name' => 'Payment - Adjusted', 'description' => 'Shipment is wrongly paid and the amount is adjusted in next payment'),
			array('id' => 41, 'code' => 'P-CD', 'name' => 'Payment - Charges Deducted', 'description' => 'Charges have been deducted of the Return Shipment')
        ));
    }
}
