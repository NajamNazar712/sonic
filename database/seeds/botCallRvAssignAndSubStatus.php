...
class botCallRvAssignAndSubStatus extends Seeder
{
    ...
    public function run()
    {
        ...
        //     array('id' => 38, 'name' => 'Shipment is another status','shipment_status_reason_id'=> Null,'rv_assign_agent_status_id'=> 9,'is_active'=> 0,'created_at' => $timestamp, 'updated_at' => $timestamp),
        // ));
    }
}
