...
class UpdateSearchSonicSeederForMasterCargoReports extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('admins_screen_list')->insert( array('created_at' => $timestamp, 'updated_at' => $timestamp, 'name' => 'Reports  > Master Cargo Short Received Shipments', 'url'=>'admin.reports.master_cargo.short_received_shipments.index', 'permission_id' => 319));
