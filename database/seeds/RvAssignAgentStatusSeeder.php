...
class RvAssignAgentStatusSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('rv_assign_agent_statuses')->insert(array(
            ...
            array('id'=> 6, 'shipment_status_id'=> 15,'name' => 'On Hold', 'shipment_status_name' => 'Shipment - On Hold for Self Collection','call_finding_id'=> NULL, 'created_at' => $timestamp, 'updated_at'=>$timestamp, 'is_visible'=> 1 ),
            array('id'=> 7, 'shipment_status_id'=> NULL,'name' => 'Unresponsive', 'shipment_status_name' => 'Unresponsive','call_finding_id'=> 1, 'created_at' => $timestamp, 'updated_at'=>$timestamp, 'is_visible'=> 1 ),
        ));
    }
}
