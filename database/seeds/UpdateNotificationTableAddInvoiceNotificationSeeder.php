...
class UpdateNotificationTableAddInvoiceNotificationSeeder extends Seeder
{
    ...
    public function run()
    {
       ...
       Notification::whereIn('id',[27,28])->delete();
        
        $timestamp = Carbon::now()->format('Y-m-d H:i:s');

        DB::table('notifications')->insert(array(
        	array('id' => 27, 'created_at' => $timestamp, 'updated_at' => $timestamp, 'name' => 'Invoice Email to Shipper', 'type_id' => 1, 'subject' => 'Invoice [invoice_number] for Delivered and Returned Shipments (Dated: [billing_period_from_date] - [billing_period_to_date])', 'body' => 'Dear [company_name],' . PHP_EOL . 'This is to notify you that an invoice with the invoice number [invoice_number] has been generated for the charges of your shipments for the period [billing_period_from_date] - [billing_period_to_date].' . PHP_EOL . 'Please find the invoice below and pay through cash/cheque/funds transfer to TRAX by [due_date].' . PHP_EOL . PHP_EOL . '[invoice]' . PHP_EOL . PHP_EOL . PHP_EOL . 'Regards,' . PHP_EOL . 'TRAX' . PHP_EOL . 'Address:  Plot # 105, Mehran Town Sector 7 A Korangi, Karachi, Sindh 74900' . PHP_EOL . 'Helpline: +92-3-041-111-232', 'updated_by' => 3, 'status' => 0),
