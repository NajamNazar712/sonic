...
class shipper_detail_seeder extends Seeder
{
    ...
    public function run()
    {
       ...
       DB::table('trax_shipper_details')->insert(array(
           array('id'=>1,'user_id'=>117,'trax_product_id'=>1,'trax_service_id'=>1,'rider_id'=>1,'route_id'=>1,'piece_setting_id'=>1,'created_at'=>$time_stamp,'updated_at'=>$time_stamp),
           array('id'=>2,'user_id'=>119,'trax_product_id'=>2,'trax_service_id'=>3,'rider_id'=>1,'route_id'=>7,'piece_setting_id'=>2,'created_at'=>$time_stamp,'updated_at'=>$time_stamp),
