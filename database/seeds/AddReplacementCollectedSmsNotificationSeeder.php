...
class AddReplacementCollectedSmsNotificationSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('notifications')->insert(array(
            array('id' => 183, 'created_at' => $timestamp, 'updated_at' => $timestamp, 'name' => 'Replacement Collected - Shipper', 'type_id' => 2, 'subject' => null, 'body' => 'Dear Shipper' . PHP_EOL . 'Your replacement parcel has been collected from the consignee by TRAX rider with CN # [tracking_number].', 'updated_by' => 664, 'status' => 1),
