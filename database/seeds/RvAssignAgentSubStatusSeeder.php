...
class RvAssignAgentSubStatusSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('rv_assign_agent_sub_statuses')->insert(array(
            ...
            array('name' => 'Consignee Unresponsive on Phone call','shipment_status_reason_id'=> 2,'rv_assign_agent_status_id'=> 1,'is_active'=>1,'created_at' => $timestamp, 'updated_at' => $timestamp),
            array('name' => 'Consignee Out Of City','shipment_status_reason_id'=> 5,'rv_assign_agent_status_id'=> 1,'is_active'=> 1,'created_at' => $timestamp, 'updated_at' => $timestamp),
            ...
            array('name' => 'Consignee is not Responding','shipment_status_reason_id'=> 13,'rv_assign_agent_status_id'=> 1,'is_active'=> 1,'created_at' => $timestamp, 'updated_at' => $timestamp),
            array('name' => 'Consignee Refused','shipment_status_reason_id'=> 38,'rv_assign_agent_status_id'=> 1,'is_active'=> 1,'created_at' => $timestamp, 'updated_at' => $timestamp),
            ...
            array('name' => 'Address Issue','shipment_status_reason_id'=> 46,'rv_assign_agent_status_id'=> 1,'is_active'=> 1,'created_at' => $timestamp, 'updated_at' => $timestamp),
            ...
            array('name' => 'Shipment Damage','shipment_status_reason_id'=> 48,'rv_assign_agent_status_id'=> 1,'is_active'=> 1,'created_at' => $timestamp, 'updated_at' => $timestamp),
            ...
            array('name' => 'As per Shipper Request','shipment_status_reason_id'=> 53,'rv_assign_agent_status_id'=> 1,'is_active'=> 1,'created_at' => $timestamp, 'updated_at' => $timestamp),
            array('name' => 'Wants to Open2','shipment_status_reason_id'=> 54,'rv_assign_agent_status_id'=> 1,'is_active'=> 1,'created_at' => $timestamp, 'updated_at' => $timestamp),
            array('name' => 'Consignee Unresponsive','shipment_status_reason_id'=> 55,'rv_assign_agent_status_id'=> 1,'is_active'=> 1,'created_at' => $timestamp, 'updated_at' => $timestamp),
            array('name' => 'Delay in Dispatch from Shipper','shipment_status_reason_id'=> 59,'rv_assign_agent_status_id'=> 1,'is_active'=> 1,'created_at' => $timestamp, 'updated_at' => $timestamp),
