...
class LeadNotificationTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('lead_notifications')->insert(array(
            ...
            array('id' => 4, 'created_at' => $timestamp, 'updated_at' => $timestamp, 'name' => 'Unresponsive SMS', 'type_id' => 2, 'subject' => '', 'body' => 'Dear [shipper_name],' . PHP_EOL . 'We tried contacting you regarding your account opening request with TRAX but we were unable to have your attention.' . PHP_EOL . ' Please contact us at 021-111-11-8729 for smooth registration process.', 'updated_by' => 3, 'status' => 0),
        ));
    }
}
