...
class ProductsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('products')->insert(array(
            ...
            array('product_name'=>'Appliances and Consumer Electronics'),
            array('product_name'=>'Home Decor and Interior Items'),
            array('product_name'=>'Toys'),
            array('product_name'=>'Pet Supplies'),
            array('product_name'=>'Athletics and Fitness Items'),
            array('product_name'=>'Vouchers and Coupons'),
            array('product_name'=>'Marketplace'),
            array('product_name'=>'Documents and Letters'),
