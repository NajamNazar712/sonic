...
class MakeBotWhatsappAgentUserSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        $name = 'Digital Whatsapp Call';
        $email = 'whatsappbot@trax.pk';
        $defaultHub = 202;
        ...
        $shiftId = 3;
        $pin = bcrypt(315513);
        $apiToken = 'opXqTblBlMFZDYTJGbkR4MENTaWg5dWZFV250Z29leDZoaEU4MDJkT0xGZEx6d3IydGgwWHdRVjBIWDB666bb6c93c2dfe'; //uniqid(base64_encode(Str::random(60)));
