...
class CreateCorporateDefaultWeightChargesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('corporate_default_weight_charges', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->decimal('national_charges_class_0', 8, 2);
    ...
    {
        Schema::dropIfExists('corporate_default_weight_charges');
    }
}
