...
class CreateHistoryRateStatusesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('history_rate_statuses', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('history_rate_statuses');
    }
}
