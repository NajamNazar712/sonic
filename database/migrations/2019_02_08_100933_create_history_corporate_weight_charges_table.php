...
class CreateHistoryCorporateWeightChargesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('history_corporate_weight_charges', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('history_corporate_weight_charges');
    }
}
