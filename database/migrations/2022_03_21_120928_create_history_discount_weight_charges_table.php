...
class CreateHistoryDiscountWeightChargesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('history_discount_weight_charges', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('history_discount_weight_charges');
    }
}
