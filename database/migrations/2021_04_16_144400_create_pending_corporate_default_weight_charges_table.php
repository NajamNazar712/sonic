...
class CreatePendingCorporateDefaultWeightChargesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('pending_corporate_default_weight_charges', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('pending_corporate_default_weight_charges');
    }
}
