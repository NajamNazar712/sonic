...
class CreatePendingDiscountWeightChargesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('pending_discount_weight_charges', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('pending_discount_weight_charges');
    }
}
