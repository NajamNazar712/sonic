...
class CreatePendingCorporateWeightChargeZoneWisesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('pending_corporate_weight_charge_zone_wises', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('pending_corporate_weight_charge_zone_wises');
    }
}
