...
class CreateRetailFranchiseCommissionsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('retail_franchise_commissions', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->integer('total_charges_without_gst')->nullable();
    ...
    {
        Schema::dropIfExists('retail_franchise_commissions');
    }
}
