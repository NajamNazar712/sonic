...
class CreateDonePaymentShipmentsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('done_payment_shipments', function (Blueprint $table) {
            $table->timestamps();
    ...
    {
        Schema::dropIfExists('done_payment_shipments');
    }
}
