...
$(document).ready(function () {
    ...
    var _cashhandlingswitch = document.querySelector('.switchery.cashChargesOvernight');
    ...
    _cashhandlingswitch = function cashhandlingswitch() {
        if (_cashhandlingswitch.checked === true) {
            $('.cash-handling-div-overnight').find('input').prop('disabled', false);
            $('.cash-handling-btn-overnight').find('button').prop('disabled', false);
        } else if (_cashhandlingswitch.checked === false) {
