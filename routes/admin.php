...
Route::prefix('admin')->name('admin.')->group(function () {
    ...
    Route::prefix('accounts')->name('accounts.')->group(function () {
        ...
        Route::post('swicth/reimbursement/submit', 'Admins\AdminCorporateAccountsController@switch_reimbursement_submit')->name('switch_reimbursement_submit');
        ...
        Route::post('faf_charges/logs', 'Admins\AdminDashboardController@faf_charges_logs')
            ->name('faf_charges.logs');
